...
label-music-mode-title = Playlist Mode
button-music-mode-mix = Mix All
...
checkbox-music-custom-china = China
checkbox-music-custom-gdi = GDI
checkbox-music-custom-nod = Nod
checkbox-music-custom-scrin = Scrin
checkbox-music-custom-generic = Generic
checkbox-music-custom-oldschool = Oldschool
label-music-filter-empty = No tracks match this mode.
...
label-restart-required-container-video-desc = Display, renderer, and OpenGL changes require restart
