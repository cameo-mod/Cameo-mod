...
namespace OpenRA
{
	...
	public class GraphicSettings
	{
		...
		[Desc("Renderer backend to use.",
			"OpenGL: Existing renderer.",
			"Vulkan: Experimental Vulkan renderer pipeline for future ray tracing and PBR work.")]
		public RendererBackend RendererBackend = RendererBackend.OpenGL;
