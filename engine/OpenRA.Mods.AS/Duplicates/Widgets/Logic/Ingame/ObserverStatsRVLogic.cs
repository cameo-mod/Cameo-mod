	...
	public class ObserverStatsRVLogic : ChromeLogic
	{
		...
		public ObserverStatsRVLogic(World world, ModData modData, WorldRenderer worldRenderer, Widget widget, Dictionary<string, MiniYaml> logicArgs)
		{
			...
			var statsDropDownOptions = new StatsDropDownOption[]
			{
				...
				CreateStatsOption(SupportPowers, ObserverStatsRVPanel.SupportPowers, supportPowersPlayerTemplate, () => DisplayStats(SupportPowerStats)),
				...
				CreateStatsOption(CPsAndUpgrades, ObserverStatsRVPanel.Upgrades, upgradesPlayerTemplate, () => DisplayStats(UpgradesStats)),
