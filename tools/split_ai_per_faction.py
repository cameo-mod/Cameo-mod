...
FACTION_MAP = {
    ...
    'RA': [('RedAlert', 'ra1_allies'), ('RedAlert', 'ra1_soviet'), ('RedAlert', 'japan')],
    ...
    'Asian': [('RedAlert2Mod/AsianAlliance', 'asian_alliance')],
    'Consortium': [('RedAlert2Mod/Consortium', 'steel_consortium')],
    'Syndicate': [('RedAlert2Mod/Syndicate', 'latin_syndicate')],
    'Naxis': [('RedAlert2Mod/Naxis', 'naxis')],
    'Schwarzer Mond': [('RedAlert2Mod/SchwarzerMond', 'schwarzer_mond')],
    ...
    'ZERG': [('StarCraft', 'zerg')],
    'Warcraft 2 Humans': [('Warcraft2', 'humans')],
    'Warcraft 2 Orcs': [('Warcraft2', 'orcs')],
    'TKM': [('TKM', 'tkm')],
...
def get_faction_prefixes(faction_prefix):
    ...
    elif faction_prefix == 'ra1_soviet':
        prefixes.extend(['ra1_soviet_', 'soviet_'])
