...
class WeaponStructureInventoryTests(unittest.TestCase):
    ...
    def test_current_corrected_baseline(self):
        ...
        self.assertEqual(210, self.data["counts"]["reviewed_stacked_main_all_concrete"])
        self.assertEqual(165, self.data["counts"]["reviewed_stacked_main_direct_actor_armament"])
        self.assertEqual(45, self.data["counts"]["reviewed_stacked_main_indirect_weapon_graph"])
        self.assertEqual(210, self.data["counts"]["reviewed_stacked_main_transitive_weapon_graph"])
        self.assertEqual(177, self.data["counts"]["unreviewed_stacked_main_all_concrete"])
        self.assertEqual(77, self.data["counts"]["unreviewed_stacked_main_transitive_weapon_graph"])
        self.assertEqual(407, self.data["counts"]["reviewed_excess_main_warhead_instances_all_concrete"])
        self.assertEqual(407, self.data["counts"]["reviewed_excess_main_warhead_instances_transitive_weapon_graph"])
        self.assertEqual(288, self.data["counts"]["unreviewed_excess_main_warhead_instances_all_concrete"])
        self.assertEqual(143, self.data["counts"]["unreviewed_excess_main_warhead_instances_transitive_weapon_graph"])
