...
class WeaponStructureInventoryTests(unittest.TestCase):
    ...
    def test_current_corrected_baseline(self):
        ...
        self.assertEqual(390, self.data["counts"]["stacked_main_all_concrete"])
        self.assertEqual(234, self.data["counts"]["stacked_main_direct_actor_armament"])
        self.assertEqual(55, self.data["counts"]["stacked_main_indirect_weapon_graph"])
        self.assertEqual(289, self.data["counts"]["stacked_main_transitive_weapon_graph"])
        self.assertEqual(101, self.data["counts"]["stacked_main_unreached"])
        self.assertEqual(2728, self.data["counts"]["main_warhead_instances_all_concrete"])
        self.assertEqual(699, self.data["counts"]["excess_main_warhead_instances_all_concrete"])
        self.assertEqual(2299, self.data["counts"]["main_warhead_instances_transitive_weapon_graph"])
        self.assertEqual(553, self.data["counts"]["excess_main_warhead_instances_transitive_weapon_graph"])
        ...
        self.assertEqual(264, self.data["counts"]["unreviewed_stacked_main_all_concrete"])
        self.assertEqual(163, self.data["counts"]["unreviewed_stacked_main_transitive_weapon_graph"])
        ...
        self.assertEqual(445, self.data["counts"]["unreviewed_excess_main_warhead_instances_all_concrete"])
        self.assertEqual(299, self.data["counts"]["unreviewed_excess_main_warhead_instances_transitive_weapon_graph"])

    def test_raw_reachable_ratchets_match_the_checkpoint(self):
        self.assertEqual(289, RAW_REACHABLE_BASELINE)
        self.assertEqual(553, RAW_REACHABLE_EXCESS_BASELINE)
