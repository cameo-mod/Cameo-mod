...
class WeaponStructureInventoryTests(unittest.TestCase):
    ...
    def test_current_corrected_baseline(self):
        ...
        self.assertEqual(265, self.data["counts"]["unreviewed_stacked_main_all_concrete"])
        self.assertEqual(164, self.data["counts"]["unreviewed_stacked_main_transitive_weapon_graph"])
        ...
        self.assertEqual(446, self.data["counts"]["unreviewed_excess_main_warhead_instances_all_concrete"])
        self.assertEqual(300, self.data["counts"]["unreviewed_excess_main_warhead_instances_transitive_weapon_graph"])
