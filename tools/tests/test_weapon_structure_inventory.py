...
class WeaponStructureInventoryTests(unittest.TestCase):
    ...
    def test_current_corrected_baseline(self):
        ...
        self.assertEqual(339, self.data["counts"]["stacked_main_all_concrete"])
        self.assertEqual(189, self.data["counts"]["stacked_main_direct_actor_armament"])
        self.assertEqual(50, self.data["counts"]["stacked_main_indirect_weapon_graph"])
        self.assertEqual(239, self.data["counts"]["stacked_main_transitive_weapon_graph"])
        self.assertEqual(100, self.data["counts"]["stacked_main_unreached"])
        self.assertEqual(2623, self.data["counts"]["main_warhead_instances_all_concrete"])
        self.assertEqual(594, self.data["counts"]["excess_main_warhead_instances_all_concrete"])
        self.assertEqual(2197, self.data["counts"]["main_warhead_instances_transitive_weapon_graph"])
        self.assertEqual(449, self.data["counts"]["excess_main_warhead_instances_transitive_weapon_graph"])
        self.assertEqual(225, self.data["counts"]["reviewed_stacked_main_all_concrete"])
        self.assertEqual(177, self.data["counts"]["reviewed_stacked_main_direct_actor_armament"])
        self.assertEqual(48, self.data["counts"]["reviewed_stacked_main_indirect_weapon_graph"])
        self.assertEqual(225, self.data["counts"]["reviewed_stacked_main_transitive_weapon_graph"])
        ...
        self.assertEqual(431, self.data["counts"]["reviewed_excess_main_warhead_instances_all_concrete"])
        self.assertEqual(431, self.data["counts"]["reviewed_excess_main_warhead_instances_transitive_weapon_graph"])
    ...
    def test_raw_reachable_ratchets_match_the_checkpoint(self):
        self.assertEqual(239, RAW_REACHABLE_BASELINE)
        self.assertEqual(449, RAW_REACHABLE_EXCESS_BASELINE)
