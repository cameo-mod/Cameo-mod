...
class WeaponStructureInventoryTests(unittest.TestCase):
    ...
    def test_current_corrected_baseline(self):
        ...
        self.assertEqual(128, self.data["counts"]["reviewed_stacked_main_all_concrete"])
        self.assertEqual(100, self.data["counts"]["reviewed_stacked_main_direct_actor_armament"])
        self.assertEqual(28, self.data["counts"]["reviewed_stacked_main_indirect_weapon_graph"])
        self.assertEqual(128, self.data["counts"]["reviewed_stacked_main_transitive_weapon_graph"])
        self.assertEqual(259, self.data["counts"]["unreviewed_stacked_main_all_concrete"])
        self.assertEqual(159, self.data["counts"]["unreviewed_stacked_main_transitive_weapon_graph"])
        self.assertEqual(257, self.data["counts"]["reviewed_excess_main_warhead_instances_all_concrete"])
        self.assertEqual(257, self.data["counts"]["reviewed_excess_main_warhead_instances_transitive_weapon_graph"])
        self.assertEqual(438, self.data["counts"]["unreviewed_excess_main_warhead_instances_all_concrete"])
        self.assertEqual(293, self.data["counts"]["unreviewed_excess_main_warhead_instances_transitive_weapon_graph"])
