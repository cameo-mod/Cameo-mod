...
def charge_attack_cycle(charge, weapon_reload: float | None):
    ...
    idle between shots and re-enters on `AutoTarget`'s random 3-7 tick scan, which adds
    roughly 8 ticks a volley (the Rail Tower measures 210 floor / 218 mean / 232 ceiling).
    This returns the FLOOR deliberately — it is the value the maintainer ruled, it is the
