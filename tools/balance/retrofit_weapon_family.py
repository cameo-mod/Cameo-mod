...
TRIPLE = {
    ...
    "LightMissile": ("MissileAP_Light", "Projectile_Missile_Light", "Effect_MissileAP_Light"),
    "MediumMissile": ("MissileAP_Medium", "Projectile_Missile_Medium", "Effect_MissileAP_Medium"),
    "HeavyMissile": ("MissileAP_Heavy", "Projectile_Missile_Heavy", "Effect_MissileAP_Heavy"),
