...
| 4 | Assign each group to a Cameo warhead family | `warhead_family_assignment*.yaml` | **13 of 17 sources, 2,405 of 2,542 weapons (95%)** (CA reviewed; Mental Omega, Red Resurrection, Rise of the East, Romanov's Vengeance, CnC Reloaded, Shattered Paradise, RA2 Reborn, RA 20XX, Twisted Insurrection, DTA Enhanced, DTA Classic and OpenRA RA proposed) |
...
⭐ **DONE (13):** `combined_arms` 182 (REVIEWED), `mental_omega` 156, `red_resurrection` 138,
...
`dta_classic` 38, `openra_ra` 33 — 1,242 groups, 2,405 weapons.

**REMAINING (4), in usage order — 85 groups, under a tenth of what is done:**
`crystallized_nexus` 28,
...
it refuses, re-key that decision per weapon — do not "fix" it by renaming the group read.
