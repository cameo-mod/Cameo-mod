...
|---|---|
| W24 — fired weapons with **more than one** damage main | **884 of 1622 = 54.5%** (histogram runs out to 15 mains) |
| armament slots whose `K` moves when those collapse | **1 547** |
| fired weapons that reach a `^Warhead_*` family at all | **1248 of 1622 = 76.9%** — the rest still route through legacy templates (`audit_unconverted_templates`: 45 templates, 1126 inheritors) |
...
**45 unconverted templates, 1126 direct inheritors.** Biggest: `^ShrapnelWeapon` (88) →
...
fired weapons, **45.5%** comply (738 of 1622); **54.5%** (884 of 1622) carry 2 or more damage
