...
| A6 | Continue the burn-down | 🔵 IN PROGRESS — collapsed the chemical turret pair; four light-chemical/AP-cannon weapons onto CannonChem; the exact medium flame+chemical pair onto Plasma; two redundant medium+heavy Flame stacks onto Flame Heavy; three redundant light+medium+heavy Chemical stacks onto Chemical Heavy; the thermobaric grenade/explosion pair onto Thermobaric Light; seven Soviet thermobaric missile definitions onto MissileThermobaric Medium/Heavy; seven resolved shotgun definitions onto CannonHE Medium; eleven resolved sniper definitions onto CannonHE Heavy; eight resolved Steel laser/railgun definitions onto Railgun Heavy; and nineteen resolved named laser definitions onto Laser Heavy. Flat and percentage totals, projectile operation, sounds, custom conditions/clouds, effects, smudges, shield behavior, and concrete damage are preserved; standard family profiles are accepted classification consequences. `review_batch_diff.py` gates percentage totals and judges friendly-fire by resolved relationships as well as flat damage. Survey 294 → 259 and W24 broadcast debt 936 → 889. Combined static audits and controlled boots passed through A14; later validation is recorded in the development log. |
