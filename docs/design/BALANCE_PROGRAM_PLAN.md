...
|---|---|
| W24 — fired weapons with **more than one** damage main | **599 of 1637 = 36.6%** (histogram runs out to 10 mains) |
...
1. **W24** — one damage warhead per weapon (DESIGN §11b). 36.6% non-compliant.
...
fired weapons, **55.8%** comply (913 of 1637); **36.6%** (599 of 1637) carry 2 or more damage
