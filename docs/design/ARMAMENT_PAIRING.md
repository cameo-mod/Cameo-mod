...
and re-enters on `AutoTarget`'s `Next(3, 8)` = U{3..7} scan, so the Rail Tower really runs
210 floor / 218 mean / 232 ceiling. Both coils are invariant, because charge-once never idles.
