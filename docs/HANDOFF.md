...
```
W24  one damage warhead per weapon          872 fired weapons still carry 2+
...
|---|---|---|
| **W24** | collapse each fired weapon to ONE damage warhead (DESIGN §11b) | `multi_main_fired_weapons` in `doc_claims.yaml` goes DOWN from 872 |
