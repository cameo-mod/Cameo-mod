...
| R3 | dual-domain route flying MissileHE/AA | 5 |
| R4 | MissileHE reachable against Air | 5 |
| custom | recipient or non-domain selector | 27 |

Scanned **378** concrete weapons; **279** recognized role/family pairs conform. The receipt also records **3** explicit policy question(s).
...
| `ra1_allies_rapierjumpjet_missile_AA` | both | MissileHE | MissileAP | 1 | `mods/cameo/ContentPacks/RedAlert/Allies/yaml/weapons.yaml:387` |
