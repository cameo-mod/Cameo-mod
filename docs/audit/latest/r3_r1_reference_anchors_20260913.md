...
|---|---:|:---:|---:|---:|---:|---:|---:|---:|---:|---|
| `artillery` | 3 | no | 30,000 | 58 | 11,837 | 768.059 | 1,000 | 26.7% | 0 | R4_VS_FITTING_MISMATCH_NOT_DIRECTLY_COMPARABLE=1 |
| `fire_support` | 1 | yes | 41,000 | 83 | 10,471 | 582.930 | 1,400 | 2.1% | 0 | THIN_COHORT=1 |
| `grenadier` | 2 | yes | 14,000 | 73 | 4,986 | 420.251 | 200 | 5.2% | 0 | THIN_COHORT=1 |
| `heavy_infantry` | 1 | yes | 31,000 | 48 | 5,962 | 357.900 | 800 | 3.4% | 0 | R4_VS_FITTING_MISMATCH_NOT_DIRECTLY_COMPARABLE=1, THIN_COHORT=1 |
| `high_tech_tank` | 2 | yes | 291,000 | 46 | 5,443 | 742.628 | 3,800 | 10.6% | 0 | R4_VS_FITTING_MISMATCH_NOT_DIRECTLY_COMPARABLE=1, THIN_COHORT=1 |
| `light_tank` | 2 | yes | 93,000 | 100 | 4,811 | 406.611 | 1,000 | 13.2% | 0 | CURRENT_R4_DIFFERS_FROM_FROZEN_R4_MAY_REFLECT_AUTHORIZED_FP_BAKE=1, R4_VS_FITTING_MISMATCH_NOT_DIRECTLY_COMPARABLE=1, THIN_COHORT=1 |
| `line_breaker` | 1 | yes | 119,000 | 83 | 2,547 | 1,187.085 | 900 | 2.1% | 0 | THIN_COHORT=1 |
| `mbt` | 3 | no | 151,000 | 74 | 5,171 | 412.432 | 1,300 | 19.5% | 0 | none |
| `melee` | 2 | yes | 42,000 | 62 | 2,676 | 710.508 | 400 | 16.5% | 0 | THIN_COHORT=1 |
| `missile_vehicle` | 3 | no | 43,000 | 131 | 6,098 | 686.352 | 1,300 | 62.8% | 0 | R4_VS_FITTING_MISMATCH_NOT_DIRECTLY_COMPARABLE=1 |
| `rocket_trooper` | 4 | no | 14,000 | 48 | 6,987 | 271.815 | 400 | 16.0% | 0 | none |
| `scout` | 4 | no | 22,000 | 57 | 4,514 | 220.791 | 100 | 19.8% | 0 | CURRENT_R4_DIFFERS_FROM_FROZEN_R4_MAY_REFLECT_AUTHORIZED_FP_BAKE=4 |
| `scout_vehicle` | 3 | no | 40,000 | 157 | 4,278 | 615.443 | 500 | 31.9% | 0 | none |
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| `artillery` | `ra1_allies_alliedartillery` | 20,000→29,945 | 60→58 | 13,350→11,837 | 375.188→768.059 | 600→982 | 1,240 | HOLD_CLASS_DPS_METRIC_BASIS |
| `artillery` | `ra1_soviets_v2rocketlauncher` | 30,000→44,849 | 85→67 | 14,110→12,621 | 1,000.000→861.550 | 1,600→1,504 | 1,410 | HOLD_CLASS_DPS_METRIC_BASIS |
| `artillery` | `td_nod_artillery` | 17,500→28,666 | 55→54 | 12,345→11,314 | 285.714→681.461 | 400→819 | 850 | HOLD_CLASS_DPS_METRIC_BASIS |
| `fire_support` | `td_nod_ssmlauncher` | 20,000→40,820 | 100→83 | 8,940→10,471 | 400.000→582.930 | 800→1,270 | 1,240 | HOLD_THIN_CLASS_COHORT |
| `grenadier` | `ra1_soviets_grenadier` | 8,000→13,786 | 75→72 | 5,791→5,000 | 400.000→356.135 | 200→237 | 230 | HOLD_THIN_CLASS_COHORT |
| `grenadier` | `td_gdi_grenadier` | 8,000→15,026 | 75→73 | 6,097→4,972 | 380.952→484.367 | 200→236 | 230 | HOLD_THIN_CLASS_COHORT |
| `heavy_infantry` | `ra1_soviets_shocktrooper` | 40,000→30,547 | 40→48 | 4,652→5,962 | 750.000→357.900 | 600→704 | 680 | HOLD_CLASS_DPS_METRIC_BASIS |
| `high_tech_tank` | `ra1_soviets_mammothtank` | 375,000→301,599 | 50→44 | 6,412→5,556 | 932.272→790.640 | 2,000→2,733 | 2,440 | HOLD_CLASS_DPS_METRIC_BASIS |
| `high_tech_tank` | `td_gdi_mammothtank` | 225,000→280,010 | 60→49 | 6,141→5,331 | 400.000→694.616 | 1,600→2,481 | 2,740 | HOLD_CLASS_DPS_METRIC_BASIS |
| `light_tank` | `ra1_allies_alliedlighttank` | 50,000→75,280 | 120→111 | 4,720→4,912 | 162.297→471.324 | 500→923 | 1,040 | HOLD_CLASS_DPS_METRIC_BASIS |
| `light_tank` | `td_nod_lighttank` | 80,000→110,334 | 110→89 | 4,993→4,710 | 133.333→341.899 | 600→982 | 930 | HOLD_CLASS_DPS_METRIC_BASIS |
| `line_breaker` | `td_nod_flametank` | 100,000→119,237 | 80→83 | 2,390→2,547 | 466.667→1,187.085 | 800→1,104 | 1,130 | HOLD_THIN_CLASS_COHORT |
| `mbt` | `ra1_allies_alliedmediumtank` | 90,000→127,394 | 100→81 | 5,159→5,133 | 170.213→323.615 | 700→1,134 | 1,350 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `mbt` | `ra1_soviets_heavytank` | 150,000→171,628 | 70→66 | 5,469→5,208 | 246.914→491.485 | 1,000→1,561 | 1,540 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `mbt` | `td_gdi_battletank` | 125,000→151,105 | 80→74 | 5,438→5,171 | 222.222→412.432 | 900→1,305 | 1,300 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `melee` | `td_nod_chemicalwarrior` | 48,000→56,186 | 48→58 | 3,414→2,841 | 1,000.000→939.107 | 500→604 | 500 | HOLD_THIN_CLASS_COHORT |
| `melee` | `td_nod_flamethrower` | 20,000→28,557 | 60→65 | 2,085→2,511 | 333.333→481.908 | 200→284 | 330 | HOLD_THIN_CLASS_COHORT |
| `missile_vehicle` | `td_gdi_mlrs` | 25,000→43,874 | 80→74 | 9,920→10,014 | 352.941→686.352 | 1,000→1,396 | 1,350 | HOLD_CLASS_DPS_METRIC_BASIS |
| `missile_vehicle` | `td_nod_reconbike` | 17,500→34,983 | 200→184 | 6,000→5,392 | 492.554→516.740 | 500→736 | 1,140 | HOLD_CLASS_DPS_METRIC_BASIS |
| `missile_vehicle` | `td_nod_stealthtank` | 25,000→43,303 | 150→131 | 7,432→6,098 | 363.636→711.410 | 900→1,394 | 520 | HOLD_CLASS_DPS_METRIC_BASIS |
| `rocket_trooper` | `ra1_soviets_rocketsoldier` | 10,000→13,854 | 55→50 | 6,643→7,242 | 400.000→258.613 | 300→436 | 410 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `rocket_trooper` | `ra1_allies_alliedrocketsoldier` | 10,000→13,854 | 55→50 | 6,643→7,242 | 400.000→258.613 | 300→436 | 510 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `rocket_trooper` | `td_gdi_rocketsoldier` | 9,000→14,581 | 50→45 | 6,368→6,732 | 285.714→285.018 | 300→433 | 400 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `rocket_trooper` | `td_nod_rocketsoldier` | 9,000→14,581 | 50→45 | 6,368→6,732 | 285.714→285.018 | 300→433 | 400 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `scout` | `ra1_soviets_rifleinfantry` | 34,000→21,062 | 54→55 | 4,668→4,611 | 42.000→188.688 | 100→138 | 110 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `scout` | `ra1_allies_rifleinfantry` | 27,000→19,883 | 55→56 | 5,500→4,804 | 48.621→190.294 | 100→138 | 110 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `scout` | `td_gdi_minigunner` | 31,000→22,376 | 63→58 | 5,499→4,417 | 32.542→251.288 | 100→132 | 110 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `scout` | `td_nod_minigunner` | 30,000→22,193 | 66→59 | 4,609→4,227 | 41.429→254.588 | 100→132 | 130 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `scout_vehicle` | `ra1_allies_ranger` | 22,500→39,547 | 175→157 | 4,359→4,267 | 640.000→526.888 | 300→562 | 510 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `scout_vehicle` | `td_gdi_humvee` | 27,500→45,459 | 150→144 | 4,792→4,337 | 857.143→707.501 | 400→584 | 560 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `scout_vehicle` | `td_nod_buggy` | 20,000→35,645 | 200→161 | 4,540→4,278 | 600.000→615.443 | 300→450 | 590 | HOLD_CLASS_FIT_RESIDUAL |
...
|---|---|---|---:|---:|---:|---|---|
| `ra1_allies_alliedaagun` | def | — | 62,500 | — | 500 | STATIC_DEFENSE_MODEL_REQUIRED | The mobile-anchor classifier excludes defenses. Use a reviewed HP/range/DPS defense model; no invented movement speed. |
...
| `ra1_allies_alliedgunturret` | def | — | 100,000 | — | 800 | STATIC_DEFENSE_MODEL_REQUIRED | The mobile-anchor classifier excludes defenses. Use a reviewed HP/range/DPS defense model; no invented movement speed. |
...
| `ra1_allies_alliedoretruck` | veh | — | 100,000 | 90 | 1,000 | ECONOMY_MANUAL_REVIEW | Harvesters retain the economy/manual-review rule and do not need a combat DPS anchor. |
...
| `ra1_allies_blackhawk` | air | — | 50,000 | 130 | 1,000 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `ra1_allies_cruiser` | nav | — | 225,000 | 40 | 3,000 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
| `ra1_allies_destroyer` | nav | — | 125,000 | 85 | 1,600 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `ra1_allies_gunboat` | nav | — | 60,000 | 120 | 1,300 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
| `ra1_allies_longbow` | air | — | 35,000 | 150 | 2,000 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `ra1_allies_rapierjumpjet` | air | — | 77,500 | 210 | 1,300 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `ra1_soviets_armoredyak` | air | — | 80,000 | 135 | 1,600 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `ra1_soviets_flametower` | def | — | 64,000 | — | 600 | STATIC_DEFENSE_MODEL_REQUIRED | The mobile-anchor classifier excludes defenses. Use a reviewed HP/range/DPS defense model; no invented movement speed. |
...
| `ra1_soviets_heavyindustrialminer` | veh | — | 135,000 | 80 | 1,200 | ECONOMY_MANUAL_REVIEW | Harvesters retain the economy/manual-review rule and do not need a combat DPS anchor. |
...
| `ra1_soviets_hindattackhelicopter` | air | — | 100,000 | 120 | 1,800 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `ra1_soviets_kamovattackhelicopter` | air | — | 122,500 | 125 | 2,100 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `ra1_soviets_migattackbomber` | air | — | 40,000 | 200 | 1,400 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
| `ra1_soviets_missilesubmarine` | nav | — | 70,000 | 60 | 3,000 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `ra1_soviets_nuclearyak` | air | — | 64,000 | 190 | 2,000 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
| `ra1_soviets_nukedemotruck` | veh | — | 20,000 | 100 | 1,500 | CLASS_MEMBERSHIP_REQUIRED | No eligible mapped class member |
| `ra1_soviets_oretruck` | veh | — | 100,000 | 90 | 1,000 | ECONOMY_MANUAL_REVIEW | Harvesters retain the economy/manual-review rule and do not need a combat DPS anchor. |
...
| `ra1_soviets_samsite` | def | — | 75,000 | — | 700 | STATIC_DEFENSE_MODEL_REQUIRED | The mobile-anchor classifier excludes defenses. Use a reviewed HP/range/DPS defense model; no invented movement speed. |
...
| `ra1_soviets_su57attackbomber` | air | — | 65,000 | 220 | 3,000 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
| `ra1_soviets_submarine` | nav | — | 100,000 | 75 | 1,000 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `ra1_soviets_teslacoil` | def | — | 90,000 | — | 1,500 | STATIC_DEFENSE_MODEL_REQUIRED | The mobile-anchor classifier excludes defenses. Use a reviewed HP/range/DPS defense model; no invented movement speed. |
...
| `ra1_soviets_teslayak` | air | — | 64,000 | 190 | 2,000 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `ra1_soviets_yakscoutplane` | air | — | 32,000 | 170 | 800 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `td_gdi_advancedguardtower` | def | — | 140,000 | — | 1,600 | STATIC_DEFENSE_MODEL_REQUIRED | The mobile-anchor classifier excludes defenses. Use a reviewed HP/range/DPS defense model; no invented movement speed. |
...
| `td_gdi_firehawk` | air | — | 180,000 | 180 | 2,000 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `td_gdi_guardtower` | def | — | 60,000 | — | 500 | STATIC_DEFENSE_MODEL_REQUIRED | The mobile-anchor classifier excludes defenses. Use a reviewed HP/range/DPS defense model; no invented movement speed. |
...
| `td_gdi_missileboat` | nav | — | 75,000 | 100 | 1,600 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `td_gdi_orca` | air | — | 32,500 | 175 | 1,700 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `td_gdi_railgunbattleship` | nav | — | 167,500 | 50 | 2,600 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `td_gdi_skyshield` | def | — | 93,000 | — | 900 | STATIC_DEFENSE_MODEL_REQUIRED | The mobile-anchor classifier excludes defenses. Use a reviewed HP/range/DPS defense model; no invented movement speed. |
...
| `td_gdi_supercarrier` | nav | — | 300,000 | 50 | 4,000 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
| `td_gdi_tiberiumharvester` | veh | — | 150,000 | 60 | 1,000 | ECONOMY_MANUAL_REVIEW | Harvesters retain the economy/manual-review rule and do not need a combat DPS anchor. |
| `td_nod_apacheattackhelicopter` | air | — | 45,000 | 160 | 1,600 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `td_nod_attacksubmarine` | nav | — | 160,000 | 80 | 1,600 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
| `td_nod_ballisticmissilesubmarine` | nav | — | 200,000 | 60 | 2,800 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `td_nod_gunturret` | def | — | 150,000 | — | 700 | STATIC_DEFENSE_MODEL_REQUIRED | The mobile-anchor classifier excludes defenses. Use a reviewed HP/range/DPS defense model; no invented movement speed. |
...
| `td_nod_lasercorvette` | nav | — | 150,000 | 60 | 2,300 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
...
| `td_nod_laserturret` | def | — | 72,500 | — | 1,000 | STATIC_DEFENSE_MODEL_REQUIRED | The mobile-anchor classifier excludes defenses. Use a reviewed HP/range/DPS defense model; no invented movement speed. |
...
| `td_nod_obeliskoflight` | def | — | 242,500 | — | 1,800 | STATIC_DEFENSE_MODEL_REQUIRED | The mobile-anchor classifier excludes defenses. Use a reviewed HP/range/DPS defense model; no invented movement speed. |
...
| `td_nod_samsite` | def | — | 100,000 | — | 800 | STATIC_DEFENSE_MODEL_REQUIRED | The mobile-anchor classifier excludes defenses. Use a reviewed HP/range/DPS defense model; no invented movement speed. |
...
| `td_nod_stealthharvester` | veh | — | 125,000 | 75 | 1,000 | ECONOMY_MANUAL_REVIEW | Harvesters retain the economy/manual-review rule and do not need a combat DPS anchor. |
...
| `td_nod_tiberiumharvester` | veh | — | 150,000 | 60 | 1,000 | ECONOMY_MANUAL_REVIEW | Harvesters retain the economy/manual-review rule and do not need a combat DPS anchor. |
...
| `td_nod_venom` | air | — | 27,500 | 200 | 900 | AIR_OR_NAVAL_CLASS_DESIGN_REQUIRED | The actor has an air/naval role but no approved corresponding class in the current registry. |
