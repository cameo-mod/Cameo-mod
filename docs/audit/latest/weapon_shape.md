...
|---|---|--:|--:|
| W1 | more than 3 inherits | **506** (23.45% of 2158) | 26.16% |
...
| W6 | effect warheads declared LOCALLY | **683** | 683 |
...
|---|--:|
| no `^Effect_*` inherit | 1207 |
| no `^Projectile_*` inherit | 1448 |
| no `^Warhead_*` inherit | 1042 |
...
## W7 ΓÇö inherits from ANOTHER WEAPON, not a template (963 vs ratchet 963)
...
## W6 ΓÇö effect warheads declared LOCALLY (683 vs ratchet 683)
