...
Live weapon files in the manifest: **41** · names defined more than once: **7**
...
| weapon | defined at |
|---|---|
| `ChemTibAtomic` | `ContentPacks/RedAlert/Shared/yaml/weapons.yaml:2597` · `weapons/tiberiandawn.yaml:231` |
...
| `Sound2` | `ContentPacks/D2k/Ordos/yaml/weapons.yaml:3352` · `ContentPacks/D2k/Atreides/yaml/weapons.yaml:15` |
