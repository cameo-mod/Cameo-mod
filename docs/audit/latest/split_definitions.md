...
Live weapon files in the manifest: **43** · names defined more than once: **8**
...
| weapon | defined at |
|---|---|
| `ChemTibAtomic` | `ContentPacks/RedAlert/Shared/yaml/weapons.yaml:1311` · `weapons/tiberiandawn.yaml:204` |
...
| `ZClaw3` | `weapons/tiberiansun.yaml:1294` · `weapons/tiberiansun.yaml:1909` |
