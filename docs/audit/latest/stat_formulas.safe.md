# audit_stat_formulas ΓÇö house stat formulas

Violations: **788** across 1884 roster actors (reference-clean units: gdiarcher, raider.ordos)


## F1 ΓÇö Repairable.HpPerStep Γëá HP/20  (40)
...
## F2 ΓÇö SelfHealing Step Γëá HP/2500 (inf: HP/1000)  (94)
...
## F3 ΓÇö infantry with Repairable  (10)
...
_243 further infantry inherit Repairable from the infantry base template (^DefaultInfantry RepairActors: drfghospΓÇª ΓÇö unloaded Dark Reign hospitals). One template-line fix covers them all._


## F4 ΓÇö upgrade shield RegenAmount Γëá 2├ùSelfHealing Step  (59)
...
## F5 ΓÇö defense RevealsShroud.Range Γëá weapon range  (41)
...
## F6 ΓÇö AA/advanced defense DetectCloaked.Range Γëá weapon range/2  (18)
...
## F7 ΓÇö defense Power.Amount Γëá -Cost/20  (92)
...
## F8 ΓÇö vehicle TurnSpeed Γëá Speed/5  (33)
...
## F9 ΓÇö Turreted.TurnSpeed Γëá Mobile.TurnSpeed  (50)
...
## F10 ΓÇö turretless TurnSpeed Γëá 2├ùSpeed/5 (artillery: Speed/5)  (45)
...
## F11 ΓÇö turreted artillery missing/incorrect firing-slow (Archer pattern)  (36)
...
## F12 ΓÇö anti-air defense not gated by the faction's radar tier  (0)

_none found_


## F13 ΓÇö advanced defense not gated by the faction's tech tier  (3)

| actor | actual | expected |
|---|---|---|
| ordos: ordos_autogunturret | prereqs: ordos_barracks, ordos_constructionyard (gate 2, radar tier 3) | DEFERRED: valid, but faction's only pre-radar defense ΓÇö add a Tier-1 defense before regating |
| ordos: ordos_artilleryplatform | prereqs: ordos_barracks, ordos_constructionyard (gate 2, radar tier 3) | DEFERRED: valid, but faction's only pre-radar defense ΓÇö add a Tier-1 defense before regating |
| schwarzermond: schwarzermond_lasertower | prereqs: schwarzermond_barracks, schwarzermond_constructionyard (gate 2, radar tier 3) | DEFERRED: valid, but faction's only pre-radar defense ΓÇö add a Tier-1 defense before regating |


## F14 ΓÇö StartingUnits referencing nonexistent actors (crash class)  (0)

_none found_


## F15 ΓÇö Light Support composition (Tier-1 only, ~2000, 5:1 inf:veh)  (68)
...
| harkonnen: ixian_L | total cost 3300 | target ~2000 (┬▒15%) |
| harkonnen: ixian_L | 5 infantry : 2 vehicles | want ~5 infantry per vehicle |
...
## F16 ΓÇö Heavy Support composition (all tiers, ~10000, 5:1 inf:veh)  (111)
...
| harkonnen: ixian_h | total cost 7100 | target ~10000 (┬▒15%) |
| harkonnen: ixian_h | 5 infantry : 4 vehicles | want ~5 infantry per vehicle |
...
## F17 ΓÇö fighter/bomber TurnSpeed Γëá Speed/15 (frontal: 2├ù)  (6)
...
## F18 ΓÇö weapons targeting Air whose damage warheads can't hit Air  (20)
...
## F19 ΓÇö helicopter/spaceship TurnSpeed Γëá Speed/5  (32)
...
## F20 ΓÇö AA support vehicle: air range Γëá 1.5 ├ù ground range  (6)
...
## F22 ΓÇö promotion tech gate Γëá unlocked unit's tech gate  (24)

| actor | actual | expected |
|---|---|---|
| futuretech: futuretech_cryolegionnaire | unit tech tier 7 | promotion futuretech_promotion_unlockcryolegionnaire tier 0 ΓÇö must match |
| futuretech: futuretech_futuretank | unit tech tier 7 | promotion futuretech_promotion_unlockfuturetank tier 0 ΓÇö must match |
| futuretech: futuretech_harbingergunship | unit tech tier 7 | promotion futuretech_promotion_unlockharbingergunship tier 0 ΓÇö must match |
| harkonnen: heavy_rocket_raider.ixian | unit tech tier 5 | promotion ixian_promotion_unlockheavyixraider tier 0 ΓÇö must match |
| harkonnen: ixian_ixprojector | unit tech tier 5 | promotion ixian_promotion_unlockixprojector tier 0 ΓÇö must match |
| harkonnen: ixian_ixsiegetank | unit tech tier 5 | promotion ixian_promotion_unlockixsiegetank tier 0 ΓÇö must match |
| harkonnen: ixian_neocymek | unit tech tier 5 | promotion ixian_promotion_unlockneocymek tier 0 ΓÇö must match |
| harkonnen: ixian_stormraider | unit tech tier 5 | promotion ixian_promotion_unlockstormraider tier 0 ΓÇö must match |
| ixian: heavy_rocket_raider.ixian | unit tech tier 5 | promotion ixian_promotion_unlockheavyixraider tier 0 ΓÇö must match |
| ixian: ixian_ixprojector | unit tech tier 5 | promotion ixian_promotion_unlockixprojector tier 0 ΓÇö must match |
| ixian: ixian_ixsiegetank | unit tech tier 5 | promotion ixian_promotion_unlockixsiegetank tier 0 ΓÇö must match |
| ixian: ixian_neocymek | unit tech tier 5 | promotion ixian_promotion_unlockneocymek tier 0 ΓÇö must match |
| ixian: ixian_stormraider | unit tech tier 5 | promotion ixian_promotion_unlockstormraider tier 0 ΓÇö must match |
| latinsyndicate: latinsyndicate_burrito | unit tech tier 5 | promotion latinsyndicate_promotion_unlockburritos tier 0 ΓÇö must match |
| latinsyndicate: latinsyndicate_lars | unit tech tier 5 | promotion latinsyndicate_promotion_unlocklars tier 0 ΓÇö must match |
| latinsyndicate: latinsyndicate_topolm | unit tech tier 5 | promotion latinsyndicate_promotion_unlocktopolm tier 0 ΓÇö must match |
| ordos: ordos_deviatortank | unit tech tier 5 | promotion ordos_promotion_unlockdeviatortank tier 0 ΓÇö must match |
| ordos: ordos_dustdrone | unit tech tier 5 | promotion ordos_promotion_unlockdustdrone tier 0 ΓÇö must match |
| ordos: ordos_laboratorycrawler | unit tech tier 5 | promotion ordos_promotion_unlocklaboratorycrawler tier 0 ΓÇö must match |
| ordos: ordos_lasertank | unit tech tier 5 | promotion ordos_promotion_unlocklasertank tier 0 ΓÇö must match |
| ordos: ordos_pythontank | unit tech tier 5 | promotion ordos_promotion_unlockpython tier 0 ΓÇö must match |
| ordos: ordos_stealthraider | unit tech tier 5 | promotion ordos_promotion_unlockstealthraider tier 0 ΓÇö must match |
| steelconsortium: steelconsortium_cloudbreaker | unit tech tier 5 | promotion steelconsortium_promotion_unlockcloudbreaker tier 0 ΓÇö must match |
| ts_gdi: ts_gdi_kodiakcommandship | unit tech tier 5 | promotion ts_gdi_promotion_unlockkodiak tier 0 ΓÇö must match |
