...
Commits reviewed: **427**, files touched: **1396**

| code | meaning | count | blocking |
|---|---|---|---|
| R1 | balance yaml edited without the ledger | 18 | yes |
| R2 | audit script never run by run_all.sh | 4 | yes |
| R3 | provenance (wrong-identity trailer blocks; missing one on the shared identity is review-only) | 31 | partly |
...
| docs/balance/derived/redalert_soviets.json | 24 |
| mods/cameo/ContentPacks/TiberianDawn/GDI/yaml/weapons.yaml | 24 |
| mods/cameo/ContentPacks/RedAlert/Soviets/yaml/weapons.yaml | 23 |
...
R1/R3 block only for commits on or after **2026-08-12**: 18 R1 and 0 R3 of 18/31 findings are in scope; the rest predate the gate.
