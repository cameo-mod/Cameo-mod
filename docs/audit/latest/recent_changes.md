...
Commits reviewed: **200**, files touched: **2010**
...
R1/R3 block only for commits on or after **2026-08-12**: 3 R1 and 0 R3 of 3/14 findings are in scope; the rest predate the gate.
