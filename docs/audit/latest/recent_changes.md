...
Commits reviewed: **429**, files touched: **1407**

| code | meaning | count | blocking |
|---|---|---|---|
| R1 | balance yaml edited without the ledger | 18 | yes |
| R2 | audit script never run by run_all.sh | 4 | yes |
| R3 | provenance (wrong-identity trailer blocks; missing one on the shared identity is review-only) | 34 | partly |
...
## R3 — commits without provenance (34)

| commit | date | author | problem | severity |
|---|---|---|---|---|
| 8968ea78 | 2026-09-10 | Blackrobe | agent trailer `GPT-6 Astra <noreply@openai.com>` on a non-shared identity | review |
| ec2631b9 | 2026-09-10 | Blackrobe | agent trailer `GPT-6 Astra <noreply@openai.com>` on a non-shared identity | review |
| 8850c3f1 | 2026-09-10 | Blackrobe | agent trailer `GPT-6 Astra <noreply@openai.com>` on a non-shared identity | review |
| 17022b1d | 2026-09-10 | Blackrobe | agent trailer `GPT-6 Astra <noreply@openai.com>` on a non-shared identity | review |
| 243c95cd | 2026-09-10 | Blackrobe | agent trailer `GPT-6 Astra <noreply@openai.com>` on a non-shared identity | review |
| d598557f | 2026-09-10 | Blackrobe | agent trailer `GPT-6 Astra <noreply@openai.com>` on a non-shared identity | review |
| b45546fe | 2026-09-10 | Blackrobe | agent trailer `GPT-6 Astra <noreply@openai.com>` on a non-shared identity | review |
...
| docs/balance/derived/redalert_allies.json | 23 |
| mods/cameo/ContentPacks/RedAlert/Shared/yaml/weapons.yaml | 23 |
...
| docs/balance/redalert_soviets.json | 21 |
...
R1/R3 block only for commits on or after **2026-08-12**: 18 R1 and 0 R3 of 18/34 findings are in scope; the rest predate the gate.
