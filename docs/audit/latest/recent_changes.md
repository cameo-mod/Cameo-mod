...
Commits reviewed: **426**, files touched: **1393**

| code | meaning | count | blocking |
|---|---|---|---|
| R1 | balance yaml edited without the ledger | 18 | yes |
| R2 | audit script never run by run_all.sh | 4 | yes |
| R3 | provenance (wrong-identity trailer blocks; missing one on the shared identity is review-only) | 30 | partly |
...
## R3 — commits without provenance (30)
...
| docs/balance/derived/d2k_ixian.json | 21 |
...
R1/R3 block only for commits on or after **2026-08-12**: 18 R1 and 0 R3 of 18/30 findings are in scope; the rest predate the gate.
