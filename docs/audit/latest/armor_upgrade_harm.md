...
Checked **136** generated `^Warhead_*` templates against **5** platings (skipping `^Warhead_Nuclear_Super`, `^Warhead_Sniper_Light`, which the generator does not emit).
...
|---|--:|--:|--:|
| `HAZMAT` | **70.01** | 34 | 102 |
| `COMPOSITE` | **69.98** | 35 | 106 |
| `BLAST` | **69.95** | 36 | 105 |
| `REFLECTOR` | **69.98** | 42 | 104 |
| `ARMOR` | **70.00** | 70 | 70 |
