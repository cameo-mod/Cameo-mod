...
|---|---|---:|---:|---:|---:|---:|---:|---|
| `artillery` | `ra1_allies_alliedartillery` | 20,000→29,950 | 60→58 | 13,350→11,842 | 375.188→768.059 | 600→982 | 1,240 | HOLD_DPS_METRIC_BASIS |
| `artillery` | `ra1_soviets_v2rocketlauncher` | 30,000→44,857 | 85→67 | 14,110→12,626 | 1,000.000→861.550 | 1,600→1,504 | 1,410 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `artillery` | `td_nod_artillery` | 17,500→28,671 | 55→54 | 12,345→11,320 | 285.714→681.461 | 400→819 | 850 | REVIEWABLE_NO_AUTOMATIC_WRITE |
...
| `heavy_infantry` | `ra1_soviets_shocktrooper` | 40,000→30,549 | 40→48 | 4,652→5,973 | 750.000→357.900 | 600→704 | 680 | HOLD_THIN_CLASS_COHORT |
| `high_tech_tank` | `ra1_soviets_mammothtank` | 375,000→301,654 | 50→44 | 6,412→5,566 | 932.272→790.640 | 2,000→2,733 | 2,450 | HOLD_THIN_CLASS_COHORT |
| `high_tech_tank` | `td_gdi_mammothtank` | 225,000→280,061 | 60→49 | 6,141→5,341 | 400.000→694.616 | 1,600→2,481 | 2,740 | HOLD_THIN_CLASS_COHORT |
| `light_tank` | `ra1_allies_alliedlighttank` | 50,000→75,294 | 120→111 | 4,720→4,922 | 162.297→471.324 | 500→923 | 1,050 | HOLD_THIN_CLASS_COHORT |
| `light_tank` | `td_nod_lighttank` | 80,000→110,354 | 110→89 | 4,993→4,721 | 133.333→341.899 | 600→982 | 930 | HOLD_THIN_CLASS_COHORT |
...
| `missile_vehicle` | `td_gdi_mlrs` | 25,000→43,882 | 80→74 | 9,920→10,022 | 352.941→686.352 | 1,000→1,396 | 1,350 | REVIEWABLE_NO_AUTOMATIC_WRITE |
| `missile_vehicle` | `td_nod_reconbike` | 17,500→34,990 | 200→184 | 6,000→5,404 | 492.554→516.740 | 500→736 | 1,140 | HOLD_DPS_METRIC_BASIS |
| `missile_vehicle` | `td_nod_stealthtank` | 25,000→43,311 | 150→131 | 7,432→6,110 | 363.636→711.410 | 900→1,394 | 520 | HOLD_CLASS_FIT_RESIDUAL |
