...
| legacy-first-level DIAGNOSTIC only | 53 |
...
## Profile sources
  ...
  BlastCryo  <- ^Warhead_BlastCryo_Heavy  (LEGACY-FIRST-LEVEL DIAGNOSTIC: no active level-less base exists for this family, so the bell verdict is simulated from the legacy level template)
  BlastSonic  <- ^Warhead_BlastSonic_Heavy  (LEGACY-FIRST-LEVEL DIAGNOSTIC: no active level-less base exists for this family, so the bell verdict is simulated from the legacy level template)
  ...
  BulletSonic  <- ^Warhead_BulletSonic_Heavy  (LEGACY-FIRST-LEVEL DIAGNOSTIC: no active level-less base exists for this family, so the bell verdict is simulated from the legacy level template)
  ...
  CannonSonic  <- ^Warhead_CannonSonic_Heavy  (LEGACY-FIRST-LEVEL DIAGNOSTIC: no active level-less base exists for this family, so the bell verdict is simulated from the legacy level template)
  ...
  MissileSonic  <- ^Warhead_MissileSonic_Heavy  (LEGACY-FIRST-LEVEL DIAGNOSTIC: no active level-less base exists for this family, so the bell verdict is simulated from the legacy level template)
