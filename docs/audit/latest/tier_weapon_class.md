# audit_tier_weapon_class — 39 of 1268 classifiable weapons break the TYPES x LEVELS budget
...
Historical budget shapes (not one-main compliance):
   1175  1 type, 1 level - squarely in tier
     34  2 types, 1 level - lore hybrid
     17  2 types, 2 adjacent levels - hybrid AND between-tier (budget 4)
      3  1 type, 2 ADJACENT levels - between-tier mix

    947  weapons unclassified — at least one main lacks a recognized Family_Level; this is not a balance or structural pass
...
| RA2Virusgun3 | 3 TYPES (Flak, MissileAP, Sniper) - max is 2 | Flak_Medium, MissileAP_Medium, Sniper_Light |
| RA2Virusgun_elite | 3 TYPES (Flak, MissileAP, Sniper) - max is 2 | Flak_Medium, MissileAP_Medium, Sniper_Light |
...
WARN 39 budget violations (ratchet 48)
