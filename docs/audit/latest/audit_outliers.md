...
| ChangesHealth.PercentageStep | orcs_deathknight | 83 | 1 | 55.3 |
...
| ChangesHealth.Step | steel_consortium_empressstation | 600 | 20 | 19.6 |

| ChangesHealth.Step | ts_gdi_mammothmkii | 480 | 20 | 15.5 |

| ChangesHealth.Step | ra1_soviet_volkov | 400 | 20 | 12.8 |

| ChangesHealth.Step | ra1_soviet_monstertank | 400 | 20 | 12.8 |
...
| ChangesHealth.Step | latin_syndicate_tortugatank | 350 | 20 | 11.1 |

| ChangesHealth.Step | ts_gdi_mammothprototype | 320 | 20 | 10.1 |

| ChangesHealth.Step | ra2_soviets_kirovairship | 320 | 20 | 10.1 |

| ChangesHealth.Step | japan_exorcistoitank | 300 | 20 | 9.4 |

| ChangesHealth.Step | protoss_starshipsovereign | 300 | 20 | 9.4 |

| Health.HP | schwarzer_mond_dieglocke | 3750000 | 60000 | 62.2 |
...
| Health.HP | steel_consortium_empressstation | 1500000 | 60000 | 24.3 |

| Health.HP | schwarzer_mond_spacezeppelin | 1350000 | 60000 | 21.8 |
...
| Health.HP | ra1_soviet_constructionyard | 1000000 | 60000 | 15.9 |

| Health.HP | japan_japaneseconstructionyard | 1000000 | 60000 | 15.9 |

| Health.HP | japan_japaneseshrine | 1000000 | 60000 | 15.9 |

| Health.HP | ra1_soviet_missilesilo | 1000000 | 60000 | 15.9 |

| Health.HP | ra1_soviet_ironcurtain | 1000000 | 60000 | 15.9 |

| Health.HP | ra1_allies_chronosphere | 1000000 | 60000 | 15.9 |

| Health.HP | ra1_soviet_monstertank | 1000000 | 60000 | 15.9 |
...
| Health.HP | ts_nod_constructionyard | 1000000 | 60000 | 15.9 |

| Health.HP | ts_nod_missilesilo | 1000000 | 60000 | 15.9 |
...
| Power.Amount | steel_consortium_bfg10000 | -1000 | -35 | 25.0 |

| Power.Amount | TECHBCANNON2 | -1000 | -35 | 25.0 |

| Power.Amount | steel_consortium_geothermalreactor | 750 | -35 | 20.4 |

| Power.Amount | futuretech_hypercore | 750 | -35 | 20.4 |

| Power.Amount | latin_syndicate_powerstation | 500 | -35 | 13.9 |

| Power.Amount | C2KNUKE | 500 | -35 | 13.9 |

| Power.Amount | terran_phobos | -500 | -35 | 12.1 |

| Power.Amount | protoss_starshipsovereign | -500 | -35 | 12.1 |
...
| Power.Amount | steel_consortium_consortiumpowerplant | 300 | -35 | 8.7 |

| Power.Amount | naxis_naxpetrolplant | 300 | -35 | 8.7 |

| Power.Amount | schwarzer_mond_hydrogenplant | 300 | -35 | 8.7 |

| Power.Amount | humans_farm | 300 | -35 | 8.7 |

| Power.Amount | EDEN_SOLAR_ARRAY | 300 | -35 | 8.7 |

| Power.Amount | PLYMOUTH_SOLARARRAY | 300 | -35 | 8.7 |

| Power.Amount | zerg_behemoth | -360 | -35 | 8.4 |

| Repairable.HpPerStep | japan_shogunexecutioner | 150000 | 4062.5 | 45.0 |

| Repairable.HpPerStep | naxis_ratte | 100000 | 4062.5 | 29.6 |

| Repairable.HpPerStep | ts_gdi_mammothmkii | 60000 | 4062.5 | 17.2 |

| Repairable.HpPerStep | ra1_soviet_monstertank | 50000 | 4062.5 | 14.2 |

| Repairable.HpPerStep | forgotten_experimentalmammothtank | 50000 | 4062.5 | 14.2 |

| Repairable.HpPerStep | terran_phobos | 50000 | 4062.5 | 14.2 |

| Repairable.HpPerStep | ts_gdi_kodiakcommandship | 45000 | 4062.5 | 12.6 |

| Repairable.HpPerStep | latin_syndicate_tortugatank | 43750 | 4062.5 | 12.2 |

| Repairable.HpPerStep | ts_gdi_mammothprototype | 40000 | 4062.5 | 11.1 |

| Repairable.HpPerStep | japan_exorcistoitank | 37500 | 4062.5 | 10.3 |

| Repairable.HpPerStep | protoss_starshipsovereign | 37500 | 4062.5 | 10.3 |

| Repairable.HpPerStep | japan_oitank | 32500 | 4062.5 | 8.8 |

| Repairable.HpPerStep | forgotten_nomadbarracks | 32500 | 4062.5 | 8.8 |

| Repairable.HpPerStep | futuretech_futuretank | 32500 | 4062.5 | 8.8 |

| Repairable.HpPerStep | ra1_soviet_siegemammothtank | 31250 | 4062.5 | 8.4 |

| RevealsShroud.Range | steel_consortium_bfg10000 | 25000 | 2048 | 20.2 |
...
| RevealsShroud.Range | ra1_soviet_samsite | 12790 | 2048 | 9.4 |
...
| RevealsShroud.Range | steel_consortium_empressstation | 12345 | 2048 | 9.0 |

| RevealsShroud.Range | steel_consortium_cloudbreaker | 12345 | 2048 | 9.0 |

| RevealsShroud.Range | schwarzer_mond_haunebuii | 12345 | 2048 | 9.0 |
...
| Valued.Cost | schwarzer_mond_dieglocke | 15000 | 1600 | 9.0 |

| Valued.Cost | humans_humangoldmine_2 | 15000 | 1600 | 9.0 |

| Valued.Cost | orcs_orcgoldmine_2 | 15000 | 1600 | 9.0 |
