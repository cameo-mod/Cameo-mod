...
- `TS70mmChem` (ContentPacks\TiberianSun\Forgotten\yaml\weapons.yaml) | old: LightChemicalWeapon | CannonHE_Medium=4000, CannonHE_Medium_Percentage=2, LightChemicalWeapon=2000, LightChemicalWeaponPercentage=1, Cloud=0
- `TSScoopDualChem` (ContentPacks\TiberianSun\Forgotten\yaml\weapons.yaml) | old: MediumChemicalWeapon | CannonHE_Medium=20000, CannonHE_Medium_Percentage=10, MediumChemicalWeapon=10000, MediumChemicalWeaponPercentage=5, Cloud=0
...
- `EpigraphMG` (ContentPacks\StarCraft\Protoss\yaml\weapons.yaml) | dominant: Grenade(2000) | Grenade=2000, GrenadeFriendlyFire=1000, GrenadePercentage=1, ArrowWeapon=2000, ArrowWeaponPercentage=1, LightMissile=2000, LightMissilePercentage=1, MediumMissile=2000, MediumMissilePercentage=1, HeavyMissile=2000, HeavyMissilePercentage=1, MediumChemicalWeapon=2000, MediumChemicalWeaponPercentage=1, HeavyAAWeapon=2000, HeavyAAWeaponPercentage=1, CannonHE_Heavy=2000, CannonHE_Heavy_Percentage=1, FlakWeapon=2000, FlakWeaponPercentage=1, Chaingun=2000, ChaingunPercentage=1, Effect=0, EffectWater=0, EffectAir=0 | → collapse to Grenade
...
- `facedancer_grenade` (ContentPacks\D2k\Ordos\yaml\weapons.yaml) | dominant: LightFlameWeapon(20000) | LightFlameWeapon=20000, LightFlameWeaponPercentage=10, MediumChemicalWeapon=20000, MediumChemicalWeaponPercentage=10, HeavyBomb=20000, HeavyBombPercentage=10, Grenade=20000, GrenadeFriendlyFire=10000, GrenadePercentage=10, ShrapnelWeapon=20000, ShrapnelWeaponFriendlyFire=10000, ShrapnelWeaponPercentage=10, CannonHE_Heavy=20000, CannonHE_Heavy_Percentage=10, LightMissile=20000, LightMissilePercentage=10, MediumMissile=20000, MediumMissilePercentage=10, MissileAP_Heavy=20000, MissileAP_Heavy_Percentage=10, Smudge=0, Effect=0 | → collapse to LightFlameWeapon
...
- `AsianHarbingerPlasma` (ContentPacks\RedAlert2Mod\AsianAlliance\yaml\weapons.yaml) | dominant: LightFlameWeapon(2000) | LightFlameWeapon=2000, LightFlameWeaponPercentage=1, LightChemicalWeapon=2000, LightChemicalWeaponPercentage=1, MediumFlameWeapon=2000, MediumFlameWeaponPercentage=1, MediumChemicalWeapon=2000, MediumChemicalWeaponPercentage=1, CannonHE_Medium=2000, CannonHE_Medium_Percentage=1, ShrapnelWeapon=2000, ShrapnelWeaponFriendlyFire=1000, ShrapnelWeaponPercentage=1, HeavyBomb=2000, HeavyBombPercentage=1, MissileAP_Medium=2000, MissileAP_Medium_Percentage=1, FireShrapnel=0, Effect=0 | → collapse to LightFlameWeapon
- `AsianSinglePlasma` (ContentPacks\RedAlert2Mod\AsianAlliance\yaml\weapons.yaml) | dominant: LightFlameWeapon(2000) | LightFlameWeapon=2000, LightFlameWeaponPercentage=1, LightChemicalWeapon=2000, LightChemicalWeaponPercentage=1, MediumFlameWeapon=2000, MediumFlameWeaponPercentage=1, MediumChemicalWeapon=2000, MediumChemicalWeaponPercentage=1, CannonHE_Medium=2000, CannonHE_Medium_Percentage=1, ShrapnelWeapon=2000, ShrapnelWeaponFriendlyFire=1000, ShrapnelWeaponPercentage=1, HeavyBomb=2000, HeavyBombPercentage=1, CannonHE_Heavy=2000, CannonHE_Heavy_Percentage=1, FireShrapnel=0 | → collapse to LightFlameWeapon
...
- `25mm` (ContentPacks\RedAlert\Allies\yaml\weapons.yaml) | dominant: Grenade(2000) | Grenade=2000, GrenadeFriendlyFire=1000, GrenadePercentage=1, ShrapnelWeapon=2000, ShrapnelWeaponFriendlyFire=1000, ShrapnelWeaponPercentage=1, LightFlameWeapon=2000, LightFlameWeaponPercentage=1, MediumChemicalWeapon=2000, MediumChemicalWeaponPercentage=1, TankDestroyerCannon=2000, TankDestroyerCannonPercentage=1, CannonHE_Medium=2000, CannonHE_Medium_Percentage=1, Effect=0 | → collapse to Grenade
...
- `NaxiShrek` (ContentPacks\RedAlert2Mod\Naxis\yaml\weapons.yaml) | dominant: HeavyBomb(8000) | HeavyBomb=8000, HeavyBombPercentage=4, HeavyFlameWeapon=8000, HeavyFlameWeaponPercentage=4, Grenade=8000, GrenadeFriendlyFire=4000, GrenadePercentage=4, TankDestroyerCannon=8000, TankDestroyerCannonPercentage=4, MediumChemicalWeapon=8000, MediumChemicalWeaponPercentage=4, MissileAP_Medium=8000, MissileAP_Medium_Percentage=4 | → collapse to HeavyBomb
...
- `eye_bomberguy` (ContentPacks\D2k\Ordos\yaml\weapons.yaml) | dominant: Grenade(20000) | Grenade=20000, GrenadeFriendlyFire=10000, GrenadePercentage=10, MediumChemicalWeapon=20000, MediumChemicalWeaponPercentage=10, MediumFlameWeapon=20000, MediumFlameWeaponPercentage=10, ShrapnelWeapon=20000, ShrapnelWeaponFriendlyFire=10000, ShrapnelWeaponPercentage=10, HeavyBomb=20000, HeavyBombPercentage=10, Effect=0, 4Concrete=1875 | → collapse to Grenade
...
- `HarrierMissiles` (ContentPacks\RedAlert2\Allies\yaml\weapons.yaml) | dominant: LightFlameWeapon(4000) | LightFlameWeapon=4000, LightFlameWeaponPercentage=2, Grenade=4000, GrenadeFriendlyFire=2000, GrenadePercentage=2, HeavyChemicalWeapon=4000, HeavyChemicalWeaponPercentage=2, HeavyAAWeapon=4000, HeavyAAWeaponPercentage=2, FlakWeapon=4000, FlakWeaponPercentage=2, MissileAP_Medium=4000, MissileAP_Medium_Percentage=2 | → collapse to LightFlameWeapon
...
- `SteelQuantumTurretRail` (ContentPacks\RedAlert2Mod\Consortium\yaml\weapons.yaml) | dominant: TeslaWeapon(2000) | TeslaWeapon=2000, TeslaExtraDamage=1000, TeslaWeaponPercentage=1, HeavyChemicalWeapon=2000, HeavyChemicalWeaponPercentage=1, HeavyFlameWeapon=2000, HeavyFlameWeaponPercentage=1, LaserWeapon=2000, LaserWeaponPercentage=1, RailgunWeapon=2000, RailgunWeaponPercentage=1, CannonHE_Heavy=2000, CannonHE_Heavy_Percentage=1, Effect=0 | → collapse to TeslaWeapon
...
- `SteelTwisterMissiles` (weapons\redalert2mod.yaml) | dominant: Grenade(2000) | Grenade=2000, GrenadeFriendlyFire=1000, GrenadePercentage=1, MediumFlameWeapon=2000, MediumFlameWeaponPercentage=1, FlakWeapon=2000, FlakWeaponPercentage=1, HeavyAAWeapon=2000, HeavyAAWeaponPercentage=1, MissileAP_Medium=2000, MissileAP_Medium_Percentage=1, Effect=0, EffectAir=0 | → collapse to Grenade
...
- `DuelistTankCannon` (ContentPacks\D2k\Ixian\yaml\weapons.yaml) | dominant: MediumFlameWeapon(14000) | MediumFlameWeapon=14000, MediumFlameWeaponPercentage=7, Grenade=14000, GrenadeFriendlyFire=7000, GrenadePercentage=7, HeavyBomb=14000, HeavyBombPercentage=7, TankDestroyerCannon=14000, TankDestroyerCannonPercentage=7, CannonHE_Heavy=14000, CannonHE_Heavy_Percentage=7, CannonHE_Medium=14000, CannonHE_Medium_Percentage=7, Effect=0 | → collapse to MediumFlameWeapon
...
- `HindMissilesThermobaric` (ContentPacks\RedAlert\Soviets\yaml\weapons.yaml) | dominant: Grenade(2000) | Grenade=2000, GrenadeFriendlyFire=1000, GrenadePercentage=1, ShrapnelWeapon=2000, ShrapnelWeaponFriendlyFire=1000, ShrapnelWeaponPercentage=1, MediumFlameWeapon=2000, MediumFlameWeaponPercentage=1, CannonHE_Heavy=2000, CannonHE_Heavy_Percentage=1, MediumMissile=2000, MediumMissilePercentage=1, Effect=0 | → collapse to Grenade
...
- `Future_MultiMissile_Frag` (ContentPacks\RedAlert2Mod\FutureTech\yaml\weapons.yaml) | dominant: ShrapnelWeapon(4000) | ShrapnelWeapon=4000, ShrapnelWeaponFriendlyFire=2000, ShrapnelWeaponPercentage=2, MediumFlameWeapon=4000, MediumFlameWeaponPercentage=2, LightChemicalWeapon=4000, LightChemicalWeaponPercentage=2, LightMissile=4000, LightMissilePercentage=2, FireShrapnel=0 | → collapse to ShrapnelWeapon
...
- `RA2SCUD_rad` (ContentPacks\RedAlert2\Shared\yaml\weapons.yaml) | dominant: LightChemicalWeapon(18000) | LightChemicalWeapon=18000, LightChemicalWeaponPercentage=9, MediumChemicalWeapon=18000, MediumChemicalWeaponPercentage=9, HeavyChemicalWeapon=18000, HeavyChemicalWeaponPercentage=9, MediumFlameWeapon=18000, MediumFlameWeaponPercentage=9, Demolition_Light=18000, Demolition_Light_Percentage=9, MissileAP_Heavy=18000, MissileAP_Heavy_Percentage=9, Radiation=0 | → collapse to LightChemicalWeapon
...
- `MigMissiles` (ContentPacks\RedAlert2\Shared\yaml\weapons.yaml) | dominant: HeavyBomb(8000) | HeavyBomb=8000, HeavyBombPercentage=4, HeavyAAWeapon=8000, HeavyAAWeaponPercentage=4, FlakWeapon=8000, FlakWeaponPercentage=4, MissileAP_Medium=8000, MissileAP_Medium_Percentage=4 | → collapse to HeavyBomb
...
- `D2K_RocketsCymek` (ContentPacks\D2k\Ixian\yaml\weapons.yaml) | dominant: Grenade(6000) | Grenade=6000, GrenadeFriendlyFire=3000, GrenadePercentage=3, FlakWeapon=6000, FlakWeaponPercentage=3, HeavyMissile=6000, HeavyMissilePercentage=3, MissileAP_Medium=6000, MissileAP_Medium_Percentage=3 | → collapse to Grenade
- `SCTyrAA` (ContentPacks\StarCraft\Terran\yaml\weapons.yaml) | dominant: Grenade(4000) | Grenade=4000, GrenadeFriendlyFire=2000, GrenadePercentage=2, FlakWeapon=4000, FlakWeaponPercentage=2, HeavyMissile=4000, HeavyMissilePercentage=2, MissileAP_Medium=4000, MissileAP_Medium_Percentage=2 | → collapse to Grenade
...
- `SCTyr` (ContentPacks\StarCraft\Terran\yaml\weapons.yaml) | dominant: LightFlameWeapon(4000) | LightFlameWeapon=4000, LightFlameWeaponPercentage=2, Chaingun=4000, ChaingunPercentage=2, ShrapnelWeapon=4000, ShrapnelWeaponFriendlyFire=2000, ShrapnelWeaponPercentage=2, CannonHE_Heavy=4000, CannonHE_Heavy_Percentage=2, Effect=0 | → collapse to LightFlameWeapon
...
- `RA2PsychicJab` (ContentPacks\RedAlert2\Yuri\yaml\weapons.yaml) | dominant: TankDestroyerCannon(2000) | TankDestroyerCannon=2000, TankDestroyerCannonPercentage=1, CannonHE_Medium=2000, CannonHE_Medium_Percentage=1, LightFlameWeapon=2000, LightFlameWeaponPercentage=1, FlakWeapon=2000, FlakWeaponPercentage=1 | → collapse to TankDestroyerCannon
...
- `RA2RBurritoRocket` (ContentPacks\RedAlert2Mod\Syndicate\yaml\weapons.yaml) | dominant: Demolition_Light(4000) | Demolition_Light=4000, Demolition_Light_Percentage=2, ShrapnelWeapon=4000, ShrapnelWeaponFriendlyFire=2000, ShrapnelWeaponPercentage=2, MediumFlameWeapon=4000, MediumFlameWeaponPercentage=2, HeavyBomb=4000, HeavyBombPercentage=2, MissileAP_Heavy=4000, MissileAP_Heavy_Percentage=2, FireShrapnel=0 | → collapse to Demolition_Light
...
- `ThermobaricMaverick` (ContentPacks\RedAlert\Soviets\yaml\weapons.yaml) | dominant: NuclearWarhead(12000) | NuclearWarhead=12000, NuclearWarheadPercentage=6, MediumFlameWeapon=12000, MediumFlameWeaponPercentage=6, HeavyMissile=12000, HeavyMissilePercentage=6, MissileAP_Medium=12000, MissileAP_Medium_Percentage=6, Effect=0 | → collapse to NuclearWarhead
...
- `TS70mmTurChem` (ContentPacks\TiberianSun\Forgotten\yaml\weapons.yaml) | dominant: CannonHE_Medium(4000) | CannonHE_Medium=4000, CannonHE_Medium_Percentage=2, TankDestroyerCannon=4000, TankDestroyerCannonPercentage=2, LightChemicalWeapon=4000, LightChemicalWeaponPercentage=2, Cloud=0 | → collapse to CannonHE_Medium
...
- `TSChem120mmx` (ContentPacks\TiberianSun\Forgotten\yaml\weapons.yaml) | dominant: ShrapnelWeapon(30000) | ShrapnelWeapon=30000, ShrapnelWeaponFriendlyFire=15000, ShrapnelWeaponPercentage=15, CannonHE_Medium=30000, CannonHE_Medium_Percentage=15, MediumChemicalWeapon=30000, MediumChemicalWeaponPercentage=15, Cloud=0 | → collapse to ShrapnelWeapon
- `TSChemJuggerboat90mm` (ContentPacks\TiberianSun\Forgotten\yaml\weapons.yaml) | dominant: ShrapnelWeapon(20000) | ShrapnelWeapon=20000, ShrapnelWeaponFriendlyFire=10000, ShrapnelWeaponPercentage=15, MediumChemicalWeapon=10000, MediumChemicalWeaponPercentage=6, 3Eff=0 | → collapse to ShrapnelWeapon
- `TSChemMLRSMissile` (ContentPacks\TiberianSun\Forgotten\yaml\weapons.yaml) | dominant: ShrapnelWeapon(12000) | ShrapnelWeapon=12000, ShrapnelWeaponPercentage=12, MediumChemicalWeapon=12000, MediumChemicalWeaponPercentage=6, Cloud=0 | → collapse to ShrapnelWeapon
- `TSChemVanMissile` (ContentPacks\TiberianSun\Forgotten\yaml\weapons.yaml) | dominant: ShrapnelWeapon(24000) | ShrapnelWeapon=24000, ShrapnelWeaponFriendlyFire=12000, ShrapnelWeaponPercentage=12, MediumChemicalWeapon=12000, MediumChemicalWeaponPercentage=6, Cloud=0 | → collapse to ShrapnelWeapon
- `TSScoopDualTurChem` (ContentPacks\TiberianSun\Forgotten\yaml\weapons.yaml) | dominant: CannonHE_Heavy(16000) | CannonHE_Heavy=16000, CannonHE_Heavy_Percentage=8, ShrapnelWeapon=16000, ShrapnelWeaponFriendlyFire=8000, ShrapnelWeaponPercentage=8, MediumChemicalWeapon=16000, MediumChemicalWeaponPercentage=8, Cloud=0 | → collapse to CannonHE_Heavy
...
- `RA2FreedomAK47` (ContentPacks\RedAlert2Mod\Syndicate\yaml\weapons.yaml) | dominant: CannonHE_Heavy(6000) | CannonHE_Heavy=6000, CannonHE_Heavy_Percentage=3, Chaingun=6000, ChaingunPercentage=3, SniperWeapon=6000, SniperWeaponExtraDamage=6000, SniperWeaponPercentage=3 | → collapse to CannonHE_Heavy
...
- `Laboratory_Bioball` (ContentPacks\D2k\Ordos\yaml\weapons.yaml) | dominant: Demolition_Light(10000) | Demolition_Light=10000, Demolition_Light_Percentage=5, Concussion_Medium=10000, Concussion_Medium_Percentage=6, CannonHE_Heavy=10000, CannonHE_Heavy_Percentage=6, MediumChemicalWeapon=10000, MediumChemicalWeaponPercentage=6, MediumFlameWeapon=10000, MediumFlameWeaponPercentage=5, Effect=0, 4Concrete=1875, Cloud=0 | → collapse to Demolition_Light
...
- `DeviatorMissile` (ContentPacks\D2k\Ordos\yaml\weapons.yaml) | dominant: MediumChemicalWeapon(10000) | MediumChemicalWeapon=10000, MediumChemicalWeaponPercentage=5, CannonHE_Heavy=10000, CannonHE_Heavy_Percentage=5, MediumMissile=10000, MediumMissilePercentage=5, MissileAP_Heavy=10000, MissileAP_Heavy_Percentage=5, Effect=0, OwnerChange=0, Concrete=1000 | → collapse to MediumChemicalWeapon
- `TSStankTibTusk` (ContentPacks\TiberianSun\Nod\yaml\weapons.yaml) | dominant: MediumMissile(10000) | MediumMissile=10000, MediumMissilePercentage=5, MediumChemicalWeapon=10000, MediumChemicalWeaponPercentage=5, CannonHE_Medium=10000, MediumCannonFriendlyFire=5000, CannonHE_Medium_Percentage=5 | → collapse to MediumMissile

### Grenade, MediumChemicalWeapon (2 weapons)
- `FutureMechPlasma` (ContentPacks\RedAlert2Mod\FutureTech\yaml\weapons.yaml) | dominant: Grenade(10000) | Grenade=10000, GrenadeFriendlyFire=5000, GrenadePercentage=5, MediumChemicalWeapon=10000, MediumChemicalWeaponPercentage=5, CannonHE_Heavy=10000, CannonHE_Heavy_Percentage=5, Effect=0 | → collapse to Grenade
- `VolkovMagneticWeapon` (ContentPacks\RedAlert\Soviets\yaml\weapons.yaml) | dominant: CannonHE_Heavy(10000) | CannonHE_Heavy=10000, CannonHE_Heavy_Percentage=5, MediumChemicalWeapon=10000, MediumChemicalWeaponPercentage=5, Grenade=10000, GrenadeFriendlyFire=5000, GrenadePercentage=5, Effect=0 | → collapse to CannonHE_Heavy

### HeavyBomb, LightChemicalWeapon (2 weapons)
- `NaxRatteCannon` (ContentPacks\RedAlert2Mod\Naxis\yaml\weapons.yaml) | dominant: LightChemicalWeapon(50000) | LightChemicalWeapon=50000, LightChemicalWeaponPercentage=25, HeavyBomb=50000, HeavyBombPercentage=25, CannonHE_Medium=50000, CannonHE_Medium_Percentage=25 | → collapse to LightChemicalWeapon
- `NaxisBlackBombSmaller` (weapons\redalert2mod.yaml) | dominant: LightChemicalWeapon(25000) | LightChemicalWeapon=25000, LightChemicalWeaponPercentage=10, HeavyBomb=25000, HeavyBombPercentage=10, CannonHE_Medium=25000, CannonHE_Medium_Percentage=10, Effect=0, Radiation=0, Effect=0 | → collapse to LightChemicalWeapon
...
- `TSChemBazooka` (ContentPacks\TiberianSun\Forgotten\yaml\weapons.yaml) | dominant: LightMissile(24000) | LightChemicalWeapon=6000, LightChemicalWeaponPercentage=3, LightMissile=24000, LightMissilePercentage=12, Cloud=0 | → collapse to LightMissile
- `TSTibBazooka` (ContentPacks\TiberianSun\Nod\yaml\weapons.yaml) | dominant: LightMissile(24000) | LightChemicalWeapon=6000, LightChemicalWeaponPercentage=3, LightMissile=24000, LightMissilePercentage=12 | → collapse to LightMissile
...
- `RA2MirageGun` (ContentPacks\RedAlert2\Shared\yaml\weapons.yaml) | dominant: RailgunWeapon(8000) | RailgunWeapon=8000, RailgunWeaponPercentage=4, MediumChemicalWeapon=8000, MediumChemicalWeaponPercentage=4, CannonAP_Light=8000, CannonAP_Light_Percentage=4 | → collapse to RailgunWeapon

### MediumFlameWeapon, ShrapnelWeapon (2 weapons)
- `GrenadeThermobaric` (ContentPacks\RedAlert\Soviets\yaml\weapons.yaml) | dominant: ShrapnelWeapon(4000) | ShrapnelWeapon=4000, ShrapnelWeaponFriendlyFire=2000, ShrapnelWeaponPercentage=2, Demolition_Light=4000, Demolition_Light_Percentage=2, MediumFlameWeapon=4000, MediumFlameWeaponPercentage=2, Flame_Light=4000, Flame_Light_Percentage=2 | → collapse to ShrapnelWeapon
...
- `ra120mm2` (ContentPacks\RedAlert\Soviets\yaml\weapons.yaml) | dominant: LightChemicalWeapon(16000) | LightChemicalWeapon=16000, LightChemicalWeaponPercentage=8, MediumFlameWeapon=16000, MediumFlameWeaponPercentage=8, CannonHE_Heavy=16000, CannonHE_Heavy_Percentage=8, Effect=0 | → collapse to LightChemicalWeapon

### LightChemicalWeapon, TeslaWeapon (1 weapons)
- `SteelMakoGun_EMP` (ContentPacks\RedAlert2Mod\Consortium\yaml\weapons.yaml) | dominant: EMPUnit(6000) | MediumFlameWeapon=2000, MediumFlameWeaponPercentage=1, Demolition_Light=2000, Demolition_Light_Percentage=1, Railgun_Heavy=2000, Railgun_Heavy_Percentage=1, CannonHE_Medium=2000, CannonHE_Medium_Percentage=1, LightChemicalWeapon=2000, LightChemicalWeaponPercentage=1, TeslaWeapon=2000, TeslaExtraDamage=1000, TeslaWeaponPercentage=1, EMPUnit=6000 | → collapse to EMPUnit
...
- `VolkovMagneticWeaponIncendiaryNuclearShells` (ContentPacks\RedAlert\Soviets\yaml\weapons.yaml) | dominant: MediumFlameWeapon(40000) | MediumFlameWeapon=40000, MediumFlameWeaponPercentage=20, CannonHE_Heavy=40000, CannonHE_Heavy_Percentage=20, MediumChemicalWeapon=40000, MediumChemicalWeaponPercentage=20, Grenade=40000, GrenadeFriendlyFire=20000, GrenadePercentage=20, NuclearWarhead=40000, NuclearWarheadPercentage=20, Effect=0 | → collapse to MediumFlameWeapon

### MediumFlameWeapon, TankDestroyerCannon (1 weapons)
- `CannonAttackRobotGun` (ContentPacks\RedAlert2Mod\FutureTech\yaml\weapons.yaml) | dominant: TankDestroyerCannon(2000) | TankDestroyerCannon=2000, TankDestroyerCannonPercentage=1, MediumFlameWeapon=2000, MediumFlameWeaponPercentage=1, Railgun_Heavy=2000, Railgun_Heavy_Percentage=1, CannonHE_Medium=2000, CannonHE_Medium_Percentage=1, Effect=0 | → collapse to TankDestroyerCannon
...
- `RA2120xmm` (ContentPacks\RedAlert2\Soviets\yaml\weapons.yaml) | dominant: TankDestroyerCannon(4000) | TankDestroyerCannon=4000, TankDestroyerCannonPercentage=2, ShrapnelWeapon=4000, ShrapnelWeaponFriendlyFire=2000, ShrapnelWeaponPercentage=2, CannonHE_Heavy=4000, CannonHE_Heavy_Percentage=2 | → collapse to TankDestroyerCannon
