...
- Groups: **12**; assembly resolved: **11**; gate resolved: **11**; gate unresolved: **1**.
...
| td/gdi/orca/vehicle/base | UNRESOLVED | — | expected_identity_mismatch:0:weapon:'td_gdi_orca_orcamissiles'!='td_gdi_orca_hellfire'; expected_identity_mismatch:1:weapon:'HellfireAG.Orca'!='Hellfire'; expected_identity_mismatch:3:weapon:'OrcaAGMissiles'!='Hellfire' |
