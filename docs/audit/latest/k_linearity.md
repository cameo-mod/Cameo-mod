...
| `edenMobileDefenceLaser` | +1.7728 |
| `Napalm` | +1.7343 |
| `CabalMantisGun` | +1.7313 |
...
| `NapalmA10Carrier` | +1.6476 |
| `TSLaserTurretLaser` | +1.6389 |
| `Lunar_YellowUbermenschLaser_elite` | +1.6263 |
| `Lunar_AmplifiedUbermenschLaser_elite` | +1.6263 |
