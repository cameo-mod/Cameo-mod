...
| `AsianTwinPlasma` | +2.0606 |
| `Tentacle` | +2.0064 |
| `ra1_soviets_migattackbomber_thermobaricmaverick` | +1.9305 |
...
| `Lunar_YellowUbermenschLaser_elite` | +1.6023 |
| `Lunar_AmplifiedUbermenschLaser_elite` | +1.6023 |
