...
|---|--:|
| `AsianTurretPlasma` | +2.3933 |
| `AsianTwinPlasma_elite` | +2.1418 |
| `AsianTwinPlasma` | +2.0605 |
| `Tentacle` | +2.0064 |
| `ra1_soviets_migattackbomber_thermobaricmaverick` | +1.9304 |
| `FutureMechPlasma_elite` | +1.9256 |
| `AsianSinglePlasma_elite` | +1.8978 |
| `FutureMechPlasma` | +1.8547 |
| `AsianSinglePlasma` | +1.8520 |
| `ra1_soviets_btr80_machinegun_tesla` | +1.7697 |
| `ra1_soviets_btr80_machinegun_tesla_arc` | +1.7697 |
| `Napalm` | +1.7497 |
| `edenMobileDefenceLaser` | +1.7464 |
| `CabalMantisGun` | +1.7058 |
| `RA2LasherLaser` | +1.7046 |
| `AsianChemicalBombs` | +1.6936 |
| `ra1_allies_alliedgunturret_cannon` | +1.6813 |
| `NapalmA10Carrier` | +1.6613 |
| `TSTurretLaser` | +1.6476 |
| `TSCABALPlasmaFire` | +1.6476 |
| `d2kChainGun_upgrade` | +1.6442 |
| `schwarzermond_lunarsoldier_rifle_yellow` | +1.6316 |
| `schwarzermond_lunarsoldier_rifle_amplified` | +1.6316 |
| `TSLaserTurretLaser` | +1.6146 |
| `Lunar_YellowUbermenschLaser_elite` | +1.6022 |
| `Lunar_AmplifiedUbermenschLaser_elite` | +1.6022 |
| `schwarzermond_lunarsoldier_rifle_yellow_elite` | +1.5973 |
| `schwarzermond_lunarsoldier_rifle_amplified_elite` | +1.5973 |
