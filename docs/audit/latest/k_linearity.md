...
Analysed **2041** concrete weapons.
...
66 weapon(s) carry a %-twin; **33** have a floor at or above 25% of output.
...
| `RA2KirovBomb_nuclear` | 33.1% |
| `VolkovMagneticWeaponNuclearShells` | 32.1% |
| `RA2KirovBomb_nuclear_elite` | 29.4% |
