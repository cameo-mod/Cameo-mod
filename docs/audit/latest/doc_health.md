...
- `tools/balance/gen_weapon_template.py`:1462 — cites §12.0i (CONTINUOUS HEAVINESS — the global armor ) but names `PROFILE`, which is §12.0 (THE PROFILE SHAPE LAW (maintainer, 2026-)
