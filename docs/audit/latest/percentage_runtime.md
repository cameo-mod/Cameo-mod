...
- Physical state: `NaxDieGlocke`, `RAVulcanCryo`, `SheridanVulcanCryo`, `ra1_allies_alliedaagun_flak_cryo`, `ra1_allies_blackhawk_chaingun_cryo`, `ra1_allies_ranger_machinegun_cryo`, `wc2deathknightDeathAndDecay_Hit`
