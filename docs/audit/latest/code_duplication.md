...
Python files: **727** (min 5 statements), C# files: **364** (min 8 lines)
...
| C3 | identical module-level literal tables | 40 | 10 |
...
## C3 — Duplicated constant tables (40 group(s))
...
| 3 | 783c5216cd3c1bf0 | tools/audit/audit_versus_profile.py:79 NON_ARMOR; tools/balance/analyse_flat_main_fold.py:55 NON_ARMOR; tools/balance/preview_bell.py:45 OFF_AXIS |
...
| 3 | e82cdb37ffc15514 | tools/audit/audit_versus_profile.py:81 LADDERS; tools/balance/gen_weapon_template.py:35 LADDERS; tools/reference/warhead_workbook.py:72 LADDERS |
| 3 | ee8795bea6c56142 | tools/audit/audit_versus_profile.py:88 LEVELS; tools/reference/cameo_families.py:38 LEVELS; tools/reference/propose_family_profiles.py:113 LEVEL_ORDER |
...
| 2 | 05b492a648a61f78 | tools/audit/audit_family_uniqueness.py:52 COMPANION; tools/audit/audit_versus_profile.py:89 COMPANION |
...
| 2 | 14e3e91bbb89b6e6 | tools/aud_to_wav.py:25 INDEX_ADJUST; tools/wav_to_aud.py:32 INDEX_ADJUST |
