...
| `shield_versus_mean` | 162.193 | 88.0773 | **MISMATCH** |
| `shield_hp_factor` | 0.61655 | 1.13537 | **MISMATCH** |
| `shield_damage_share` | 0.0144427 | 0.0171309 | **MISMATCH** |
...
| `physical_state_fired_weapons` | 542 | 543 | **MISMATCH** |
| `plating_row_ties` | 0 | 0 | ✅ |
| `plating_families` | 52 | 52 | ✅ |
| `signed_off_class_anchors` | 0 | 0 | ✅ |
| `warhead_family_reach` | 1530 | 1530 | ✅ |
| `unconverted_template_inheritors` | 827 | 385 | **MISMATCH** |
| `ledgers_drifted` | 0 | 25 | **MISMATCH** |
...
| `cameo_family_labelled_weapons` | 1116 | 1210 | **MISMATCH** |
