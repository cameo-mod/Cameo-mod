...
| `shield_versus_mean` | 162.193 | 160.484 | **MISMATCH** |
| `shield_hp_factor` | 0.61655 | 0.623116 | **MISMATCH** |
| `shield_damage_share` | 0.0144427 | 0.014935 | ✅ |
...
| `physical_state_fired_weapons` | 533 | 542 | **MISMATCH** |
