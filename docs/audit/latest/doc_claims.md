...
| `shield_versus_mean` | 88.0773 | 99.4053 | **MISMATCH** |
| `shield_hp_factor` | 1.13537 | 1.00598 | **MISMATCH** |
| `shield_damage_share` | 0.0171309 | 0.0167321 | ✅ |
| `always_on_shield_actors` | 58 | 58 | ✅ |
| `always_on_shielded_buildings` | 16 | 16 | ✅ |
| `live_damage_multipliers` | 326 | 328 | **MISMATCH** |
| `multi_main_fired_weapons` | 1 | 1 | ✅ |
| `percentage_denominator_unset` | 417 | 423 | **MISMATCH** |
| `unmigrated_scout_damage_multiplier` | 0 | 0 | ✅ |
| `meters_filling_before_death` | 318 | 328 | **MISMATCH** |
| `corrosion_meter_actors` | 839 | 839 | ✅ |
| `w24_multi_main_fed` | 269 | 224 | **MISMATCH** |
| `physical_state_fired_weapons` | 544 | 547 | **MISMATCH** |
| `plating_row_ties` | 0 | 0 | ✅ |
| `plating_families` | 52 | 52 | ✅ |
| `signed_off_class_anchors` | 0 | 0 | ✅ |
| `warhead_family_reach` | 1530 | 1493 | **MISMATCH** |
| `unconverted_template_inheritors` | 385 | 390 | **MISMATCH** |
| `ledgers_drifted` | 0 | 17 | **MISMATCH** |
...
| `cameo_family_labelled_weapons` | 1210 | 1291 | **MISMATCH** |
