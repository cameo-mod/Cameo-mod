...
| `shield_versus_mean` | 180.284 | 180.284 | ✅ |
| `shield_hp_factor` | 0.55468 | 0.55468 | ✅ |
| `shield_damage_share` | 0.0152182 | 0.0144437 | **MISMATCH** |
...
| `percentage_denominator_unset` | 184 | 404 | **MISMATCH** |
| `unmigrated_scout_damage_multiplier` | 18 | 0 | **MISMATCH** |
| `meters_filling_before_death` | 310 | 309 | **MISMATCH** |
...
| `warhead_family_reach` | 1454 | 1531 | **MISMATCH** |
| `unconverted_template_inheritors` | 1590 | 1168 | **MISMATCH** |
| `ledgers_drifted` | 0 | 5 | **MISMATCH** |
| `armament_multi_role_actors` | 106 | 104 | **MISMATCH** |
