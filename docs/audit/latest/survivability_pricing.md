...
Shield row mean Versus **161.83**, so one shield point is **0.6179 HP** BEFORE any shield-gated `DamageMultiplier` — measured off the live ladder every run, never frozen. The Shield row takes **1.482%** of all roster raw damage at baseline.
