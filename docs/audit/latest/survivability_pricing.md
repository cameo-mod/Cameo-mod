...
* Implied price change if the formula read effective HP: median **×1.369**, max **×1.733**
...
| redalert2mod_consortium | `steelconsortium_stalker` | 140,000 | 280,000 | 287,520 | ×2.054 | 4,000 | ×1.675 |
| redalert2mod_consortium | `steelconsortium_whiterabbit` | 150,000 | 300,000 | 308,057 | ×2.054 | 4,500 | ×1.558 |
...
| redalert2mod_consortium | `cruiser_f.steel` | 37,500 | 75,000 | 77,014 | ×2.054 | 125 | ×1.516 |
| starcraft_protoss | `protoss_mobilenexus` | 300,000 | 300,000 | 458,057 | ×1.527 | 5,000 | ×1.479 |
| starcraft_protoss | `protoss_starshipsovereign` | 750,000 | 750,000 | 1,145,142 | ×1.527 | 10,000 | ×1.440 |
...
| starcraft_protoss | `protoss_epigraph` | 200,000 | 200,000 | 305,371 | ×1.527 | 2,600 | ×1.386 |
| starcraft_protoss | `protoss_shuttle` | 100,000 | 100,000 | 152,686 | ×1.527 | 6,000 | ×1.383 |
| starcraft_protoss | `protoss_arbiter` | 225,000 | 225,000 | 343,542 | ×1.527 | 4,800 | ×1.370 |
| starcraft_protoss | `protoss_carrier` | 300,000 | 300,000 | 458,057 | ×1.527 | 3,000 | ×1.368 |
| starcraft_protoss | `protoss_idol` | 350,000 | 350,000 | 534,399 | ×1.527 | 2,800 | ×1.366 |
| starcraft_protoss | `protoss_atreus` | 250,000 | 250,000 | 381,714 | ×1.527 | 2,400 | ×1.362 |
| starcraft_protoss | `protoss_zeratul` | 250,000 | 250,000 | 381,714 | ×1.527 | 4,000 | ×1.356 |
| redalert2mod_consortium | `cougar.steel` | 25,000 | 50,000 | 51,343 | ×2.054 | 1,200 | ×1.355 |
| starcraft_protoss | `protoss_corsair` | 125,000 | 125,000 | 190,857 | ×1.527 | 2,100 | ×1.350 |
| redalert2mod_consortium | `steelconsortium_cloudbreaker` | 250,000 | 250,000 | 381,714 | ×1.527 | 5,000 | ×1.347 |
| starcraft_protoss | `protoss_reaver` | 275,000 | 275,000 | 419,885 | ×1.527 | 2,700 | ×1.332 |
| redalert2mod_consortium | `hummer.steel` | 45,000 | 67,500 | 80,563 | ×1.790 | 2,000 | ×1.320 |
| starcraft_protoss | `protoss_scout` | 75,000 | 75,000 | 114,514 | ×1.527 | 1,500 | ×1.306 |
| redalert2mod_consortium | `oldqtnk.steel` | 112,500 | 112,500 | 171,771 | ×1.527 | 2,400 | ×1.300 |
| starcraft_protoss | `protoss_voidray` | 70,000 | 70,000 | 106,880 | ×1.527 | 1,400 | ×1.299 |
...
| starcraft_protoss | `protoss_dragoon` | 75,000 | 75,000 | 114,514 | ×1.527 | 1,200 | ×1.245 |
| starcraft_protoss | `protoss_patriarch` | 75,000 | 75,000 | 114,514 | ×1.527 | 4,000 | ×1.237 |
...
| starcraft_protoss | `protoss_analogue` | 60,000 | 60,000 | 91,611 | ×1.527 | 1,200 | ×1.189 |
| starcraft_protoss | `protoss_probe` | 45,000 | 45,000 | 68,708 | ×1.527 | 500 | ×1.189 |
...
| starcraft_protoss | `protoss_adept` | 30,000 | 30,000 | 45,806 | ×1.527 | 650 | ×1.124 |
| starcraft_protoss | `protoss_manifold` | 25,000 | 25,000 | 38,171 | ×1.527 | 600 | ×1.115 |
| starcraft_protoss | `protoss_photoncannon` | 200,000 | 200,000 | 305,371 | ×1.527 | 2,000 | ×1.062 |
