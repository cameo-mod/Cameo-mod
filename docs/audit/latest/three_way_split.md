# audit_three_way_split — 1138 of 2345 weapons fire more than ONE main warhead

    971  correct — exactly one main warhead
    236  none — utility / effect-only weapons
   1138  VIOLATIONS — stacked mains
...
446 distinct stacked combinations; the 20 most common:

| count | combination |
|---|---|
| 66 | Bullet_Light + Bullet_Medium |
...
WARN 1138 violating weapons (ratchet 1176)
