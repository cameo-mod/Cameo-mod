# `dreadnought` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 0 of 5 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | unavailable | 1.15e+06 | unavailable | unavailable | unavailable | ledger medians / no reference preference |
| speed0 | unavailable | 50 | unavailable | unavailable | unavailable | ledger medians / no reference preference |
| range0_wdist | unavailable | 7000 | unavailable | unavailable | unavailable | ledger medians / no reference preference |
| cost0 | unavailable | 3000 | unavailable | unavailable | unavailable | ledger medians / no reference preference |

Status: NO SOURCE
NO SOURCE means no eligible member of this class in the selected faction pool — class members or references outside the pool are not borrowed.
...
|---|---|--:|--:|--:|--:|
| anchor: terran_warhound | ledger | 300000 | 45 | 7156 | 4500 |
| anchor: terran_warhound | live | 300000 | 45 | 7156 | 4500 |
| verifier: ixian_neocymek | ledger | 300000 | 45 | 6787 | 4500 |
| verifier: ixian_neocymek | live | 300000 | 45 | 6787 | 4500 |

Verifier / anchor ratios (HP, speed, range, cost): 1 / 1 / 0.948435 / 1

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 1438.38 | 0.75 | 0.313866 | 0 |
| verifier | 1212.12 | 0.75 | 0.68079 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| naxis_sturmtiger | redalert2mod_naxis | REF | 250000 | 30 | 14000 | 2500 | live resolved YAML |
| asianalliance_pulverizermecha | redalert2mod_asianalliance | FORMULA | 285000 | 55 | 7020 | 3000 | live resolved YAML |
| ixian_neocymek | d2k_ixian | FORMULA | 300000 | 45 | 6787 | 4500 | live resolved YAML |
| schwarzermond_neojagdpanzer | redalert2mod_schwarzermond | FORMULA | 450000 | 45 | 7379 | 4500 | live resolved YAML |
| terran_warhound | starcraft_terran | FORMULA | 300000 | 45 | 7156 | 4500 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| naxis_sturmtiger | RA2 0XX/TNKD | 191485 (n=1) | 42.0221 (n=1) | 8706.22 (n=1) | 1963.39 (n=1) | 2656.09 (n=1) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 300000 | 1.15e+06 | -850000 | -73.9% |
| speed | 45 | 50 | -5 | -10.0% |
| range_wdist | 7156 | 7000 | +156 | +2.2% |
| cost | 4500 | 3000 | +1500 | +50.0% |
...
|---|--:|--:|--:|--:|
| terran_warhound / hp | 300000 | 300000 | unavailable | unavailable |
| terran_warhound / speed | 45 | 45 | unavailable | unavailable |
| terran_warhound / range_wdist | 7156 | 7156 | unavailable | unavailable |
| terran_warhound / cost | 4500 | 4500 | unavailable | unavailable |
| ixian_neocymek / hp | 300000 | 300000 | unavailable | unavailable |
| ixian_neocymek / speed | 45 | 45 | unavailable | unavailable |
| ixian_neocymek / range_wdist | 6787 | 6787 | unavailable | unavailable |
| ixian_neocymek / cost | 4500 | 4500 | unavailable | unavailable |
