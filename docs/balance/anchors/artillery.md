# `artillery` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 8 of 34 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 25000 | 60000 | 5 | 13.2353 | ra1_allies_alliedartillery, ra1_soviets_nuclearv2launcher, ra1_soviets_v1rockettruck, ra1_soviets_v2rocketlauncher, td_nod_artillery | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 80 | 75 | 5 | 76.4706 | ra1_allies_alliedartillery, ra1_soviets_nuclearv2launcher, ra1_soviets_v1rockettruck, ra1_soviets_v2rocketlauncher, td_nod_artillery | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 12550 | 15000 | 5 | 65 | ra1_allies_alliedartillery, ra1_soviets_nuclearv2launcher, ra1_soviets_v1rockettruck, ra1_soviets_v2rocketlauncher, td_nod_artillery | reference-backed ledger medians, snapped to step 10 |
| cost0 | 900 | 500 | 5 | 30.8824 | ra1_allies_alliedartillery, ra1_soviets_nuclearv2launcher, ra1_soviets_v1rockettruck, ra1_soviets_v2rocketlauncher, td_nod_artillery | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: ra1_allies_alliedartillery | ledger | 20000 | 60 | 13350 | 600 |
| anchor: ra1_allies_alliedartillery | live | 20000 | 60 | 13350 | 600 |
| verifier: naxis_brummbar | ledger | 90000 | 60 | 14000 | 1100 |
| verifier: naxis_brummbar | live | 90000 | 60 | 14000 | 1100 |

Verifier / anchor ratios (HP, speed, range, cost): 4.5 / 1 / 1.04869 / 1.83333

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 375 | 1 | 2.29664 | 0 |
| verifier | 300 | 0.6846 | 0.208033 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| td_nod_artillery | tiberiandawn_nod | REF | 17500 | 55 | 12345 | 400 | live resolved YAML |
| atreides_siegetank | d2k_atreides | FORMULA | 40000 | 43 | 10000 | 600 | live resolved YAML |
| corrino_siegetank | d2k_corrino | FORMULA | 40000 | 56 | 10000 | 600 | live resolved YAML |
| ra1_allies_alliedartillery | redalert_allies | REF | 20000 | 60 | 13350 | 600 | live resolved YAML |
| siege_tank | shared_d2k | FORMULA | 40000 | 43 | 10000 | 600 | excluded from fit (buildable=False and no explicit balance_include) |
| asianalliance_viper | redalert2mod_asianalliance | REF | 25000 | 125 | 9000 | 700 | live resolved YAML |
| atreides_missiletank | d2k_atreides | REF | 50000 | 64 | 10240 | 750 | live resolved YAML |
| corrino_missiletank | d2k_corrino | FORMULA | 50000 | 64 | 10240 | 750 | live resolved YAML |
| harkonnen_buzzsaw | d2k_harkonnen | FORMULA | 70000 | 43 | 4352 | 800 | live resolved YAML |
| naxis_grille | redalert2mod_naxis | FORMULA | 40000 | 80 | 12345 | 800 | live resolved YAML |
| wc2_orcs_catapult | warcraft2_orcs | FORMULA | 40000 | 40 | 13400 | 800 | live resolved YAML |
| ra1_soviets_v1rockettruck | redalert_soviets | REF | 25000 | 100 | 9595 | 850 | live resolved YAML |
| atreides_minotaurus | d2k_atreides | FORMULA | 40000 | 43 | 10000 | 900 | live resolved YAML |
| harkonnen_inkvine | d2k_harkonnen | FORMULA | 45000 | 43 | 10000 | 900 | live resolved YAML |
| ra2_soviets_v3rocketlauncher | redalert2_soviets | REF | 37500 | 75 | unavailable | 900 | live resolved YAML |
| td_nod_specterartillery | tiberiandawn_nod | FORMULA | 22500 | 100 | 12640 | 900 | live resolved YAML |
| wc2_humans_ballista | warcraft2_humans | FORMULA | 45000 | 45 | 14450 | 900 | live resolved YAML |
| steelconsortium_hammerheadartillerytank | redalert2mod_consortium | FORMULA | 52500 | 100 | unavailable | 1000 | live resolved YAML |
| naxis_brummbar | redalert2mod_naxis | FORMULA | 90000 | 60 | 14000 | 1100 | live resolved YAML |
| japan_ballista | redalert_japan | FORMULA | 65000 | 65 | 13515 | 1150 | live resolved YAML |
| td_nod_chemicalssmlauncher | tiberiandawn_nod | FORMULA | 32500 | 75 | 12345 | 1200 | live resolved YAML |
| tkm_tornadoglauncher | redalert2mod_tkm | FORMULA | 35000 | 80 | 12437 | 1200 | live resolved YAML |
| cabal_artilleryspider | tiberiansun_cabal | REF | 50000 | 70 | 11580 | 1250 | live resolved YAML |
| ordos_deviatorartillery | d2k_ordos | REF | 55000 | 55 | 10025 | 1250 | live resolved YAML |
| steelconsortium_dagger | redalert2mod_consortium | FORMULA | 25000 | 100 | 20000 | 1300 | live resolved YAML |
| ra1_soviets_v2rocketlauncher | redalert_soviets | REF | 30000 | 85 | 14110 | 1600 | live resolved YAML |
| tkm_dronepodtruck | redalert2mod_tkm | REF | 60000 | 60 | 23589 | 1600 | live resolved YAML |
| latinsyndicate_burrito | redalert2mod_syndicate | REF | 35000 | 80 | 12000 | 1800 | live resolved YAML |
| wc2_humans_siegeengine | warcraft2_humans | FORMULA | 70000 | 70 | 11200 | 1800 | live resolved YAML |
| wc2_orcs_siegeengine | warcraft2_orcs | FORMULA | 70000 | 70 | 11200 | 1800 | live resolved YAML |
| ixian_ixsiegetank | d2k_ixian | FORMULA | 60000 | 60 | 12000 | 2050 | live resolved YAML |
| futuretech_athenacannon | redalert2mod_futuretech | REF | 62500 | 60 | unavailable | 2200 | live resolved YAML |
| ts_gdi_juggernautmkii | tiberiansun_gdi | FORMULA | 50000 | 70 | 12860 | 2200 | live resolved YAML |
| naxis_donnerschlag | redalert2mod_naxis | FORMULA | 80000 | 40 | unavailable | 2300 | live resolved YAML |
| ra1_soviets_nuclearv2launcher | redalert_soviets | REF | 40000 | 80 | 12550 | 2300 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| atreides_missiletank | OpenRA Dune 2000/missile_tank | 55317.5 (n=1) | 67.7138 (n=1) | 10558.7 (n=1) | 1126.02 (n=1) | unavailable (n=0) | unapproved |
| ordos_deviatorartillery | OpenRA Dune 2000/deviator | 55355.8 (n=1) | 59.1671 (n=1) | 8891.07 (n=1) | 1534.3 (n=1) | unavailable (n=0) | unapproved |
| ra2_soviets_v3rocketlauncher | CnC Reloaded/V3; Mental Omega/V3; RA2 0XX/V3; RA2 Reborn/V3; Red Resurrection/V3; Romanov's Vengeance/v3; Valiant Shades/topol | 49589 (n=7) | 54.8611 (n=7) | 14270.1 (n=4) | 1477.2 (n=7) | 26.3105 (n=4) | unapproved |
| asianalliance_viper | RA2 Reborn/HOVER | 45151.1 (n=1) | 116.982 (n=1) | 7122.96 (n=1) | 914.632 (n=1) | 481.728 (n=1) | unapproved |
| futuretech_athenacannon | Mental Omega/BASS | 64859.2 (n=1) | 51.7896 (n=1) | 14506.5 (n=1) | 2305.53 (n=1) | 7913.46 (n=1) | unapproved |
| latinsyndicate_burrito | Mental Omega/BURA | 47869 (n=1) | 66.0181 (n=1) | 12563 (n=1) | 1909.49 (n=1) | 455.312 (n=1) | unapproved |
| tkm_dronepodtruck | Rise of the East/DRON | 44127.6 (n=1) | 80.7456 (n=1) | 6340.47 (n=1) | 1062.88 (n=1) | 8.4245 (n=1) | unapproved |
| ra1_allies_alliedartillery | Combined Arms/ARTY; DTA Enhanced/RAARTY; OpenRA Red Alert/ARTY | 29944.7 (n=3) | 57.6665 (n=3) | 11836.7 (n=3) | 981.84 (n=3) | 768.059 (n=3) | unapproved |
| ra1_soviets_nuclearv2launcher | Combined Arms/NUKC | 88711.4 (n=1) | 63.3935 (n=1) | unavailable (n=0) | 3010.08 (n=1) | unavailable (n=0) | unapproved |
| ra1_soviets_v1rockettruck | Combined Arms/KATY | 33382.6 (n=1) | 76.9314 (n=1) | 9283.1 (n=1) | 1035.2 (n=1) | 452.56 (n=1) | unapproved |
| ra1_soviets_v2rocketlauncher | Combined Arms/V2RL; DTA Enhanced/V2RL; OpenRA Red Alert/V2RL | 44849 (n=3) | 67.2095 (n=3) | 12621.1 (n=3) | 1504.21 (n=3) | 861.55 (n=3) | unapproved |
| td_nod_artillery | Combined Arms/ARTY.nod; DTA Enhanced/ARTY; OpenRA Tiberian Dawn/ARTY | 28665.6 (n=3) | 54.2197 (n=3) | 11314.1 (n=3) | 818.935 (n=3) | 681.461 (n=3) | unapproved |
| cabal_artilleryspider | CnC Reloaded/AHOWI | 44457.7 (n=1) | 66.0283 (n=1) | 12106 (n=1) | 1370.26 (n=1) | 1023.93 (n=1) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 20000 | 60000 | -40000 | -66.7% |
| speed | 60 | 75 | -15 | -20.0% |
| range_wdist | 13350 | 15000 | -1650 | -11.0% |
| cost | 600 | 500 | +100 | +20.0% |
...
|---|--:|--:|--:|--:|
| ra1_allies_alliedartillery / hp | 20000 | 20000 | 25000 | -20.0% |
| ra1_allies_alliedartillery / speed | 60 | 60 | 80 | -25.0% |
| ra1_allies_alliedartillery / range_wdist | 13350 | 13350 | 12550 | +6.4% |
| ra1_allies_alliedartillery / cost | 600 | 600 | 900 | -33.3% |
| naxis_brummbar / hp | 90000 | 90000 | 25000 | +260.0% |
| naxis_brummbar / speed | 60 | 60 | 80 | -25.0% |
| naxis_brummbar / range_wdist | 14000 | 14000 | 12550 | +11.6% |
| naxis_brummbar / cost | 1100 | 1100 | 900 | +22.2% |
...
- `atreides_missiletank` / `mtank_pri`: 2 mains
- `corrino_missiletank` / `mtank_pri`: 2 mains
- `tkm_tornadoglauncher` / `tkmkatyushalalauncherrocketsfire`: 3 mains
- `japan_ballista` / `BallistaMultiShot`: 2 mains
- `ra1_soviets_v1rockettruck` / `ra1_soviets_v1rockettruck_v1rocketsthermobaric`: 2 mains
- `ra1_soviets_v2rocketlauncher` / `ra1_soviets_v2rocketlauncher_scudthermobaric`: 5 mains
