# `armed_troop_transport` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 3 of 3 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 69000 | 50000 | 2 | 66.6667 | ra1_soviets_btr80, td_gdi_apc | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 95 | 100 | 2 | 33.3333 | ra1_soviets_btr80, td_gdi_apc | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 5560 | 6000 | 2 | 66.6667 | ra1_soviets_btr80, td_gdi_apc | reference-backed ledger medians, snapped to step 10 |
| cost0 | 1500 | 1200 | 2 | 33.3333 | ra1_soviets_btr80, td_gdi_apc | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: td_gdi_apc | ledger | 47500 | 100 | 5668 | 1400 |
| anchor: td_gdi_apc | live | 47500 | 100 | 5668 | 1400 |
...
|---|---|---|--:|--:|--:|--:|---|
| td_gdi_apc | tiberiandawn_gdi | REF | 47500 | 100 | 5668 | 1400 | live resolved YAML |
| ra1_soviets_btr80 | redalert_soviets | REF | 90000 | 90 | 5454 | 1620 | live resolved YAML |
| ra1_allies_phasetransport | redalert_allies | FORMULA | 30000 | 125 | 5038 | 1960 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| ra1_soviets_btr80 | Combined Arms/BTR | 86696.3 (n=1) | 99.7799 (n=1) | 5034.74 (n=1) | 1349.8 (n=1) | 692.508 (n=1) | unapproved |
| td_gdi_apc | Combined Arms/APC2; DTA Enhanced/APC; OpenRA Tiberian Dawn/APC | 69811.6 (n=3) | 118.898 (n=3) | 4841.65 (n=3) | 1097.86 (n=3) | 533.155 (n=3) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 47500 | 50000 | -2500 | -5.0% |
| speed | 100 | 100 | +0 | +0.0% |
| range_wdist | 5668 | 6000 | -332 | -5.5% |
| cost | 1400 | 1200 | +200 | +16.7% |
...
|---|--:|--:|--:|--:|
| td_gdi_apc / hp | 47500 | 47500 | 69000 | -31.2% |
| td_gdi_apc / speed | 100 | 100 | 95 | +5.3% |
| td_gdi_apc / range_wdist | 5668 | 5668 | 5560 | +1.9% |
| td_gdi_apc / cost | 1400 | 1400 | 1500 | -6.7% |
