# `tank_destroyer` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 1 of 5 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 120000 | 150000 | 1 | 50 | ra1_allies_alliedtankdestroyer | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 60 | 70 | 1 | 30 | ra1_allies_alliedtankdestroyer | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 6820 | 7500 | 1 | 10 | ra1_allies_alliedtankdestroyer | reference-backed ledger medians, snapped to step 10 |
| cost0 | 1200 | 600 | 1 | 10 | ra1_allies_alliedtankdestroyer | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: naxis_hetzer | ledger | 75000 | 75 | 7132 | 1300 |
| anchor: naxis_hetzer | live | 75000 | 75 | 7132 | 1300 |
| verifier: ra2_allies_tankdestroyer | ledger | 145000 | 65 | 7040 | 1500 |
| verifier: ra2_allies_tankdestroyer | live | 145000 | 65 | 7040 | 1500 |

Verifier / anchor ratios (HP, speed, range, cost): 1.93333 / 0.866667 / 0.9871 / 1.15385

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 500 | 1 | 0.13672 | 0 |
| verifier | 500 | 0.8639 | 0.39406 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| ra1_allies_alliedtankdestroyer | redalert_allies | REF | 120000 | 60 | 6819 | 1200 | live resolved YAML |
| naxis_hetzer | redalert2mod_naxis | FORMULA | 75000 | 75 | 7132 | 1300 | live resolved YAML |
| ra2_allies_tankdestroyer | redalert2_allies | REF | 145000 | 65 | 7040 | 1500 | live resolved YAML |
| naxis_jagdpanzer | redalert2mod_naxis | FORMULA | 125000 | 50 | 7396 | 2000 | live resolved YAML |
| ordos_tankdestroyer | d2k_ordos | FORMULA | 80000 | 90 | 8500 | 2200 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| ra2_allies_tankdestroyer | CnC Reloaded/TNKD; RA2 0XX/TNKD; RA2 Reborn/TNKD; Red Resurrection/TNKD | 112607 (n=4) | 61.3035 (n=4) | 5404.03 (n=3) | 1425.54 (n=4) | 1619 (n=3) | unapproved |
| ra1_allies_alliedtankdestroyer | Combined Arms/TNKD; DTA Enhanced/TNKD | 124162 (n=2) | 62.7337 (n=2) | 7240.69 (n=2) | 1642.84 (n=2) | 597.453 (n=2) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 75000 | 150000 | -75000 | -50.0% |
| speed | 75 | 70 | +5 | +7.1% |
| range_wdist | 7132 | 7500 | -368 | -4.9% |
| cost | 1300 | 600 | +700 | +116.7% |
...
|---|--:|--:|--:|--:|
| naxis_hetzer / hp | 75000 | 75000 | 120000 | -37.5% |
| naxis_hetzer / speed | 75 | 75 | 60 | +25.0% |
| naxis_hetzer / range_wdist | 7132 | 7132 | 6820 | +4.6% |
| naxis_hetzer / cost | 1300 | 1300 | 1200 | +8.3% |
| ra2_allies_tankdestroyer / hp | 145000 | 145000 | 120000 | +20.8% |
| ra2_allies_tankdestroyer / speed | 65 | 65 | 60 | +8.3% |
| ra2_allies_tankdestroyer / range_wdist | 7040 | 7040 | 6820 | +3.2% |
| ra2_allies_tankdestroyer / cost | 1500 | 1500 | 1200 | +25.0% |
