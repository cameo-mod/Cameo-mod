...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 1 of 4 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 20000 | 20000 | 1 | 37.5 | japan_archermaiden | ledger medians / no reference preference, snapped to step 1000 |
| speed0 | 72 | 70 | 1 | 37.5 | japan_archermaiden | ledger medians / no reference preference, snapped to step 1 |
| range0_wdist | 7500 | 7000 | 1 | 87.5 | japan_archermaiden | ledger medians / no reference preference, snapped to step 10 |
| cost0 | 500 | 500 | 1 | 37.5 | japan_archermaiden | ledger medians / no reference preference, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: japan_archermaiden | ledger | 20000 | 72 | 7500 | 500 |
| anchor: japan_archermaiden | live | 20000 | 72 | 7500 | 500 |
| verifier: asianalliance_veteranarcher | ledger | 14000 | 68 | 6740 | 450 |
| verifier: asianalliance_veteranarcher | live | 14000 | 68 | 6740 | 450 |

Verifier / anchor ratios (HP, speed, range, cost): 0.7 / 0.944444 / 0.898667 / 0.9

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 400 | 1 | 0.02295 | 0 |
| verifier | 529.412 | 1 | 0.12852 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| asianalliance_veteranarcher | redalert2mod_asianalliance | FORMULA | 14000 | 68 | 6740 | 450 | live resolved YAML |
| japan_archermaiden | redalert_japan | FORMULA | 20000 | 72 | 7500 | 500 | live resolved YAML |
| wc2_humans_elvenarcher | warcraft2_humans | FORMULA | 25000 | 75 | 6973 | 600 | live resolved YAML |
| wc2_humans_highelvenarcher | warcraft2_humans | FORMULA | 35000 | 85 | 7487 | 1100 | live resolved YAML |
...
|---|--:|--:|--:|--:|
| japan_archermaiden / hp | 20000 | 20000 | 20000 | +0.0% |
| japan_archermaiden / speed | 72 | 72 | 72 | +0.0% |
| japan_archermaiden / range_wdist | 7500 | 7500 | 7500 | +0.0% |
| japan_archermaiden / cost | 500 | 500 | 500 | +0.0% |
| asianalliance_veteranarcher / hp | 14000 | 14000 | 20000 | -30.0% |
| asianalliance_veteranarcher / speed | 68 | 68 | 72 | -5.6% |
| asianalliance_veteranarcher / range_wdist | 6740 | 6740 | 7500 | -10.1% |
| asianalliance_veteranarcher / cost | 450 | 450 | 500 | -10.0% |
...
- `japan_archermaiden` / `JapanMaidenBowEnergized`: 3 mains
