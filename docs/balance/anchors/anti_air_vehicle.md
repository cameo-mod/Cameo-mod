# `anti_air_vehicle` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 4 of 14 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 100000 | 170000 | 2 | 85.7143 | ra1_allies_alliedheavyaatank, ra1_soviets_gatlingtank | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 75 | 110 | 2 | 35.7143 | ra1_allies_alliedheavyaatank, ra1_soviets_gatlingtank | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 4870 | 6000 | 2 | 7.69231 | ra1_allies_alliedheavyaatank, ra1_soviets_gatlingtank | reference-backed ledger medians, snapped to step 10 |
| cost0 | 1200 | 1000 | 2 | 64.2857 | ra1_allies_alliedheavyaatank, ra1_soviets_gatlingtank | reference-backed ledger medians, snapped to step 100 |

Status: UNAPPROVED; THIN hp; THIN speed; BIASED range_wdist — do not sign; THIN range_wdist; THIN cost; NO MODEL — calibrated damage/reload not supplied
...
|---|---|--:|--:|--:|--:|
| anchor: latinsyndicate_diablo | ledger | 45000 | 125 | 6300 | 1200 |
| anchor: latinsyndicate_diablo | live | 45000 | 125 | 6300 | 1200 |
| verifier: steelconsortium_barracuda | ledger | 40000 | 80 | 8000 | 1100 |
| verifier: steelconsortium_barracuda | live | 40000 | 80 | 8000 | 1100 |

Verifier / anchor ratios (HP, speed, range, cost): 0.888889 / 0.64 / 1.26984 / 0.916667

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 500 | 1 | 0.74754 | 0 |
| verifier | 500 | 1 | 0.51742 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| japan_armoredcar | redalert_japan | FORMULA | 42500 | 130 | 5012 | 700 | live resolved YAML |
| harkonnen_adp | d2k_harkonnen | FORMULA | 50000 | 64 | 5500 | 750 | live resolved YAML |
| ra1_soviets_flaktruck | redalert_soviets | FORMULA | 30000 | 120 | 5412 | 800 | live resolved YAML |
| naxis_kubelwagen | redalert2mod_naxis | FORMULA | 50000 | 115 | 5757 | 850 | live resolved YAML |
| ra2_soviets_flaktrack | redalert2_soviets | REF | 45000 | 95 | 5528 | 900 | live resolved YAML |
| forgotten_m113adats | tiberiansun_forgotten | FORMULA | 50000 | 70 | 5606 | 950 | live resolved YAML |
| ra1_soviets_gatlingtank | redalert_soviets | REF | 75000 | 75 | 5000 | 1100 | live resolved YAML |
| steelconsortium_barracuda | redalert2mod_consortium | FORMULA | 40000 | 80 | 8000 | 1100 | live resolved YAML |
| yuri_gatlingtank | redalert2_yuri | REF | 45000 | 90 | 5000 | 1100 | live resolved YAML |
| latinsyndicate_diablo | redalert2mod_syndicate | FORMULA | 45000 | 125 | 6300 | 1200 | live resolved YAML |
| ra1_allies_alliedheavyaatank | redalert_allies | REF | 125000 | 75 | 4746 | 1250 | live resolved YAML |
| asianalliance_pulverizer | redalert2mod_asianalliance | REF | 85000 | 65 | 5517 | 1400 | live resolved YAML |
| naxis_wirbelwind | redalert2mod_naxis | FORMULA | 87500 | 85 | 5368 | 1800 | live resolved YAML |
| tkm_flakbus | redalert2mod_tkm | FORMULA | 120000 | 60 | unavailable | 1800 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| ra2_soviets_flaktrack | CnC Reloaded/HTK; Mental Omega/HTK; RA2 Reborn/HTK; Red Resurrection/HTK; Romanov's Vengeance/htk; Valiant Shades/htk | 54790.8 (n=6) | 96.6246 (n=6) | 5718.53 (n=6) | 751.799 (n=6) | 412.059 (n=6) | unapproved |
| yuri_gatlingtank | CnC Reloaded/YTNK; Mental Omega/YTNK; RA2 0XX/YTNK; RA2 Reborn/YTNK; Red Resurrection/YTNK; Romanov's Vengeance/ytnk | 51264.3 (n=6) | 80.55 (n=6) | 5269.33 (n=6) | 843.743 (n=6) | 655.785 (n=6) | unapproved |
| asianalliance_pulverizer | RA2 Reborn/SMIN | 176016 (n=1) | 52.6648 (n=1) | 5351.8 (n=1) | 1581.39 (n=1) | 513.661 (n=1) | unapproved |
| ra1_allies_alliedheavyaatank | DTA Enhanced/MFLAK | 94044 (n=1) | 75.091 (n=1) | 5124.16 (n=1) | 982.146 (n=1) | 506.078 (n=1) | unapproved |
| ra1_soviets_gatlingtank | Combined Arms/BTR | 79142.5 (n=1) | 91.0862 (n=1) | 4820.64 (n=1) | 1119.19 (n=1) | 437.981 (n=1) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 45000 | 170000 | -125000 | -73.5% |
| speed | 125 | 110 | +15 | +13.6% |
| range_wdist | 6300 | 6000 | +300 | +5.0% |
| cost | 1200 | 1000 | +200 | +20.0% |
...
|---|--:|--:|--:|--:|
| latinsyndicate_diablo / hp | 45000 | 45000 | 100000 | -55.0% |
| latinsyndicate_diablo / speed | 125 | 125 | 75 | +66.7% |
| latinsyndicate_diablo / range_wdist | 6300 | 6300 | 4870 | +29.4% |
| latinsyndicate_diablo / cost | 1200 | 1200 | 1200 | +0.0% |
| steelconsortium_barracuda / hp | 40000 | 40000 | 100000 | -60.0% |
| steelconsortium_barracuda / speed | 80 | 80 | 75 | +6.7% |
| steelconsortium_barracuda / range_wdist | 8000 | 8000 | 4870 | +64.3% |
| steelconsortium_barracuda / cost | 1100 | 1100 | 1200 | -8.3% |
...
- `harkonnen_adp` / `D2K_Rocket_AA`: 2 mains
- `japan_armoredcar` / `ArmoredCarMGWaveforce`: 2 mains
