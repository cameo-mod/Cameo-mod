# `missile_vehicle` — NOT READY / UNAPPROVED
...
|---|--:|--:|--:|--:|---|---|
| hp0 | 25000 | 160000 | 3 | 28.5714 | td_gdi_mlrs, td_nod_reconbike, td_nod_stealthtank | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 150 | 100 | 3 | 75 | td_gdi_mlrs, td_nod_reconbike, td_nod_stealthtank | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 7430 | 8000 | 3 | 39.2857 | td_gdi_mlrs, td_nod_reconbike, td_nod_stealthtank | reference-backed ledger medians, snapped to step 10 |
| cost0 | 900 | 1200 | 3 | 42.8571 | td_gdi_mlrs, td_nod_reconbike, td_nod_stealthtank | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: ts_gdi_hovermlrs | ledger | 30000 | 80 | 8159 | 900 |
| anchor: ts_gdi_hovermlrs | live | 30000 | 80 | 8159 | 900 |
| verifier: terran_cyclone | ledger | 90000 | 115 | 7320 | 2300 |
| verifier: terran_cyclone | live | 90000 | 115 | 7320 | 2300 |

Verifier / anchor ratios (HP, speed, range, cost): 3 / 1.4375 / 0.897169 / 2.55556

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 352.941 | 1 | 0.116507 | 0 |
| verifier | 533.333 | 1 | 0.009375 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| td_nod_reconbike | tiberiandawn_nod | REF | 17500 | 200 | 6000 | 500 | live resolved YAML |
| ts_nod_attackcycle | tiberiansun_nod | REF | 20000 | 170 | 6554 | 550 | live resolved YAML |
| atreides_mongoose | d2k_atreides | FORMULA | 50000 | 64 | 10240 | 750 | live resolved YAML |
| missile_tank | d2k_harkonnen | FORMULA | 50000 | 64 | 10240 | 750 | live resolved YAML |
| td_nod_chemicalattackbike | tiberiandawn_nod | FORMULA | 22500 | 175 | 6000 | 750 | live resolved YAML |
| td_nod_stealthtank | tiberiandawn_nod | REF | 25000 | 150 | 7432 | 900 | live resolved YAML |
| ts_gdi_hovermlrs | tiberiansun_gdi | REF | 30000 | 80 | 8159 | 900 | live resolved YAML |
| td_gdi_mlrs | tiberiandawn_gdi | REF | 25000 | 80 | 9920 | 1000 | live resolved YAML |
| asianalliance_type89mlrs | redalert2mod_asianalliance | FORMULA | 40000 | 80 | 8500 | 1200 | live resolved YAML |
| latinsyndicate_lars | redalert2mod_syndicate | FORMULA | 47500 | 70 | 10130 | 1300 | live resolved YAML |
| ordos_dustdrone | d2k_ordos | FORMULA | 32500 | 145 | 6500 | 1400 | live resolved YAML |
| tkm_stryker | redalert2mod_tkm | REF | 80000 | 105 | 7880 | 1600 | live resolved YAML |
| ixian_ixmissiletank | d2k_ixian | FORMULA | 50000 | 50 | 10052 | 2250 | live resolved YAML |
| terran_cyclone | starcraft_terran | FORMULA | 90000 | 115 | 7320 | 2300 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| tkm_stryker | Mental Omega/TRIKE; Rise of the East/STRIDER | 44089.8 (n=2) | 108.842 (n=2) | 7267.19 (n=2) | 1078.62 (n=2) | 720.114 (n=2) | unapproved |
| td_gdi_mlrs | Combined Arms/MSAM; DTA Enhanced/MSAM; OpenRA Tiberian Dawn/MSAM | 43873.5 (n=3) | 74.0261 (n=3) | 10013.8 (n=3) | 1396.31 (n=3) | 686.352 (n=3) | unapproved |
| td_nod_reconbike | Combined Arms/BIKE; DTA Enhanced/BIKE; OpenRA Tiberian Dawn/BIKE | 34983.2 (n=3) | 183.889 (n=3) | 5392.34 (n=3) | 736.382 (n=3) | 516.74 (n=3) | unapproved |
| td_nod_stealthtank | Combined Arms/STNK.Nod; DTA Enhanced/STNK; OpenRA Tiberian Dawn/STNK | 43303.1 (n=3) | 131.327 (n=3) | 6098.11 (n=3) | 1393.61 (n=3) | 711.41 (n=3) | unapproved |
| ts_gdi_hovermlrs | CnC Reloaded/TSHVR; OpenRA Tiberian Sun/HVR; Shattered Paradise/HVR | 48397.5 (n=3) | 99.1385 (n=3) | 8336.88 (n=3) | 1214.17 (n=3) | 380.136 (n=2) | unapproved |
| ts_nod_attackcycle | CnC Reloaded/TSBIKE; Crystallized Nexus/BIKE; OpenRA Tiberian Sun/BIKE; Shattered Paradise/ATTACKBIKE | 29085.9 (n=4) | 167.548 (n=4) | 5024.2 (n=3) | 698.02 (n=4) | 416.33 (n=3) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 30000 | 160000 | -130000 | -81.2% |
| speed | 80 | 100 | -20 | -20.0% |
| range_wdist | 8159 | 8000 | +159 | +2.0% |
| cost | 900 | 1200 | -300 | -25.0% |
...
|---|--:|--:|--:|--:|
| ts_gdi_hovermlrs / hp | 30000 | 30000 | 25000 | +20.0% |
| ts_gdi_hovermlrs / speed | 80 | 80 | 150 | -46.7% |
| ts_gdi_hovermlrs / range_wdist | 8159 | 8159 | 7430 | +9.8% |
| ts_gdi_hovermlrs / cost | 900 | 900 | 900 | +0.0% |
| terran_cyclone / hp | 90000 | 90000 | 25000 | +260.0% |
| terran_cyclone / speed | 115 | 115 | 150 | -23.3% |
| terran_cyclone / range_wdist | 7320 | 7320 | 7430 | -1.5% |
| terran_cyclone / cost | 2300 | 2300 | 900 | +155.6% |
...
- `atreides_mongoose` / `mtank_pri`: 2 mains
- `missile_tank` / `mtank_pri`: 2 mains
- `tkm_stryker` / `tkmstrykerfirerockets`: 2 mains
- `td_nod_reconbike` / `td_nod_reconbike_rocket`: 2 mains
