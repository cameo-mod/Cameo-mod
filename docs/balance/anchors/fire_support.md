# `fire_support` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 6 of 31 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 45000 | 120000 | 4 | 32.2581 | ra1_soviets_heatraytank, ra1_soviets_teslatank, td_gdi_exosuit, td_nod_ssmlauncher | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 90 | 90 | 4 | 82.2581 | ra1_soviets_heatraytank, ra1_soviets_teslatank, td_gdi_exosuit, td_nod_ssmlauncher | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 7760 | 10000 | 4 | 57.1429 | ra1_soviets_heatraytank, ra1_soviets_teslatank, td_gdi_exosuit, td_nod_ssmlauncher | reference-backed ledger medians, snapped to step 10 |
| cost0 | 1500 | 1400 | 4 | 51.6129 | ra1_soviets_heatraytank, ra1_soviets_teslatank, td_gdi_exosuit, td_nod_ssmlauncher | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: latinsyndicate_missiletruck | ledger | 30000 | 75 | 7777 | 1000 |
| anchor: latinsyndicate_missiletruck | live | 30000 | 75 | 7777 | 1000 |
...
|---|--:|--:|--:|--:|
| anchor | 496.124 | 0.6735 | 0.0757673 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| cabal_mantis | tiberiansun_cabal | REF | 35000 | 120 | 7082 | 500 | live resolved YAML |
| ts_gdi_wolverine | tiberiansun_gdi | REF | 30000 | 80 | 6305 | 550 | live resolved YAML |
| naxis_antitankcannon | redalert2mod_naxis | FORMULA | 17500 | 30 | 7361 | 600 | live resolved YAML |
| td_nod_ssmlauncher | tiberiandawn_nod | REF | 20000 | 100 | 8940 | 800 | live resolved YAML |
| forgotten_tankkiller | tiberiansun_forgotten | FORMULA | 85000 | 65 | 7701 | 900 | live resolved YAML |
| naxis_imperialturbotank | redalert2mod_naxis | FORMULA | 82500 | 110 | 7396 | 950 | live resolved YAML |
| ts_gdi_wolverinemkii | tiberiansun_gdi | FORMULA | 50000 | 80 | 6520 | 950 | live resolved YAML |
| futuretech_energizer | redalert2mod_futuretech | FORMULA | 50000 | 50 | 7500 | 1000 | live resolved YAML |
| latinsyndicate_missiletruck | redalert2mod_syndicate | FORMULA | 30000 | 75 | 7777 | 1000 | live resolved YAML |
| zerg_sporemaw | starcraft_zerg | FORMULA | 25000 | 80 | 7740 | 1000 | live resolved YAML |
| cabal_laserspider | tiberiansun_cabal | FORMULA | 40000 | 70 | 6147 | 1200 | live resolved YAML |
| japan_nanodronebuggy | redalert_japan | FORMULA | 37500 | 77 | 7777 | 1200 | live resolved YAML |
| td_gdi_exosuit | tiberiandawn_gdi | REF | 50000 | 100 | 6806 | 1200 | live resolved YAML |
| yuri_magnetron | redalert2_yuri | REF | 65000 | 65 | 7032 | 1300 | live resolved YAML |
| zerg_lurker | starcraft_zerg | FORMULA | 125000 | 90 | unavailable | 1300 | live resolved YAML |
| naxis_nop03sarubia | redalert2mod_naxis | FORMULA | 62500 | 65 | unavailable | 1400 | live resolved YAML |
| asianalliance_railguntank | redalert2mod_asianalliance | REF | 160000 | 65 | 8888 | 1500 | live resolved YAML |
| cabal_spidercnc4 | tiberiansun_cabal | REF | 40000 | 70 | 7000 | 1500 | live resolved YAML |
| ra1_soviets_teslatank | redalert_soviets | REF | 40000 | 80 | 7300 | 1700 | live resolved YAML |
| schwarzermond_crystaltank | redalert2mod_schwarzermond | FORMULA | 400000 | 60 | 7420 | 1700 | live resolved YAML |
| japan_waveforcetank | redalert_japan | FORMULA | 60000 | 60 | 9343 | 1800 | live resolved YAML |
| ra2_soviets_teslatank | redalert2_soviets | REF | 75000 | 75 | 7500 | 1800 | live resolved YAML |
| ra1_soviets_heatraytank | redalert_soviets | REF | 60000 | 60 | 8212 | 1900 | live resolved YAML |
| forgotten_warriortank | tiberiansun_forgotten | FORMULA | 100000 | 75 | 8207 | 2000 | live resolved YAML |
| ra2_allies_prismtank | redalert2_allies | REF | 60000 | 60 | 11111 | 2000 | live resolved YAML |
| futuretech_beehivedronecarrier | redalert2mod_futuretech | FORMULA | 125000 | 45 | unavailable | 2100 | live resolved YAML |
| asianalliance_heavyrailguntank | redalert2mod_asianalliance | REF | 250000 | 50 | 10000 | 2200 | live resolved YAML |
| ixian_stormraider | d2k_ixian | FORMULA | 60000 | 95 | 7343 | 2200 | live resolved YAML |
| futuretech_gunstrider | redalert2mod_futuretech | REF | 320000 | 35 | 8300 | 2500 | live resolved YAML |
| protoss_reaver | starcraft_protoss | FORMULA | 275000 | 40 | 7777 | 2700 | live resolved YAML |
| schwarzermond_korruptesbiest | redalert2mod_schwarzermond | FORMULA | 240000 | 40 | 7984 | 3500 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| ra2_allies_prismtank | CnC Reloaded/MTNK; Mental Omega/MTNK; RA2 0XX/MTNK; RA2 Reborn/MTNK; Red Resurrection/MTNK; Romanov's Vengeance/sref; Valiant Shades/mtnk | 76272.2 (n=7) | 80.6319 (n=7) | 6369.48 (n=7) | 1189.21 (n=7) | 463.373 (n=7) | unapproved |
| ra2_soviets_teslatank | CnC Reloaded/FLMTNK; Mental Omega/TTNK; RA2 0XX/TTNK; RA2 Reborn/TDTNK; Red Resurrection/SONIC; Romanov's Vengeance/ftnk | 85360.8 (n=6) | 63.2773 (n=6) | 6788.28 (n=6) | 1588.91 (n=6) | 312.572 (n=6) | unapproved |
| yuri_magnetron | CnC Reloaded/TELE; Combined Arms/MANT; Mental Omega/TELE; RA2 0XX/TELE; RA2 Reborn/TELE; Red Resurrection/TELE; Romanov's Vengeance/tele | 53321.3 (n=7) | 70.4492 (n=7) | 10015.8 (n=7) | 1456.88 (n=7) | 4852.17 (n=6) | unapproved |
| asianalliance_heavyrailguntank | Rise of the East/RAILTNK | 179822 (n=1) | 51.5204 (n=1) | 9955.91 (n=1) | 2340.88 (n=1) | 531.483 (n=1) | unapproved |
| asianalliance_railguntank | Generals Alpha/vehicle.emparor_overlord; Generals Alpha/vehicle.overlord_tank; Generals Alpha/vehicle.battlemaster_tank; Generals Alpha/vehicle.nuclear_battlemaster_tank; Generals Alpha/vehicle.attack_outpost; Generals Alpha/vehicle.ecm_tank; Generals Alpha/vehicle.gatling_tank; Generals Alpha/vehicle.supply_truck; Generals Alpha/vehicle.dragon_tank; Generals Alpha/vehicle.prc_mcc; Generals Alpha/vehicle.assault_troop_crawler; Generals Alpha/vehicle.listening_outpost; Generals Alpha/vehicle.nuke_cannon; Generals Alpha/vehicle.troop_crawler; Generals Alpha/vehicle.inferno_cannon; RA2 Reborn/GRNDR; Rise of the East/ECMTNK | 125569 (n=3) | 63.9616 (n=3) | 4023.14 (n=3) | 1296.11 (n=3) | 525.527 (n=3) | unapproved |
| futuretech_gunstrider | Mental Omega/UMIN; OpenE2140/ucs_vehicles_spider | 188494 (n=2) | 50.2376 (n=2) | 7834.84 (n=2) | 2671.35 (n=2) | 267.033 (n=2) | unapproved |
| ra1_soviets_heatraytank | Combined Arms/HSTK | 70787.2 (n=1) | 81.47 (n=1) | 6356.86 (n=1) | 2060.92 (n=1) | unavailable (n=0) | unapproved |
| ra1_soviets_teslatank | Combined Arms/TTRA; DTA Enhanced/TTNK | 45329.4 (n=2) | 73.5387 (n=2) | 7891.66 (n=2) | 1678.42 (n=2) | 785.868 (n=2) | unapproved |
| td_gdi_exosuit | Combined Arms/XO; DTA Enhanced/XO | unavailable (n=0) | unavailable (n=0) | unavailable (n=0) | unavailable (n=0) | unavailable (n=0) | DTA Enhanced/XO: hero-only evidence; ordinary synthesis withheld |
| td_nod_ssmlauncher | Combined Arms/MLRS; DTA Enhanced/MLRS; OpenRA Tiberian Dawn/MLRS | 40820 (n=3) | 83.3032 (n=3) | 10470.6 (n=3) | 1270.22 (n=3) | 582.93 (n=3) | unapproved |
| cabal_mantis | CnC Reloaded/ROBOTMANTIS | 35298.3 (n=1) | 114.076 (n=1) | 7382.25 (n=1) | 598.51 (n=1) | 258.112 (n=1) | unapproved |
| cabal_spidercnc4 | Shattered Paradise/SPIDERARTY | 76480.7 (n=1) | 60.7472 (n=1) | unavailable (n=0) | 1833.43 (n=1) | unavailable (n=0) | unapproved |
| ts_gdi_wolverine | CnC Reloaded/SMECH; OpenRA Tiberian Sun/SMECH; Shattered Paradise/SMECH | 42098.7 (n=3) | 96.1845 (n=3) | 5674.91 (n=3) | 596.467 (n=3) | 447.97 (n=2) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 30000 | 120000 | -90000 | -75.0% |
| speed | 75 | 90 | -15 | -16.7% |
| range_wdist | 7777 | 10000 | -2223 | -22.2% |
| cost | 1000 | 1400 | -400 | -28.6% |
...
|---|--:|--:|--:|--:|
| latinsyndicate_missiletruck / hp | 30000 | 30000 | 45000 | -33.3% |
| latinsyndicate_missiletruck / speed | 75 | 75 | 90 | -16.7% |
| latinsyndicate_missiletruck / range_wdist | 7777 | 7777 | 7760 | +0.2% |
| latinsyndicate_missiletruck / cost | 1000 | 1000 | 1500 | -33.3% |
...
- `ra2_allies_prismtank` / `RA2Comet`: 3 mains
- `japan_waveforcetank` / `WaveforceCannon`: 2 mains
