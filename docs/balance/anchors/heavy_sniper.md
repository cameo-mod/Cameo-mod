# `heavy_sniper` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 2 of 3 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 25000 | 25000 | 1 | 83.3333 | td_gdi_heavysniper | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 78 | 80 | 1 | 83.3333 | td_gdi_heavysniper | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 8660 | 8000 | 1 | 50 | td_gdi_heavysniper | reference-backed ledger medians, snapped to step 10 |
| cost0 | 700 | 700 | 1 | 66.6667 | td_gdi_heavysniper | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: td_gdi_heavysniper | ledger | 25000 | 78 | 8655 | 700 |
| anchor: td_gdi_heavysniper | live | 25000 | 78 | 8655 | 700 |
| verifier: yuri_virus | ledger | 12000 | 52 | 9999 | 700 |
| verifier: yuri_virus | live | 12000 | 52 | 9999 | 700 |

Verifier / anchor ratios (HP, speed, range, cost): 0.48 / 0.666667 / 1.15529 / 1

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 426.667 | 0.7674 | 0.000117187 | 0 |
| verifier | 324.324 | 1 | 0.000925 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| ra1_soviets_dragunovantimaterialsniper | redalert_soviets | FORMULA | 20000 | 40 | 5804 | 420 | live resolved YAML |
| td_gdi_heavysniper | tiberiandawn_gdi | REF | 25000 | 78 | 8655 | 700 | live resolved YAML |
| yuri_virus | redalert2_yuri | REF | 12000 | 52 | 9999 | 700 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| yuri_virus | CnC Reloaded/VIRUS; Combined Arms/EVIS; Mental Omega/VIRUS; RA2 0XX/VIRUS; RA2 Reborn/VIRUS; Red Resurrection/VIRUS; Romanov's Vengeance/virus | 25902.2 (n=7) | 56.5501 (n=7) | 8861.96 (n=7) | 987.522 (n=7) | 536.616 (n=7) | unapproved |
| td_gdi_heavysniper | Combined Arms/SNIP | 19296.6 (n=1) | 62.0989 (n=1) | 8566.34 (n=1) | 729.277 (n=1) | 467.294 (n=1) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 25000 | 25000 | +0 | +0.0% |
| speed | 78 | 80 | -2 | -2.5% |
| range_wdist | 8655 | 8000 | +655 | +8.2% |
| cost | 700 | 700 | +0 | +0.0% |
...
|---|--:|--:|--:|--:|
| td_gdi_heavysniper / hp | 25000 | 25000 | 25000 | +0.0% |
| td_gdi_heavysniper / speed | 78 | 78 | 78 | +0.0% |
| td_gdi_heavysniper / range_wdist | 8655 | 8655 | 8660 | -0.1% |
| td_gdi_heavysniper / cost | 700 | 700 | 700 | +0.0% |
| yuri_virus / hp | 12000 | 12000 | 25000 | -52.0% |
| yuri_virus / speed | 52 | 52 | 78 | -33.3% |
| yuri_virus / range_wdist | 9999 | 9999 | 8660 | +15.5% |
| yuri_virus / cost | 700 | 700 | 700 | +0.0% |
...
- `yuri_virus` / `RA2Virusgun3`: 3 mains
