# `epic_vehicle` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 6 of 24 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 1e+06 | 4e+06 | 3 | 79.1667 | japan_shogunexecutioner, ra1_soviets_madtank, ra1_soviets_monstertank | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 60 | 60 | 3 | 62.5 | japan_shogunexecutioner, ra1_soviets_madtank, ra1_soviets_monstertank | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 5420 | 8500 | 2 | 9.52381 | japan_shogunexecutioner, ra1_soviets_monstertank | reference-backed ledger medians, snapped to step 10 |
| cost0 | 10000 | 10000 | 3 | 87.5 | japan_shogunexecutioner, ra1_soviets_madtank, ra1_soviets_monstertank | reference-backed ledger medians, snapped to step 100 |

Status: UNAPPROVED; BIASED range_wdist — do not sign; THIN range_wdist; NO MODEL — calibrated damage/reload not supplied
...
|---|---|--:|--:|--:|--:|
| anchor: ra1_soviets_monstertank | ledger | 1e+06 | 45 | 7833 | 10000 |
| anchor: ra1_soviets_monstertank | live | 1e+06 | 45 | 7833 | 10000 |
...
|---|---|---|--:|--:|--:|--:|---|
| ra1_allies_chronotank | redalert_allies | FORMULA | 75000 | 100 | 6102 | 2000 | live resolved YAML |
| protoss_idol | starcraft_protoss | FORMULA | 350000 | 40 | 9343 | 2800 | live resolved YAML |
| latinsyndicate_nuketruck | redalert2mod_syndicate | FORMULA | 60000 | 100 | unavailable | 3000 | live resolved YAML |
| naxis_nokana | redalert2mod_naxis | FORMULA | 450000 | 60 | 7000 | 3000 | live resolved YAML |
| ra1_soviets_madtank | redalert_soviets | REF | 300000 | 60 | unavailable | 3000 | live resolved YAML |
| ts_gdi_mammothprototype | tiberiansun_gdi | FORMULA | 800000 | 50 | 9332 | 4000 | live resolved YAML |
| forgotten_chemicalmammothtank | tiberiansun_forgotten | FORMULA | 400000 | 60 | 6172 | 5000 | live resolved YAML |
| ixian_ixprojector | d2k_ixian | FORMULA | 100000 | 100 | 20000 | 5000 | live resolved YAML |
| td_gdi_defenserig | tiberiandawn_gdi | FORMULA | 400000 | 60 | unavailable | 5000 | live resolved YAML |
| tkm_bigshiee | redalert2mod_tkm | FORMULA | 500000 | 50 | 7238 | 5000 | live resolved YAML |
| tkm_sandmarine | redalert2mod_tkm | FORMULA | 800000 | 30 | 6464 | 5000 | live resolved YAML |
| tkm_t30 | redalert2mod_tkm | FORMULA | 400000 | 50 | 22000 | 5000 | live resolved YAML |
| forgotten_experimentalmammothtank | tiberiansun_forgotten | FORMULA | 1e+06 | 50 | 5677 | 6000 | live resolved YAML |
| latinsyndicate_topolm | redalert2mod_syndicate | FORMULA | 100000 | 75 | 32000 | 6000 | live resolved YAML |
| zerg_hermit | starcraft_zerg | FORMULA | 375000 | 50 | 7120 | 6000 | live resolved YAML |
| forgotten_nomadbarracks | tiberiansun_forgotten | FORMULA | 650000 | 65 | 8301 | 6500 | live resolved YAML |
| naxis_ratte | redalert2mod_naxis | FORMULA | 2e+06 | 35 | 6110 | 8000 | live resolved YAML |
| ts_gdi_mammothmkii | tiberiansun_gdi | REF | 1.2e+06 | 50 | 8434 | 8000 | live resolved YAML |
| schwarzermond_dalek | redalert2mod_schwarzermond | FORMULA | 325000 | 65 | 8060 | 9000 | live resolved YAML |
| futuretech_futuretank | redalert2mod_futuretech | FORMULA | 650000 | 45 | 7500 | 10000 | live resolved YAML |
| japan_exorcistoitank | redalert_japan | FORMULA | 750000 | 50 | 5394 | 10000 | live resolved YAML |
| japan_shogunexecutioner | redalert_japan | REF | 3e+06 | 65 | 3000 | 10000 | live resolved YAML |
| ra1_soviets_monstertank | redalert_soviets | REF | 1e+06 | 45 | 7833 | 10000 | live resolved YAML |
| cabal_coredefender | tiberiansun_cabal | REF | 2e+06 | 50 | 6332 | 15000 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| japan_shogunexecutioner | RA2 Reborn/SHOG | 1.54724e+06 (n=1) | 71.4493 (n=1) | 3764.15 (n=1) | 8753.08 (n=1) | 1995.5 (n=1) | unapproved |
| ra1_soviets_madtank | DTA Enhanced/QTNK | 195344 (n=1) | 47.0187 (n=1) | unavailable (n=0) | 4257.24 (n=1) | unavailable (n=0) | unapproved |
| ra1_soviets_monstertank | DTA Enhanced/BEHEMOTH | 685621 (n=1) | 40.7194 (n=1) | 9342.65 (n=1) | 7772.63 (n=1) | 2397.04 (n=1) | unapproved |
| cabal_coredefender | Shattered Paradise/COREDEFENDER | 1.47339e+06 (n=1) | 55.8159 (n=1) | 6427.34 (n=1) | 18169.9 (n=1) | 6044.01 (n=1) | unapproved |
| ts_gdi_mammothmkii | OpenRA Tiberian Sun/HMEC; Shattered Paradise/HMEC; Twisted Insurrection/MMKII | 473120 (n=3) | 50.3749 (n=3) | 7372.74 (n=2) | 6390.38 (n=3) | 1786.73 (n=2) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 1e+06 | 4e+06 | -3e+06 | -75.0% |
| speed | 45 | 60 | -15 | -25.0% |
| range_wdist | 7833 | 8500 | -667 | -7.8% |
| cost | 10000 | 10000 | +0 | +0.0% |
...
|---|--:|--:|--:|--:|
| ra1_soviets_monstertank / hp | 1e+06 | 1e+06 | 1e+06 | +0.0% |
| ra1_soviets_monstertank / speed | 45 | 45 | 60 | -25.0% |
| ra1_soviets_monstertank / range_wdist | 7833 | 7833 | 5420 | +44.5% |
| ra1_soviets_monstertank / cost | 10000 | 10000 | 10000 | +0.0% |
...
W24: 4 class members with stacked mains (raw, no exemptions).
- `futuretech_futuretank` / `FutureTankCannons`: 2 mains
- `tkm_bigshiee` / `SandmarineTuskTwin`: 5 mains
- `tkm_sandmarine` / `SandmarineTuskTwin`: 5 mains
- `protoss_idol` / `WaveforceCannonChargedLaser`: 2 mains
