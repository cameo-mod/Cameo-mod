# `grenadier` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 4 of 7 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 8000 | 8000 | 3 | 14.2857 | ra1_soviets_grenadier, td_gdi_empgrenadier, td_gdi_grenadier | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 75 | 75 | 3 | 57.1429 | ra1_soviets_grenadier, td_gdi_empgrenadier, td_gdi_grenadier | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 5790 | 5500 | 3 | 35.7143 | ra1_soviets_grenadier, td_gdi_empgrenadier, td_gdi_grenadier | reference-backed ledger medians, snapped to step 10 |
| cost0 | 200 | 200 | 3 | 21.4286 | ra1_soviets_grenadier, td_gdi_empgrenadier, td_gdi_grenadier | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: td_gdi_grenadier | ledger | 8000 | 75 | 6097 | 200 |
| anchor: td_gdi_grenadier | live | 8000 | 75 | 6097 | 200 |
| verifier: ra1_soviets_molotovconscript | ledger | 11000 | 67 | 5725 | 200 |
| verifier: ra1_soviets_molotovconscript | live | 11000 | 67 | 5725 | 200 |

Verifier / anchor ratios (HP, speed, range, cost): 1.375 / 0.893333 / 0.938986 / 1

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 380.952 | 1 | 0.19698 | 0 |
| verifier | 320 | 1 | 0.540344 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| ra1_soviets_grenadier | redalert_soviets | REF | 8000 | 75 | 5791 | 200 | live resolved YAML |
| ra1_soviets_molotovconscript | redalert_soviets | FORMULA | 11000 | 67 | 5725 | 200 | live resolved YAML |
| td_gdi_grenadier | tiberiandawn_gdi | REF | 8000 | 75 | 6097 | 200 | live resolved YAML |
| ts_gdi_discthrower | tiberiansun_gdi | REF | 12000 | 60 | 6151 | 300 | live resolved YAML |
| latinsyndicate_grenademonkey | redalert2mod_syndicate | FORMULA | 30000 | 80 | 6500 | 400 | live resolved YAML |
| td_gdi_empgrenadier | tiberiandawn_gdi | REF | 32000 | 60 | 5694 | 500 | live resolved YAML |
| steelconsortium_hoverboardgrenadier | redalert2mod_consortium | FORMULA | 22000 | 130 | 6050 | 650 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| ra1_soviets_grenadier | Combined Arms/E2; DTA Enhanced/E2; OpenRA Red Alert/E2 | 13785.7 (n=3) | 72.4358 (n=3) | 5000.45 (n=3) | 237.344 (n=3) | 356.135 (n=3) | unapproved |
| ra1_soviets_molotovconscript |  | unavailable (n=0) | unavailable (n=0) | unavailable (n=0) | unavailable (n=0) | unavailable (n=0) | absent from ordinary reference population; hero/eligibility lane requires review |
| td_gdi_empgrenadier | Combined Arms/MRDR; DTA Enhanced/GRENL | 41208.2 (n=2) | 57.7727 (n=2) | 6090.51 (n=2) | 760.234 (n=2) | 752.268 (n=1) | unapproved |
| td_gdi_grenadier | Combined Arms/N2; DTA Enhanced/E2; OpenRA Tiberian Dawn/E2 | 15026 (n=3) | 73.3466 (n=3) | 4971.99 (n=3) | 236.393 (n=3) | 484.367 (n=3) | unapproved |
| ts_gdi_discthrower | CnC Reloaded/TSE2; Crystallized Nexus/E2; OpenRA Tiberian Sun/E2; Shattered Paradise/E2; Twisted Insurrection/E2 | 29646.9 (n=5) | 57.0956 (n=5) | 4636.91 (n=5) | 291.205 (n=5) | 407.445 (n=4) | unapproved |
...
| hp | 8000 | 8000 | +0 | +0.0% |
| speed | 75 | 75 | +0 | +0.0% |
| range_wdist | 6097 | 5500 | +597 | +10.9% |
| cost | 200 | 200 | +0 | +0.0% |
...
|---|--:|--:|--:|--:|
| td_gdi_grenadier / hp | 8000 | 8000 | 8000 | +0.0% |
| td_gdi_grenadier / speed | 75 | 75 | 75 | +0.0% |
| td_gdi_grenadier / range_wdist | 6097 | 6097 | 5790 | +5.3% |
| td_gdi_grenadier / cost | 200 | 200 | 200 | +0.0% |
| ra1_soviets_molotovconscript / hp | 11000 | 11000 | 8000 | +37.5% |
| ra1_soviets_molotovconscript / speed | 67 | 67 | 75 | -10.7% |
| ra1_soviets_molotovconscript / range_wdist | 5725 | 5725 | 5790 | -1.1% |
| ra1_soviets_molotovconscript / cost | 200 | 200 | 200 | +0.0% |
