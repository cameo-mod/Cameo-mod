...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 5 of 45 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 20000 | 27000 | 3 | 15.5556 | ra1_soviets_dog, td_nod_chemicalwarrior, td_nod_flamethrower | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 60 | 90 | 3 | 24.4444 | ra1_soviets_dog, td_nod_chemicalwarrior, td_nod_flamethrower | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 2090 | 1500 | 3 | 63.9535 | ra1_soviets_dog, td_nod_chemicalwarrior, td_nod_flamethrower | reference-backed ledger medians, snapped to step 10 |
| cost0 | 200 | 280 | 3 | 6.66667 | ra1_soviets_dog, td_nod_chemicalwarrior, td_nod_flamethrower | reference-backed ledger medians, snapped to step 100 |

Status: UNAPPROVED; BIASED cost — do not sign; NO MODEL — calibrated damage/reload not supplied
...
|---|---|--:|--:|--:|--:|
| anchor: asianalliance_alligator | ledger | 27000 | 108 | 1345 | 300 |
| anchor: asianalliance_alligator | live | 27000 | 108 | 1345 | 300 |
| verifier: yuri_brute | ledger | 45000 | 80 | 1616 | 400 |
| verifier: yuri_brute | live | 45000 | 80 | 1616 | 400 |

Verifier / anchor ratios (HP, speed, range, cost): 1.66667 / 0.740741 / 1.20149 / 1.33333

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 410.256 | 1 | 0.982093 | 0 |
| verifier | 540.541 | 1 | 0.995985 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| latinsyndicate_terrorist | redalert2mod_syndicate | REF | 15000 | 75 | unavailable | 200 | live resolved YAML |
| ra1_soviets_dog | redalert_soviets | REF | 5000 | 100 | 2000 | 200 | live resolved YAML |
| ra2_allies_dog | redalert2_allies | REF | 5000 | 100 | 2000 | 200 | live resolved YAML |
| ra2_soviets_dog | redalert2_soviets | REF | 5000 | 100 | 2000 | 200 | live resolved YAML |
| td_nod_flamethrower | tiberiandawn_nod | REF | 20000 | 60 | 2085 | 200 | live resolved YAML |
| zerg_zergling | starcraft_zerg | FORMULA | 11000 | 110 | 1350 | 200 | live resolved YAML |
| YRSLAV | shared_redalert2 | FORMULA | 10000 | 60 | 1500 | 250 | excluded from fit (buildable=False and no explicit balance_include) |
| naxis_slave | redalert2mod_naxis | FORMULA | 10000 | 60 | 1500 | 250 | live resolved YAML |
| tkmworker | redalert2mod_tkm | FORMULA | 10000 | 60 | 1500 | 250 | excluded from fit (buildable=False and no explicit balance_include) |
| asianalliance_alligator | redalert2mod_asianalliance | REF | 27000 | 108 | 1345 | 300 | live resolved YAML |
| futuretech_enforcer | redalert2mod_futuretech | REF | 30000 | 60 | 3000 | 300 | live resolved YAML |
| japan_samurai | redalert_japan | FORMULA | 35000 | 65 | 1637 | 300 | live resolved YAML |
| protoss_zealot | starcraft_protoss | FORMULA | 40000 | 70 | 1335 | 300 | live resolved YAML |
| wc2_humans_militiapeasant | warcraft2_humans | FORMULA | 20000 | 90 | 1333 | 300 | live resolved YAML |
| zerg_talon | starcraft_zerg | FORMULA | 32000 | 160 | 1680 | 300 | live resolved YAML |
| asianalliance_japanesesamurai | redalert2mod_asianalliance | FORMULA | 40000 | 72 | 1579 | 350 | live resolved YAML |
| heavy_inf.ixian | d2k_ixian | FORMULA | 32000 | 50 | 3800 | 400 | live resolved YAML |
| yuri_brute | redalert2_yuri | REF | 45000 | 80 | 1616 | 400 | live resolved YAML |
| zerg_infestedterranbomber | starcraft_zerg | FORMULA | 60000 | 90 | unavailable | 400 | live resolved YAML |
| forgotten_visceroid | tiberiansun_forgotten | FORMULA | 50000 | 80 | 1618 | 500 | excluded from fit (buildable=False and no explicit balance_include) |
| forgotten_zombiemutant | tiberiansun_forgotten | FORMULA | 45000 | 100 | 1127 | 500 | live resolved YAML |
| naxis_frank | redalert2mod_naxis | FORMULA | 85000 | 61 | 1616 | 500 | live resolved YAML |
| ordos_contaminator | d2k_ordos | FORMULA | 75000 | 60 | 2000 | 500 | live resolved YAML |
| td_nod_chemicalwarrior | tiberiandawn_nod | REF | 48000 | 48 | 3414 | 500 | live resolved YAML |
| terran_firebat | starcraft_terran | FORMULA | 52000 | 52 | 3400 | 500 | live resolved YAML |
| tkm_thermonaut | redalert2mod_tkm | FORMULA | 60000 | 60 | 3204 | 500 | live resolved YAML |
| ts_nod_chameleonspy | tiberiansun_nod | FORMULA | 30000 | 90 | 1538 | 500 | live resolved YAML |
| wc2_humans_footman | warcraft2_humans | FORMULA | 50000 | 75 | 1333 | 500 | live resolved YAML |
| corrino_sardaukar_berserker | d2k_corrino | FORMULA | 120000 | 56 | 5120 | 600 | live resolved YAML |
| corrino_sardaukar_sword | d2k_corrino | FORMULA | 120000 | 56 | 5120 | 600 | live resolved YAML |
| protoss_darktemplar | starcraft_protoss | FORMULA | 50000 | 75 | 1600 | 600 | live resolved YAML |
| wc2_orcs_grunt | warcraft2_orcs | FORMULA | 65000 | 65 | 1555 | 600 | live resolved YAML |
| forgotten_chemsprayinfantry | tiberiansun_forgotten | FORMULA | 64000 | 55 | 3183 | 700 | live resolved YAML |
| protoss_legionnaire | starcraft_protoss | FORMULA | 60000 | 60 | 1337 | 700 | live resolved YAML |
| terran_harakan | starcraft_terran | FORMULA | 78000 | 56 | 4185 | 700 | live resolved YAML |
| ts_gdi_riottrooper | tiberiansun_gdi | FORMULA | 54000 | 60 | 4002 | 700 | live resolved YAML |
| forgotten_runnershotgal | tiberiansun_forgotten | FORMULA | 30000 | 85 | 3112 | 750 | live resolved YAML |
| tkm_spetsnaz | redalert2mod_tkm | REF | 50000 | 100 | 5750 | 900 | live resolved YAML |
| ts_nod_shadowteam | tiberiansun_nod | REF | 30000 | 60 | 8000 | 900 | live resolved YAML |
| wc2_humans_warcraft3footman | warcraft2_humans | FORMULA | 80000 | 85 | 1533 | 900 | live resolved YAML |
| ra1_soviets_cyberdog | redalert_soviets | FORMULA | 50000 | 100 | 2500 | 1000 | live resolved YAML |
| wc2_orcs_warcraft3grunt | warcraft2_orcs | FORMULA | 120000 | 70 | 1600 | 1100 | live resolved YAML |
| futuretech_blackwidow | redalert2mod_futuretech | FORMULA | 25000 | 75 | 9000 | 1200 | live resolved YAML |
| protoss_amaranth | starcraft_protoss | FORMULA | 70000 | 70 | 1840 | 1200 | live resolved YAML |
| apparition.ixian | d2k_ixian | FORMULA | 37500 | 160 | 3333 | 2000 | excluded from fit (buildable=False and no explicit balance_include) |
| wc2_humans_danath | warcraft2_humans | FORMULA | 150000 | 90 | 1533 | 2000 | live resolved YAML |
| wc2_orcs_hellscream | warcraft2_orcs | FORMULA | 150000 | 90 | 1533 | 2000 | live resolved YAML |
| wc2_humans_danath_elite | warcraft2_humans | FORMULA | 250000 | 90 | 1533 | 3500 | live resolved YAML |
| wc2_orcs_hellscream_elite | warcraft2_orcs | FORMULA | 250000 | 90 | 1533 | 3500 | live resolved YAML |

Classified ledger rows excluded by fitting eligibility: 4.
...
|---|---|--:|--:|--:|--:|--:|---|
| ra2_allies_dog | Mental Omega/DOG; RA2 0XX/DOG; RA2 Reborn/DOG; Red Resurrection/DOG; Romanov's Vengeance/dog | 18094.2 (n=5) | 102.439 (n=5) | 1769.37 (n=5) | 202.617 (n=5) | 2585.45 (n=5) | unapproved |
| ra2_soviets_dog | Mental Omega/DOG; RA2 0XX/DOG; RA2 Reborn/DOG; Red Resurrection/DOG; Romanov's Vengeance/dog | 18094.2 (n=5) | 102.439 (n=5) | 1769.37 (n=5) | 202.617 (n=5) | 2585.45 (n=5) | unapproved |
| yuri_brute | CnC Reloaded/BRUTE; Combined Arms/BRUT; Mental Omega/BRUTE; RA2 0XX/BRUTE; RA2 Reborn/BRUTE; Red Resurrection/BRUTE | 55171.3 (n=6) | 75.0852 (n=6) | 1430.15 (n=6) | 554.624 (n=6) | 597.69 (n=6) | unapproved |
| asianalliance_alligator | Mental Omega/DESOR | 38695 (n=1) | 75.7251 (n=1) | 3078.29 (n=1) | 825.397 (n=1) | 813.638 (n=1) | unapproved |
| futuretech_enforcer | Mental Omega/ENFO | 31350.4 (n=1) | 66.7026 (n=1) | 4871.28 (n=1) | 535.603 (n=1) | 371.374 (n=1) | unapproved |
| naxis_frank |  | unavailable (n=0) | unavailable (n=0) | unavailable (n=0) | unavailable (n=0) | unavailable (n=0) | absent from ordinary reference population; hero/eligibility lane requires review |
| latinsyndicate_terrorist | Generals Alpha/infantry.rebel; Generals Alpha/infantry.saboteur; Generals Alpha/infantry.terrorist; Generals Alpha/infantry.toxin_rebel; Generals Alpha/infantry.toxin_terrorist; Generals Alpha/infantry.angry_mob; Generals Alpha/infantry.hijacker; Generals Alpha/infantry.rpg_trooper; Generals Alpha/infantry.worker; RA2 Reborn/TERROR | 23287.1 (n=2) | 67.4739 (n=2) | 2068.6 (n=2) | 239.958 (n=2) | 2443.24 (n=2) | unapproved |
| tkm_spetsnaz | Rise of the East/RGUARD | 49761 (n=1) | 83.3256 (n=1) | 5535.99 (n=1) | 752.964 (n=1) | 528.604 (n=1) | unapproved |
| ra1_soviets_dog | Combined Arms/DOG; DTA Enhanced/DOG; OpenRA Red Alert/DOG | 6204.09 (n=3) | 111.663 (n=3) | 2315.36 (n=3) | 288.17 (n=3) | 15451.8 (n=3) | unapproved |
| td_nod_chemicalwarrior | Combined Arms/N5; DTA Enhanced/E5; OpenRA Tiberian Dawn/E5 | 56185.9 (n=3) | 58.3537 (n=3) | 2840.77 (n=3) | 603.899 (n=3) | 939.107 (n=3) | unapproved |
| td_nod_flamethrower | Combined Arms/N4; DTA Enhanced/E4; OpenRA Tiberian Dawn/E4 | 28557.2 (n=3) | 65.1971 (n=3) | 2511.29 (n=3) | 283.629 (n=3) | 481.908 (n=3) | unapproved |
| ts_nod_shadowteam | Crystallized Nexus/SHADOW | 25116.9 (n=1) | 66.1025 (n=1) | 8064.49 (n=1) | 963.57 (n=1) | 643.323 (n=1) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 27000 | 27000 | +0 | +0.0% |
| speed | 108 | 90 | +18 | +20.0% |
| range_wdist | 1345 | 1500 | -155 | -10.3% |
| cost | 300 | 280 | +20 | +7.1% |
...
|---|--:|--:|--:|--:|
| asianalliance_alligator / hp | 27000 | 27000 | 20000 | +35.0% |
| asianalliance_alligator / speed | 108 | 108 | 60 | +80.0% |
| asianalliance_alligator / range_wdist | 1345 | 1345 | 2090 | -35.6% |
| asianalliance_alligator / cost | 300 | 300 | 200 | +50.0% |
| yuri_brute / hp | 45000 | 45000 | 20000 | +125.0% |
| yuri_brute / speed | 80 | 80 | 60 | +33.3% |
| yuri_brute / range_wdist | 1616 | 1616 | 2090 | -22.7% |
| yuri_brute / cost | 400 | 400 | 200 | +100.0% |
...
W24: 5 class members with stacked mains (raw, no exemptions).
- `heavy_inf.ixian` / `RashidanGun_upgrade`: 2 mains
- `futuretech_enforcer` / `FutureEnforcerShotgun`: 5 mains
- `japan_samurai` / `SamuraiBladeCharged`: 2 mains
- `forgotten_runnershotgal` / `TSMutShotgun`: 5 mains
- `ts_gdi_riottrooper` / `TSShotgun`: 5 mains
