# `heavy_infantry` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 7 of 38 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 36000 | 50000 | 5 | 31.5789 | japan_japaneseflamethrower, ra1_soviets_flamethrower, ra1_soviets_shocktrooper, ra1_soviets_zapper, td_nod_blackhandflamer | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 50 | 50 | 5 | 60.5263 | japan_japaneseflamethrower, ra1_soviets_flamethrower, ra1_soviets_shocktrooper, ra1_soviets_zapper, td_nod_blackhandflamer | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 4990 | 5000 | 5 | 20.2703 | japan_japaneseflamethrower, ra1_soviets_flamethrower, ra1_soviets_shocktrooper, ra1_soviets_zapper, td_nod_blackhandflamer | reference-backed ledger medians, snapped to step 10 |
| cost0 | 600 | 800 | 5 | 48.6842 | japan_japaneseflamethrower, ra1_soviets_flamethrower, ra1_soviets_shocktrooper, ra1_soviets_zapper, td_nod_blackhandflamer | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: ra1_soviets_shocktrooper | ledger | 40000 | 40 | 4652 | 600 |
| anchor: ra1_soviets_shocktrooper | live | 40000 | 40 | 4652 | 600 |
| verifier: ra1_soviets_zapper | ledger | 60000 | 30 | 5000 | 1200 |
| verifier: ra1_soviets_zapper | live | 60000 | 30 | 5000 | 1200 |

Verifier / anchor ratios (HP, speed, range, cost): 1.5 / 0.75 / 1.07481 / 2

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 500 | 0.75 | 1.53394 | 0 |
| verifier | 1000 | 0.75 | 1.5577 | 0 |
...
| td_gdi_sonicmissilesoldier | tiberiandawn_gdi | FORMULA | 25000 | 50 | 7500 | 400 | live resolved YAML |
| yuri_biotrooper | redalert2_yuri | REF | 96000 | 64 | 4840 | 400 | live resolved YAML |
| asianalliance_plasmatrooper | redalert2mod_asianalliance | REF | 64000 | 42 | 5190 | 500 | live resolved YAML |
| cabal_cyborginfantry | tiberiansun_cabal | REF | 45000 | 40 | 5800 | 500 | live resolved YAML |
| ixian_shockinfantry | d2k_ixian | FORMULA | 36000 | 45 | 5818 | 500 | live resolved YAML |
| latinsyndicate_latinflametrooper | redalert2mod_syndicate | REF | 55000 | 55 | 5555 | 500 | live resolved YAML |
| ra2_soviets_teslatrooper | redalert2_soviets | REF | 48000 | 38 | 5222 | 500 | live resolved YAML |
| ra2shk.bot | shared_redalert2 | FORMULA | 48000 | 38 | unavailable | 500 | excluded from fit (buildable=False and no explicit balance_include) |
| schwarzermond_noidmgarmor | redalert2mod_schwarzermond | FORMULA | 50000 | 40 | 4384 | 500 | live resolved YAML |
| futuretech_cannondroid | redalert2mod_futuretech | FORMULA | 80000 | 35 | 6000 | 525 | live resolved YAML |
| naxis_naximachinegunners | redalert2mod_naxis | FORMULA | 60000 | 55 | unavailable | 600 | live resolved YAML |
| naxis_panzerschreck | redalert2mod_naxis | FORMULA | 96000 | 42 | 6805 | 600 | live resolved YAML |
| ra1_soviets_shocktrooper | redalert_soviets | REF | 40000 | 40 | 4652 | 600 | live resolved YAML |
| td_nod_blackhandflamer | tiberiandawn_nod | REF | 36000 | 66 | 4988 | 600 | live resolved YAML |
| wc2_humans_dwarvenrifleman | warcraft2_humans | FORMULA | 24000 | 64 | 6936 | 600 | live resolved YAML |
| protoss_adept | starcraft_protoss | FORMULA | 30000 | 70 | 5250 | 650 | live resolved YAML |
| tkm_juggernaut | redalert2mod_tkm | FORMULA | 36000 | 45 | 4490 | 650 | live resolved YAML |
| ra2_soviets_desolator | redalert2_soviets | REF | 30000 | 59 | 6444 | 700 | live resolved YAML |
| schwarzermond_ubermensch | redalert2mod_schwarzermond | FORMULA | 64000 | 64 | 5801 | 700 | live resolved YAML |
| cabal_dissolver | tiberiansun_cabal | FORMULA | 50000 | 40 | 5142 | 725 | live resolved YAML |
| ixian_storminfantry | d2k_ixian | FORMULA | 44000 | 44 | 6275 | 800 | live resolved YAML |
| ts_nod_toxintrooper | tiberiansun_nod | FORMULA | 30000 | 55 | 10293 | 850 | live resolved YAML |
| forgotten_tiberianfiend | tiberiansun_forgotten | REF | 80000 | 60 | 5690 | 1000 | live resolved YAML |
| forgotten_tiberianfiend_wild | tiberiansun_forgotten | FORMULA | 80000 | 60 | 5690 | 1000 | excluded from fit (buildable=False and no explicit balance_include) |
| ra2shkhero | shared_redalert2 | FORMULA | 45000 | 38 | 5222 | 1000 | excluded from fit (buildable=False and no explicit balance_include) |
| terran_marauder | starcraft_terran | FORMULA | 90000 | 45 | 7010 | 1000 | live resolved YAML |
| steelconsortium_quantummissiletrooper | redalert2mod_consortium | FORMULA | 64000 | 48 | 8000 | 1150 | live resolved YAML |
| ra1_soviets_zapper | redalert_soviets | REF | 60000 | 30 | 5000 | 1200 | live resolved YAML |
| cabal_devout | tiberiansun_cabal | REF | 80000 | 40 | 6200 | 1400 | live resolved YAML |
| ts_gdi_zonetrooper | tiberiansun_gdi | REF | 80000 | 60 | 6230 | 1500 | live resolved YAML |
| cabal_enlighted | tiberiansun_cabal | FORMULA | 80000 | 40 | 5120 | 1600 | live resolved YAML |
| forgotten_viniferafiend | tiberiansun_forgotten | FORMULA | 100000 | 60 | 6096 | 2000 | live resolved YAML |
| cabal_cyborgcommando | tiberiansun_cabal | REF | 250000 | 40 | 5219 | 5000 | live resolved YAML |
| cabal_cyborgcommandov2 | tiberiansun_cabal | FORMULA | 400000 | 40 | 6264 | 10000 | live resolved YAML |
...
| ra1_soviets_flamethrower | Combined Arms/N4; DTA Enhanced/E4S | 20943.2 (n=2) | 61.7828 (n=2) | 4201.72 (n=2) | 315.136 (n=2) | 641.044 (n=2) | unapproved |
| ra1_soviets_shocktrooper | Combined Arms/SHOK; DTA Enhanced/SHOK; OpenRA Red Alert/SHOK | 30547.5 (n=3) | 47.8305 (n=3) | 5962.44 (n=3) | 703.902 (n=3) | 357.9 (n=3) | unapproved |
| ra1_soviets_zapper | Combined Arms/TTRP | 59847 (n=1) | 38.5121 (n=1) | 5617.08 (n=1) | 997.766 (n=1) | 624.993 (n=1) | unapproved |
| td_nod_blackhandflamer | Combined Arms/BH | 43708.5 (n=1) | 69.2976 (n=1) | 4234.51 (n=1) | 643.391 (n=1) | 431.867 (n=1) | unapproved |
| cabal_cyborgcommando | Shattered Paradise/CYC2 | 237586 (n=1) | 43.2454 (n=1) | 5001.43 (n=1) | 3858.36 (n=1) | 2216.42 (n=1) | unapproved |
| cabal_cyborginfantry | CnC Reloaded/TSCYBORG; Shattered Paradise/CYBORG | 66017.4 (n=2) | 45.3255 (n=2) | 4822.92 (n=2) | 482.605 (n=2) | 436.844 (n=2) | unapproved |
| cabal_devout | CnC Reloaded/DEVOUT | 59259 (n=1) | 53.6679 (n=1) | 5092.88 (n=1) | 603.517 (n=1) | 275.682 (n=1) | unapproved |
| forgotten_tiberianfiend | Shattered Paradise/MUTFIEND | 41100.2 (n=1) | 70.9663 (n=1) | 5424.28 (n=1) | 571.289 (n=1) | 350.922 (n=1) | unapproved |
| ts_gdi_zonetrooper | Shattered Paradise/ZONERAIDER; Twisted Insurrection/E4 | 68465.8 (n=2) | 55.6446 (n=2) | 6959.94 (n=2) | 1099.77 (n=2) | 684.842 (n=2) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 40000 | 50000 | -10000 | -20.0% |
| speed | 40 | 50 | -10 | -20.0% |
| range_wdist | 4652 | 5000 | -348 | -7.0% |
| cost | 600 | 800 | -200 | -25.0% |
...
|---|--:|--:|--:|--:|
| ra1_soviets_shocktrooper / hp | 40000 | 40000 | 36000 | +11.1% |
| ra1_soviets_shocktrooper / speed | 40 | 40 | 50 | -20.0% |
| ra1_soviets_shocktrooper / range_wdist | 4652 | 4652 | 4990 | -6.8% |
| ra1_soviets_shocktrooper / cost | 600 | 600 | 600 | +0.0% |
| ra1_soviets_zapper / hp | 60000 | 60000 | 36000 | +66.7% |
| ra1_soviets_zapper / speed | 30 | 30 | 50 | -40.0% |
| ra1_soviets_zapper / range_wdist | 5000 | 5000 | 4990 | +0.2% |
| ra1_soviets_zapper / cost | 1200 | 1200 | 600 | +100.0% |
...
- `japan_tankbuster` / `TankBusterBeamCannon`: 2 mains
