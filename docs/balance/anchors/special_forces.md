...
|---|--:|--:|--:|--:|---|
| hp0 | 39000 | 15000 | 2 | 62.5 | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 50 | 50 | 2 | 31.25 | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 6010 | 6000 | 2 | 50 | reference-backed ledger medians, snapped to step 10 |
| cost0 | 700 | 200 | 2 | 43.75 | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: japan_imperialscoutsman | ledger | 15000 | 50 | 6000 | 200 |
| anchor: japan_imperialscoutsman | live | 15000 | 50 | 6000 | 200 |
| verifier: schwarzermond_lunarsoldier | ledger | 30000 | 50 | 6000 | 500 |
| verifier: schwarzermond_lunarsoldier | live | 30000 | 50 | 6000 | 500 |
...
|---|--:|--:|--:|--:|
| anchor | 143 | 1 | 0.4065 | 0 |
| verifier | 264 | 1 | 0.423813 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| japan_imperialscoutsman | redalert_japan | FORMULA | 15000 | 50 | 6000 | 200 | live resolved YAML |
| tkm_trooper | redalert2mod_tkm | REF | 33000 | 59 | 5191 | 200 | live resolved YAML |
| ra2_soviets_flaktrooper | redalert2_soviets | REF | 10000 | 44 | 7834 | 416 | live resolved YAML |
| yuri_gatlingtrooper | redalert2_yuri | REF | 36000 | 45 | 5531 | 431 | live resolved YAML |
| ts_nod_elitecadre | tiberiansun_nod | REF | 21000 | 55 | 6217 | 435 | live resolved YAML |
| schwarzermond_lunarsoldier | redalert2mod_schwarzermond | FORMULA | 30000 | 50 | 6000 | 500 | live resolved YAML |
| ra1_allies_machinegunner | redalert_allies | REF | 19000 | 49 | 6500 | 557 | live resolved YAML |
| td_nod_lasertrooper | tiberiandawn_nod | REF | 59000 | 51 | 5524 | 750 | live resolved YAML |
| td_nod_stealthsoldier | tiberiandawn_nod | FORMULA | 25000 | 72 | 6480 | 753 | live resolved YAML |
| forgotten_mutantsergeant | tiberiansun_forgotten | FORMULA | 40000 | 74 | 5611 | 1154 | live resolved YAML |
| ra2_allies_seal | redalert2_allies | REF | 31000 | 59 | 6386 | 1162 | live resolved YAML |
| terran_ghost | starcraft_terran | FORMULA | 44000 | 75 | 8428 | 1176 | live resolved YAML |
| ts_gdi_falconenforcer | tiberiansun_gdi | FORMULA | 45000 | 62 | 6125 | 1322 | live resolved YAML |
| cabal_eliminator800 | tiberiansun_cabal | FORMULA | 85000 | 39 | 5857 | 1450 | live resolved YAML |
| td_gdi_officer | tiberiandawn_gdi | FORMULA | 32000 | 79 | 5596 | 1532 | live resolved YAML |
| terran_specter | starcraft_terran | FORMULA | 50000 | 80 | 7922 | 1744 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|---|
| ra2_allies_seal | Mental Omega/GHOST; RA2 Reborn/GHOST; Red Resurrection/GHOST; Romanov's Vengeance/ghost | 34141.3 (n=4) | 66.6008 (n=4) | 5700.81 (n=4) | 1056.41 (n=4) | unapproved |
| ra2_soviets_flaktrooper | CnC Reloaded/FTHROW; Mental Omega/FLAKT; RA2 Reborn/FLAKT; Red Resurrection/FLAMET; Romanov's Vengeance/flakt; Valiant Shades/flakt | 23023.7 (n=6) | 55.8386 (n=6) | 4927.05 (n=6) | 363.313 (n=6) | unapproved |
| yuri_gatlingtrooper | CnC Reloaded/GBRUTE; Combined Arms/ZTRP; RA2 Reborn/HCONS | 43191.6 (n=3) | 50.4336 (n=3) | 5313 (n=3) | 681.442 (n=3) | unapproved |
| tkm_trooper | Rise of the East/FLAKT | 25649.4 (n=1) | 64.0036 (n=1) | 5260.01 (n=1) | 286.218 (n=1) | unapproved |
| ra1_allies_machinegunner | DTA Enhanced/MGI | 47428.9 (n=1) | 37.8553 (n=1) | 6400.87 (n=1) | 793.952 (n=1) | unapproved |
| td_nod_lasertrooper | Combined Arms/RMBC | 85863.9 (n=1) | 54.8071 (n=1) | 6340.18 (n=1) | 1224.89 (n=1) | unapproved |
| ts_nod_elitecadre | CnC Reloaded/ELCAD; Crystallized Nexus/NACAD | 33624.6 (n=2) | 61.6122 (n=2) | 4628.39 (n=2) | 567.361 (n=2) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 15000 | 15000 | +0 | +0.0% |
| speed | 50 | 50 | +0 | +0.0% |
| range_wdist | 6000 | 6000 | +0 | +0.0% |
| cost | 200 | 200 | +0 | +0.0% |
...
|---|--:|--:|--:|--:|
| japan_imperialscoutsman / hp | 15000 | 15000 | 39000 | -61.5% |
| japan_imperialscoutsman / speed | 50 | 50 | 50 | +0.0% |
| japan_imperialscoutsman / range_wdist | 6000 | 6000 | 6010 | -0.2% |
| japan_imperialscoutsman / cost | 200 | 200 | 700 | -71.4% |
| schwarzermond_lunarsoldier / hp | 30000 | 30000 | 39000 | -23.1% |
| schwarzermond_lunarsoldier / speed | 50 | 50 | 50 | +0.0% |
| schwarzermond_lunarsoldier / range_wdist | 6000 | 6000 | 6010 | -0.2% |
| schwarzermond_lunarsoldier / cost | 500 | 500 | 700 | -28.6% |
...
- `japan_imperialscoutsman` / `japan_imperialscoutsman_rifle_waveforce`: 4 mains
...
**Coordinator pilot judgement — not sign-off.** Do not restate the baseline from 15000 HP / 200 cost to the diagnostic 39000 / 700 on only 2 reference-backed source members; the entry unit may intentionally sit below the class median. The existing live anchor matches the ruled spec on all four axes, and the verifier stat ratios match 2 / 1 / 1 / 2.5, but the nominal DPS ratio (264 / 143) is not 2 and the derived K differs — the verifier identity is not established. W24 raw debt 1 remains. Keep the nomination pending meaningful reference and weapon review; keeping the nomination is neither approval, nor sign-off, nor permission to apply prices.

## 7. What would make this wrong

These candidates are wrong if the selected current-stat pool is unrepresentative, its reference assignments are rejected, its ledger differs from resolved YAML, or the baseline is restated to the diagnostic 39000 HP / 700 cost without meaningful reference and weapon review; approval and calibration must resolve those questions before any number is applied.
