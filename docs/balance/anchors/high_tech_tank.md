# `high_tech_tank` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 8 of 26 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 300000 | 700000 | 8 | 73.0769 | japan_hovercraftflametank, japan_oitank, ra1_soviets_heavyteslatank, ra1_soviets_mammothtank, ra1_soviets_siegemammothtank, td_gdi_mammothtank, td_gdi_mammothtankmkiii, td_nod_chemicalstealthtank | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 58 | 65 | 8 | 30.7692 | japan_hovercraftflametank, japan_oitank, ra1_soviets_heavyteslatank, ra1_soviets_mammothtank, ra1_soviets_siegemammothtank, td_gdi_mammothtank, td_gdi_mammothtankmkiii, td_nod_chemicalstealthtank | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 6380 | 6500 | 8 | 42.3077 | japan_hovercraftflametank, japan_oitank, ra1_soviets_heavyteslatank, ra1_soviets_mammothtank, ra1_soviets_siegemammothtank, td_gdi_mammothtank, td_gdi_mammothtankmkiii, td_nod_chemicalstealthtank | reference-backed ledger medians, snapped to step 10 |
| cost0 | 2500 | 2000 | 8 | 71.1538 | japan_hovercraftflametank, japan_oitank, ra1_soviets_heavyteslatank, ra1_soviets_mammothtank, ra1_soviets_siegemammothtank, td_gdi_mammothtank, td_gdi_mammothtankmkiii, td_nod_chemicalstealthtank | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: td_gdi_mammothtank | ledger | 225000 | 60 | 6141 | 1600 |
| anchor: td_gdi_mammothtank | live | 225000 | 60 | 6141 | 1600 |
| verifier: ra1_soviets_siegemammothtank | ledger | 625000 | 45 | 6666 | 4000 |
| verifier: ra1_soviets_siegemammothtank | live | 625000 | 45 | 6666 | 4000 |

Verifier / anchor ratios (HP, speed, range, cost): 2.77778 / 0.75 / 1.08549 / 2.5

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 400 | 0.75 | 0.551125 | 0 |
| verifier | 1422.22 | 0.4925 | 0.855703 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| yuri_mastermind | redalert2_yuri | REF | 100000 | 120 | 7000 | 1500 | live resolved YAML |
| zerg_goremaw | starcraft_zerg | FORMULA | 150000 | 150 | 1250 | 1500 | live resolved YAML |
| ordos_deviatortank | d2k_ordos | REF | 85000 | 115 | 7070 | 1600 | live resolved YAML |
| ra2_allies_miragetank | redalert2_allies | REF | 120000 | 90 | 6031 | 1600 | live resolved YAML |
| td_gdi_mammothtank | tiberiandawn_gdi | REF | 225000 | 60 | 6141 | 1600 | live resolved YAML |
| terran_goliath | starcraft_terran | FORMULA | 125000 | 90 | 6000 | 1600 | live resolved YAML |
| japan_hovercraftflametank | redalert_japan | REF | 120000 | 90 | 6000 | 1700 | live resolved YAML |
| ra2_soviets_apocalypsetank | redalert2_soviets | REF | 350000 | 55 | 6992 | 1750 | live resolved YAML |
| ts_nod_stealthtank | tiberiansun_nod | REF | 80000 | 100 | 6385 | 1750 | live resolved YAML |
| duelist_tank.ixian | d2k_ixian | FORMULA | 240000 | 45 | 7000 | 1800 | live resolved YAML |
| td_nod_chemicalstealthtank | tiberiandawn_nod | REF | 90000 | 120 | 6962 | 1800 | live resolved YAML |
| ra1_soviets_mammothtank | redalert_soviets | REF | 375000 | 50 | 6412 | 2000 | live resolved YAML |
| ra2_allies_heavymiragetank | redalert2_allies | REF | 240000 | 60 | 6112 | 2000 | live resolved YAML |
| forgotten_scoopertank | tiberiansun_forgotten | REF | 250000 | 65 | 6224 | 2250 | live resolved YAML |
| futuretech_oriontank | redalert2mod_futuretech | REF | 180000 | 60 | 7500 | 2400 | live resolved YAML |
| ordos_lasertank | d2k_ordos | FORMULA | 105000 | 105 | 7275 | 2400 | live resolved YAML |
| protoss_atreus | starcraft_protoss | FORMULA | 250000 | 60 | 4500 | 2400 | live resolved YAML |
| terran_goliathmk2 | starcraft_terran | FORMULA | 175000 | 75 | 6479 | 2400 | live resolved YAML |
| naxis_shoekarn | redalert2mod_naxis | FORMULA | 150000 | 75 | 12345 | 2500 | live resolved YAML |
| td_gdi_mammothtankmkiii | tiberiandawn_gdi | REF | 500000 | 55 | 6340 | 3000 | live resolved YAML |
| ra1_soviets_heavyteslatank | redalert_soviets | REF | 150000 | 60 | 6650 | 3500 | live resolved YAML |
| steelconsortium_katytank | redalert2mod_consortium | REF | 275000 | 45 | 7250 | 3800 | live resolved YAML |
| ra1_soviets_siegemammothtank | redalert_soviets | REF | 625000 | 45 | 6666 | 4000 | live resolved YAML |
| naxis_maus | redalert2mod_naxis | FORMULA | 600000 | 60 | 6666 | 4200 | live resolved YAML |
| japan_oitank | redalert_japan | REF | 650000 | 50 | 5394 | 7000 | live resolved YAML |
| cabal_avatar | tiberiansun_cabal | FORMULA | 1e+06 | 25 | 6332 | 7500 | live resolved YAML |

Classified ledger rows excluded by fitting eligibility: 0.
...
|---|---|--:|--:|--:|--:|--:|---|
| ordos_deviatortank | OpenRA Dune II/deviator | 72478.5 (n=1) | 91.8654 (n=1) | unavailable (n=0) | 1796.79 (n=1) | unavailable (n=0) | unapproved |
| ra2_allies_heavymiragetank | RA2 Reborn/HARVEY | 264490 (n=1) | 50.5987 (n=1) | 5633 (n=1) | 2276 (n=1) | 480.736 (n=1) | unapproved |
| ra2_allies_miragetank | CnC Reloaded/MGTK; Mental Omega/MGTK; RA2 Reborn/MGTK; Red Resurrection/MGTK; Romanov's Vengeance/mgtk | 65761.7 (n=5) | 81.46 (n=5) | 6460.35 (n=5) | 1504.64 (n=5) | 634.657 (n=5) | unapproved |
| ra2_soviets_apocalypsetank | CnC Reloaded/APOC; Mental Omega/APOC; RA2 0XX/APOC; RA2 Reborn/APOC; Red Resurrection/APOC; Romanov's Vengeance/apoc | 192054 (n=6) | 50.9645 (n=6) | 6313.66 (n=5) | 2290.26 (n=6) | 540.505 (n=5) | unapproved |
| yuri_mastermind | CnC Reloaded/MIND; Mental Omega/MIND; RA2 0XX/MIND; RA2 Reborn/MIND; Red Resurrection/MIND; Romanov's Vengeance/mind | 108374 (n=6) | 59.3196 (n=6) | 5531.99 (n=5) | 2242.88 (n=6) | 84.8802 (n=5) | unapproved |
| steelconsortium_katytank | OpenHV/STEALTHTANK | 179715 (n=1) | 67.0832 (n=1) | 6447.21 (n=1) | 3110.34 (n=1) | 1150.41 (n=1) | unapproved |
| futuretech_oriontank | Mental Omega/CHRTNK | 152834 (n=1) | 51.7896 (n=1) | 7737.03 (n=1) | 2484.56 (n=1) | 1040.04 (n=1) | unapproved |
| japan_hovercraftflametank | RA2 Reborn/HOVER | 98921 (n=1) | 99.2628 (n=1) | 5815.87 (n=1) | 1425.35 (n=1) | 625.262 (n=1) | unapproved |
| japan_oitank | Mental Omega/CHRTNK; RA2 Reborn/SHEIKH | 230723 (n=2) | 50.1024 (n=2) | 6188.74 (n=2) | 3041.74 (n=2) | 933.335 (n=2) | unapproved |
| ra1_soviets_heavyteslatank | Combined Arms/TTNK | 137255 (n=1) | 62.8787 (n=1) | 6028.68 (n=1) | 2640.41 (n=1) | 1251.89 (n=1) | unapproved |
| ra1_soviets_mammothtank | Combined Arms/4TNK; Combined Arms/4TNK.ATOMIC; Combined Arms/4TNK.ERAD; Combined Arms/4TNK.ERAD.ATOMIC; DTA Enhanced/4TNK; OpenRA Red Alert/4TNK | 301599 (n=3) | 43.9673 (n=3) | 5555.84 (n=3) | 2732.87 (n=3) | 790.64 (n=3) | unapproved |
| ra1_soviets_siegemammothtank | Combined Arms/ISU; Combined Arms/APOC; Combined Arms/OVLD | 455746 (n=1) | 46.4651 (n=1) | 6369.18 (n=1) | 3721.79 (n=1) | 1240.78 (n=1) | unapproved |
| td_gdi_mammothtank | Combined Arms/HTNK; Combined Arms/HTNK.Drone; Combined Arms/HTNK.Hover; Combined Arms/HTNK.Ion; DTA Enhanced/HTNK; OpenRA Tiberian Dawn/HTNK | 280010 (n=3) | 48.7334 (n=3) | 5330.58 (n=3) | 2480.5 (n=3) | 694.616 (n=3) | unapproved |
| td_gdi_mammothtankmkiii | Combined Arms/HTNK; Combined Arms/HTNK.Drone; Combined Arms/HTNK.Hover; Combined Arms/HTNK.Ion; Combined Arms/TITN; Combined Arms/TITN.RAIL | 408325 (n=1) | 51.0773 (n=1) | 5506.83 (n=1) | 3019.67 (n=1) | 616.221 (n=1) | unapproved |
| td_nod_chemicalstealthtank | Combined Arms/HSTK | 86696.3 (n=1) | 115.216 (n=1) | 5853.09 (n=1) | 2005.96 (n=1) | unavailable (n=0) | unapproved |
| forgotten_scoopertank | Twisted Insurrection/LEVIA | 159804 (n=1) | 58.0252 (n=1) | 5770.81 (n=1) | 2430.67 (n=1) | 439.792 (n=1) | unapproved |
| ts_nod_stealthtank | CnC Reloaded/TSSTNK; Crystallized Nexus/STNK; OpenRA Tiberian Sun/STNK; Shattered Paradise/STNK; Twisted Insurrection/LTNK2 | 59024.2 (n=5) | 91.2526 (n=5) | 6422.1 (n=5) | 1572.14 (n=5) | 604.432 (n=4) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 225000 | 700000 | -475000 | -67.9% |
| speed | 60 | 65 | -5 | -7.7% |
| range_wdist | 6141 | 6500 | -359 | -5.5% |
| cost | 1600 | 2000 | -400 | -20.0% |
...
|---|--:|--:|--:|--:|
| td_gdi_mammothtank / hp | 225000 | 225000 | 300000 | -25.0% |
| td_gdi_mammothtank / speed | 60 | 60 | 58 | +3.4% |
| td_gdi_mammothtank / range_wdist | 6141 | 6141 | 6380 | -3.7% |
| td_gdi_mammothtank / cost | 1600 | 1600 | 2500 | -36.0% |
| ra1_soviets_siegemammothtank / hp | 625000 | 625000 | 300000 | +108.3% |
| ra1_soviets_siegemammothtank / speed | 45 | 45 | 58 | -22.4% |
| ra1_soviets_siegemammothtank / range_wdist | 6666 | 6666 | 6380 | +4.5% |
| ra1_soviets_siegemammothtank / cost | 4000 | 4000 | 2500 | +60.0% |
...
W24: 1 class members with stacked mains (raw, no exemptions).
- `japan_oitank` / `OIBigPlasmaCannon`: 3 mains
