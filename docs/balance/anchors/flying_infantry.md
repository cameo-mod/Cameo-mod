# `flying_infantry` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 1 of 9 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 24000 | 18000 | 1 | 27.7778 | japan_rocketangel | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 140 | 80 | 1 | 33.3333 | japan_rocketangel | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 4600 | 5000 | 1 | 16.6667 | japan_rocketangel | reference-backed ledger medians, snapped to step 10 |
| cost0 | 900 | 600 | 1 | 61.1111 | japan_rocketangel | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: ra2_allies_rocketeer | ledger | 18000 | 180 | 5000 | 600 |
| anchor: ra2_allies_rocketeer | live | 18000 | 180 | 5000 | 600 |
| verifier: yuri_cosmonaut | ledger | 28000 | 165 | 4750 | 1100 |
| verifier: yuri_cosmonaut | live | 28000 | 165 | 4750 | 1100 |

Verifier / anchor ratios (HP, speed, range, cost): 1.55556 / 0.916667 / 0.95 / 1.83333

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 142.857 | 0.8639 | 0.527258 | 0 |
| verifier | 309.091 | 1 | 1.06893 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| cabal_orbdrone_slave | tiberiansun_cabal | FORMULA | 25000 | 140 | 6420 | 270 | excluded from fit (buildable=False and no explicit balance_include) |
| zerg_shriek | starcraft_zerg | FORMULA | 14000 | 195 | 1150 | 500 | live resolved YAML |
| cabal_orbdrone | tiberiansun_cabal | FORMULA | 25000 | 140 | 6420 | 600 | live resolved YAML |
| ra2_allies_rocketeer | redalert2_allies | REF | 18000 | 180 | 5000 | 600 | live resolved YAML |
| ts_gdi_jumpjetinfantry | tiberiansun_gdi | REF | 34000 | 110 | 5090 | 700 | live resolved YAML |
| zerg_swarmling | starcraft_zerg | FORMULA | 40000 | 80 | 8561 | 800 | live resolved YAML |
| japan_rocketangel | redalert_japan | REF | 24000 | 140 | 4600 | 900 | live resolved YAML |
| ts_nod_shadowteam_air | tiberiansun_nod | FORMULA | 30000 | 150 | unavailable | 900 | excluded from fit (buildable=False and no explicit balance_include) |
| cabal_cyborgassassin | tiberiansun_cabal | FORMULA | 30000 | 180 | 6309 | 1000 | live resolved YAML |
| yuri_cosmonaut | redalert2_yuri | REF | 28000 | 165 | 4750 | 1100 | live resolved YAML |
| naxis_skymage | redalert2mod_naxis | FORMULA | 48000 | 160 | 5000 | 1200 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| ra2_allies_rocketeer | CnC Reloaded/JUMPJET; Mental Omega/JUMPJET; RA2 Reborn/JUMPJET; Red Resurrection/JUMPJET; Romanov's Vengeance/jumpjet; Valiant Shades/jumpjet | 28449.6 (n=6) | 154.666 (n=6) | 5033.58 (n=6) | 659.832 (n=6) | 398.801 (n=6) | unapproved |
| yuri_cosmonaut | RA2 Reborn/LUNR | 26907.8 (n=1) | 138.016 (n=1) | 5493.65 (n=1) | 669.154 (n=1) | 807.723 (n=1) | unapproved |
| japan_rocketangel | Mental Omega/JUMPJET; RA2 Reborn/JUMPJET | 26106.4 (n=2) | 183.636 (n=2) | 4963.01 (n=2) | 711.939 (n=2) | 597.374 (n=2) | unapproved |
| ts_gdi_jumpjetinfantry | CnC Reloaded/TSJUMPJET; OpenRA Tiberian Sun/JUMPJET; Shattered Paradise/JUMPJET; Twisted Insurrection/JUMPJET | 31018.3 (n=4) | 76.3187 (n=4) | 5389.35 (n=4) | 782.728 (n=4) | 357.419 (n=3) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 18000 | 18000 | +0 | +0.0% |
| speed | 180 | 80 | +100 | +125.0% |
...
|---|--:|--:|--:|--:|
| ra2_allies_rocketeer / hp | 18000 | 18000 | 24000 | -25.0% |
| ra2_allies_rocketeer / speed | 180 | 180 | 140 | +28.6% |
| ra2_allies_rocketeer / range_wdist | 5000 | 5000 | 4600 | +8.7% |
| ra2_allies_rocketeer / cost | 600 | 600 | 900 | -33.3% |
| yuri_cosmonaut / hp | 28000 | 28000 | 24000 | +16.7% |
| yuri_cosmonaut / speed | 165 | 165 | 140 | +17.9% |
| yuri_cosmonaut / range_wdist | 4750 | 4750 | 4600 | +3.3% |
| yuri_cosmonaut / cost | 1100 | 1100 | 900 | +22.2% |
