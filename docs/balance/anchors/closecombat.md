# `closecombat` — NOT READY / UNAPPROVED
...
|---|--:|--:|--:|--:|---|
| hp0 | 50000 | 50000 | 1 | 12.5 | ledger medians / no reference preference, snapped to step 1000 |
| speed0 | 75 | 75 | 1 | 75 | ledger medians / no reference preference, snapped to step 1 |
| range0_wdist | 3500 | 3500 | 1 | 25 | ledger medians / no reference preference, snapped to step 10 |
| cost0 | 200 | 200 | 1 | 12.5 | ledger medians / no reference preference, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: td_gdi_shotgunner | ledger | 50000 | 75 | 3500 | 200 |
| anchor: td_gdi_shotgunner | live | 50000 | 75 | 3500 | 200 |
| verifier: asianalliance_fanatic | ledger | 100000 | 75 | 3500 | 500 |
| verifier: asianalliance_fanatic | live | 100000 | 75 | 3500 | 500 |
...
|---|--:|--:|--:|--:|
| anchor | 172.857 | 1 | 0.01498 | 0 |
| verifier | 345.714 | 1 | 0.0149625 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| naxis_alien | redalert2mod_naxis | FORMULA | 15000 | 40 | 2777 | 110 | excluded from fit (buildable=False and no explicit balance_include) |
| td_gdi_shotgunner | tiberiandawn_gdi | FORMULA | 50000 | 75 | 3500 | 200 | live resolved YAML |
| naxis_sssoldier | redalert2mod_naxis | FORMULA | 63000 | 55 | 4500 | 240 | live resolved YAML |
| futuretech_shotgundroid | redalert2mod_futuretech | FORMULA | 55000 | 55 | 4110 | 400 | live resolved YAML |
| asianalliance_fanatic | redalert2mod_asianalliance | FORMULA | 100000 | 75 | 3500 | 500 | live resolved YAML |
...
|---|--:|--:|--:|--:|
| hp | 50000 | 50000 | +0 | +0.0% |
| speed | 75 | 75 | +0 | +0.0% |
| range_wdist | 3500 | 3500 | +0 | +0.0% |
| cost | 200 | 200 | +0 | +0.0% |
...
|---|--:|--:|--:|--:|
| td_gdi_shotgunner / hp | 50000 | 50000 | 50000 | +0.0% |
| td_gdi_shotgunner / speed | 75 | 75 | 75 | +0.0% |
| td_gdi_shotgunner / range_wdist | 3500 | 3500 | 3500 | +0.0% |
| td_gdi_shotgunner / cost | 200 | 200 | 200 | +0.0% |
| asianalliance_fanatic / hp | 100000 | 100000 | 50000 | +100.0% |
| asianalliance_fanatic / speed | 75 | 75 | 75 | +0.0% |
| asianalliance_fanatic / range_wdist | 3500 | 3500 | 3500 | +0.0% |
| asianalliance_fanatic / cost | 500 | 500 | 200 | +150.0% |
...
- `futuretech_shotgundroid` / `ShotgunAttackRobotGun`: 3 mains
...
**Coordinator pilot judgement — not sign-off.** Keep the current nominated baseline (`td_gdi_shotgunner`; live 50000 / 75 / 3500 / 200 matches the ruled spec on all four axes) for further review — this is not an approved restat. The stat-ratio side of the verifier identity is visible (`asianalliance_fanatic`: 2x HP, same speed / range, 2.5x cost, nominal DPS ratio 2), but the diagnostic source pool is n=1 with no accepted reference rows and cannot establish representativeness. The derived aggregate K differs slightly (0.01498 versus 0.0149625); investigate precision and model basis before declaring equivalence — no combat model or matchup signature is inferred from this gap, and it must not be claimed as a significant gameplay difference or attributed to rounding; it is an open question. W24 raw debt 1 (`futuretech_shotgundroid`, 3 mains) remains. Keeping the nomination is neither approval nor permission to apply prices.

## 7. What would make this wrong

These candidates are wrong if the selected current-stat pool is unrepresentative, its reference assignments are rejected, its ledger differs from resolved YAML, or the slight derived-K difference (0.01498 versus 0.0149625) proves to be a precision or model-basis defect rather than benign derivation; approval and calibration must resolve those questions before any number is applied.
