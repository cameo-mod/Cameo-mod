...
|---|--:|--:|--:|--:|---|---|
| hp0 | 16000 | 30000 | 1 | 10 | ra1_soviets_mortarsoldier | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 48 | 50 | 1 | 30 | ra1_soviets_mortarsoldier | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 10830 | 10000 | 1 | 60 | ra1_soviets_mortarsoldier | reference-backed ledger medians, snapped to step 10 |
| cost0 | 500 | 500 | 1 | 30 | ra1_soviets_mortarsoldier | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: forgotten_mutantmortarman | ledger | 30000 | 50 | 10830 | 500 |
| anchor: forgotten_mutantmortarman | live | 30000 | 50 | 10830 | 500 |
| verifier: ordos_mortartrooper | ledger | 20000 | 40 | 9920 | 600 |
| verifier: ordos_mortartrooper | live | 20000 | 40 | 9920 | 600 |

Verifier / anchor ratios (HP, speed, range, cost): 0.666667 / 0.8 / 0.915974 / 1.2

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 363.636 | 1 | 1.18459 | 0 |
| verifier | 500 | 1 | 1.66968 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| forgotten_mutantmortarman | tiberiansun_forgotten | FORMULA | 30000 | 50 | 10830 | 500 | live resolved YAML |
| latinsyndicate_mortarbike | redalert2mod_syndicate | FORMULA | 28000 | 140 | 7500 | 500 | live resolved YAML |
| ra1_soviets_mortarsoldier | redalert_soviets | REF | 16000 | 48 | 10830 | 500 | live resolved YAML |
| ordos_mortartrooper | d2k_ordos | FORMULA | 20000 | 40 | 9920 | 600 | live resolved YAML |
| wc2_humans_mortarteam | warcraft2_humans | FORMULA | 40000 | 80 | 12000 | 800 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| ra1_soviets_mortarsoldier | Combined Arms/BJET | 17841 (n=1) | 73.3727 (n=1) | 8948.97 (n=1) | 616.351 (n=1) | 391.901 (n=1) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 30000 | 30000 | +0 | +0.0% |
| speed | 50 | 50 | +0 | +0.0% |
| range_wdist | 10830 | 10000 | +830 | +8.3% |
| cost | 500 | 500 | +0 | +0.0% |
...
|---|--:|--:|--:|--:|
| forgotten_mutantmortarman / hp | 30000 | 30000 | 16000 | +87.5% |
| forgotten_mutantmortarman / speed | 50 | 50 | 48 | +4.2% |
| forgotten_mutantmortarman / range_wdist | 10830 | 10830 | 10830 | +0.0% |
| forgotten_mutantmortarman / cost | 500 | 500 | 500 | +0.0% |
| ordos_mortartrooper / hp | 20000 | 20000 | 16000 | +25.0% |
| ordos_mortartrooper / speed | 40 | 40 | 48 | -16.7% |
| ordos_mortartrooper / range_wdist | 9920 | 9920 | 10830 | -8.4% |
| ordos_mortartrooper / cost | 600 | 600 | 500 | +20.0% |
