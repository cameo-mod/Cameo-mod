# `artillery_tank` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 3 of 14 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 50000 | 140000 | 3 | 64.2857 | japan_waveforceartillery, ra1_soviets_grad, td_gdi_archerartillery | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 70 | 85 | 3 | 42.8571 | japan_waveforceartillery, ra1_soviets_grad, td_gdi_archerartillery | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 13910 | 12000 | 2 | 71.4286 | ra1_soviets_grad, td_gdi_archerartillery | reference-backed ledger medians, snapped to step 10 |
| cost0 | 1400 | 700 | 3 | 42.8571 | japan_waveforceartillery, ra1_soviets_grad, td_gdi_archerartillery | reference-backed ledger medians, snapped to step 100 |

Status: UNAPPROVED; THIN range_wdist; NO MODEL — calibrated damage/reload not supplied
...
|---|---|--:|--:|--:|--:|
| anchor: ixian_ixcombatsiege | ledger | 80000 | 80 | 8686 | 1200 |
| anchor: ixian_ixcombatsiege | live | 80000 | 80 | 8686 | 1200 |
| verifier: schwarzermond_lunargrille | ledger | 62500 | 90 | 12345 | 600 |
| verifier: schwarzermond_lunargrille | live | 62500 | 90 | 12345 | 600 |

Verifier / anchor ratios (HP, speed, range, cost): 0.78125 / 1.125 / 1.42125 / 0.5

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 300 | 1 | 1.28857 | 0 |
| verifier | 432.432 | 1 | 0.267325 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| schwarzermond_lunargrille | redalert2mod_schwarzermond | FORMULA | 62500 | 90 | 12345 | 600 | live resolved YAML |
| td_gdi_archerartillery | tiberiandawn_gdi | REF | 35000 | 70 | 14000 | 750 | live resolved YAML |
| forgotten_missilevan | tiberiansun_forgotten | FORMULA | 35000 | 75 | 10460 | 1200 | live resolved YAML |
| ixian_ixcombatsiege | d2k_ixian | FORMULA | 80000 | 80 | 8686 | 1200 | live resolved YAML |
| ts_nod_artillery | tiberiansun_nod | REF | 30000 | 60 | unavailable | 1300 | live resolved YAML |
| ra1_soviets_grad | redalert_soviets | REF | 50000 | 75 | 13820 | 1400 | live resolved YAML |
| ts_gdi_juggernaut | tiberiansun_gdi | REF | 35000 | 71 | unavailable | 1400 | live resolved YAML |
| ordos_cobratank | d2k_ordos | FORMULA | 45000 | 45 | unavailable | 1500 | live resolved YAML |
| asianalliance_howitzer | redalert2mod_asianalliance | REF | 40000 | 60 | 16000 | 1600 | live resolved YAML |
| schwarzermond_mars | redalert2mod_schwarzermond | FORMULA | 35000 | 70 | unavailable | 2000 | live resolved YAML |
| japan_waveforceartillery | redalert_japan | REF | 50000 | 55 | unavailable | 2500 | live resolved YAML |
| ordos_pythontank | d2k_ordos | FORMULA | 70000 | 40 | unavailable | 2500 | live resolved YAML |
| forgotten_mlrs | tiberiansun_forgotten | REF | 40000 | 80 | 11913 | 2750 | live resolved YAML |
| terran_siegetank | starcraft_terran | FORMULA | 150000 | 75 | unavailable | 2800 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| asianalliance_howitzer | RA2 Reborn/CHRHOWI; Rise of the East/HOWI | 63182.5 (n=2) | 54.9865 (n=2) | 12391 (n=2) | 1997.58 (n=2) | 417.92 (n=2) | unapproved |
| japan_waveforceartillery | Mental Omega/HOWI; RA2 Reborn/ARMH | 56233 (n=2) | 50.3941 (n=2) | 12093.1 (n=2) | 1614.62 (n=2) | 195.792 (n=2) | unapproved |
| ra1_soviets_grad | Combined Arms/GRAD | 48902.5 (n=1) | 66.6245 (n=1) | 13688.9 (n=1) | 1328.55 (n=1) | 486.549 (n=1) | unapproved |
| td_gdi_archerartillery | Combined Arms/THWK; DTA Enhanced/DISCARTY | 47791.4 (n=2) | 59.574 (n=2) | 15508 (n=2) | 1695.96 (n=2) | 721.414 (n=2) | unapproved |
| forgotten_mlrs | Shattered Paradise/MRLS | 36577.7 (n=1) | 79.3893 (n=1) | 12610.2 (n=1) | 1971.28 (n=1) | 1649.87 (n=1) | unapproved |
| ts_gdi_juggernaut | CnC Reloaded/JUGG; OpenRA Tiberian Sun/JUGG; Shattered Paradise/JUG | 75093.8 (n=3) | 61.7668 (n=3) | 14897.4 (n=2) | 1664.41 (n=3) | 640.194 (n=2) | unapproved |
| ts_nod_artillery | CnC Reloaded/AHOWI; Crystallized Nexus/NHWTZ; OpenRA Tiberian Sun/ART2; Twisted Insurrection/SUBARTY | 43566.1 (n=4) | 59.6511 (n=4) | 13301.9 (n=3) | 1566.62 (n=4) | 507.54 (n=3) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 80000 | 140000 | -60000 | -42.9% |
| speed | 80 | 85 | -5 | -5.9% |
| range_wdist | 8686 | 12000 | -3314 | -27.6% |
| cost | 1200 | 700 | +500 | +71.4% |
...
|---|--:|--:|--:|--:|
| ixian_ixcombatsiege / hp | 80000 | 80000 | 50000 | +60.0% |
| ixian_ixcombatsiege / speed | 80 | 80 | 70 | +14.3% |
| ixian_ixcombatsiege / range_wdist | 8686 | 8686 | 13910 | -37.6% |
| ixian_ixcombatsiege / cost | 1200 | 1200 | 1400 | -14.3% |
| schwarzermond_lunargrille / hp | 62500 | 62500 | 50000 | +25.0% |
| schwarzermond_lunargrille / speed | 90 | 90 | 70 | +28.6% |
| schwarzermond_lunargrille / range_wdist | 12345 | 12345 | 13910 | -11.3% |
| schwarzermond_lunargrille / cost | 600 | 600 | 1400 | -57.1% |
...
- `schwarzermond_lunargrille` / `Lunar_GreenGrilleArty`: 2 mains
