...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 9 of 44 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 155000 | 240000 | 8 | 81.8182 | ra1_allies_alliedmediumtank, ra1_allies_alliedtigerheavytank, japan_igomediumtank, ra1_soviets_hammertank, ra1_soviets_heavytank, ra1_soviets_kotinnucleartank, td_gdi_battletank, td_gdi_predatortank | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 73 | 95 | 8 | 31.8182 | ra1_allies_alliedmediumtank, ra1_allies_alliedtigerheavytank, japan_igomediumtank, ra1_soviets_hammertank, ra1_soviets_heavytank, ra1_soviets_kotinnucleartank, td_gdi_battletank, td_gdi_predatortank | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 5670 | 5500 | 8 | 50 | ra1_allies_alliedmediumtank, ra1_allies_alliedtigerheavytank, japan_igomediumtank, ra1_soviets_hammertank, ra1_soviets_heavytank, ra1_soviets_kotinnucleartank, td_gdi_battletank, td_gdi_predatortank | reference-backed ledger medians, snapped to step 10 |
| cost0 | 1100 | 800 | 8 | 63.6364 | ra1_allies_alliedmediumtank, ra1_allies_alliedtigerheavytank, japan_igomediumtank, ra1_soviets_hammertank, ra1_soviets_heavytank, ra1_soviets_kotinnucleartank, td_gdi_battletank, td_gdi_predatortank | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: naxis_tiger | ledger | 100000 | 100 | 5000 | 800 |
| anchor: naxis_tiger | live | 100000 | 100 | 5000 | 800 |
| verifier: naxis_kingtigerheavytank | ledger | 200000 | 100 | 5000 | 2000 |
| verifier: naxis_kingtigerheavytank | live | 200000 | 100 | 5000 | 2000 |
...
|---|--:|--:|--:|--:|
| anchor | 200 | 1 | 0.9303 | 0 |
| verifier | 400 | 1 | 0.9303 | 0 |

Shared TechTier: equal.

Shared aggregate K: equal.
...
|---|---|---|--:|--:|--:|--:|---|
| corrino_buggy | d2k_corrino | FORMULA | 25000 | 85 | 5120 | 300 | live resolved YAML |
| corrino_bmp | d2k_corrino | FORMULA | 40000 | 70 | 5120 | 400 | live resolved YAML |
| atreides_combattank | d2k_atreides | REF | 100000 | 75 | 5120 | 600 | live resolved YAML |
| combat_tank.harkonnen | d2k_harkonnen | FORMULA | 70000 | 65 | 5120 | 600 | live resolved YAML |
| corrino_combattank | d2k_corrino | FORMULA | 100000 | 75 | 5120 | 600 | live resolved YAML |
| forgotten_rattytank | tiberiansun_forgotten | REF | 70000 | 90 | 5566 | 600 | live resolved YAML |
| ra2_c_ifv | shared_redalert2 | FORMULA | 120000 | 100 | 5000 | 600 | excluded from fit (buildable=False and no explicit balance_include) |
| harkonnen_flametank | d2k_harkonnen | REF | 70000 | 65 | 6742 | 700 | live resolved YAML |
| ra1_allies_alliedmediumtank | redalert_allies | REF | 90000 | 100 | 5159 | 700 | live resolved YAML |
| tkm_technicaltank | redalert2mod_tkm | FORMULA | 70000 | 110 | 5316 | 700 | live resolved YAML |
| ra2_allies_grizzlytank | redalert2_allies | REF | 100000 | 95 | 5289 | 750 | live resolved YAML |
| ixian_kodatank | d2k_ixian | FORMULA | 65000 | 65 | 5555 | 800 | live resolved YAML |
| japan_igomediumtank | redalert_japan | REF | 110000 | 90 | 5243 | 800 | live resolved YAML |
| naxis_tiger | redalert2mod_naxis | REF | 100000 | 100 | 5000 | 800 | live resolved YAML |
| ts_nod_ticktank | tiberiansun_nod | REF | 100000 | 90 | unavailable | 800 | live resolved YAML |
| asianalliance_lynxtank | redalert2mod_asianalliance | REF | 120000 | 90 | 5357 | 850 | live resolved YAML |
| futuretech_guardiantank | redalert2mod_futuretech | REF | 115000 | 85 | 7820 | 850 | live resolved YAML |
| ra2_soviets_rhinoheavytank | redalert2_soviets | REF | 130000 | 85 | 5374 | 850 | live resolved YAML |
| naxis_assault | redalert2mod_naxis | FORMULA | 130000 | 100 | 5555 | 900 | excluded from fit (buildable=False and no explicit balance_include) |
| ra2_c_abram | shared_redalert2 | FORMULA | 190000 | 75 | 5374 | 900 | excluded from fit (buildable=False and no explicit balance_include) |
| steelconsortium_mako | redalert2mod_consortium | FORMULA | 95000 | 85 | 6050 | 900 | live resolved YAML |
| td_gdi_battletank | tiberiandawn_gdi | REF | 125000 | 80 | 5438 | 900 | live resolved YAML |
| tkm_t72m | redalert2mod_tkm | FORMULA | 100000 | 80 | 6196 | 900 | live resolved YAML |
| ordos_heavycombattank | d2k_ordos | FORMULA | 115000 | 75 | 6000 | 950 | live resolved YAML |
| ra2leopard | shared_redalert2 | FORMULA | 230000 | 70 | 5374 | 950 | excluded from fit (buildable=False and no explicit balance_include) |
| schwarzermond_lunartiger | redalert2mod_schwarzermond | FORMULA | 160000 | 80 | 5105 | 950 | live resolved YAML |
| ts_gdi_titan | tiberiansun_gdi | REF | 100000 | 75 | 6201 | 950 | live resolved YAML |
| atreides_sonictank | d2k_atreides | REF | 100000 | 31 | 7777 | 1000 | live resolved YAML |
| cabal_tarantula | tiberiansun_cabal | FORMULA | 110000 | 70 | 5278 | 1000 | live resolved YAML |
| ra1_soviets_heavytank | redalert_soviets | REF | 150000 | 70 | 5469 | 1000 | live resolved YAML |
| tkm_abrams | redalert2mod_tkm | REF | 120000 | 80 | 5672 | 1000 | live resolved YAML |
| ixian_heavykodatank | d2k_ixian | FORMULA | 95000 | 58 | 6000 | 1100 | live resolved YAML |
| japan_chihaheavytank | redalert_japan | FORMULA | 130000 | 85 | 5692 | 1200 | live resolved YAML |
| protoss_dragoon | starcraft_protoss | FORMULA | 75000 | 80 | 5000 | 1200 | live resolved YAML |
| yrrobo | shared_redalert2 | FORMULA | 50000 | 130 | 5780 | 1200 | excluded from fit (buildable=False and no explicit balance_include) |
| td_gdi_predatortank | tiberiandawn_gdi | REF | 170000 | 70 | 5880 | 1250 | live resolved YAML |
| ixian_mongoose | d2k_ixian | FORMULA | 75000 | 75 | 6183 | 1300 | live resolved YAML |
| ra1_allies_alliedcybertank | shared_redalert | FORMULA | 160000 | 75 | 5915 | 1300 | excluded from fit (buildable=False and no explicit balance_include) |
| ra1_allies_alliedtigerheavytank | redalert_allies | REF | 160000 | 75 | 5915 | 1300 | live resolved YAML |
| ordos_combatautoguntank | d2k_ordos | REF | 95000 | 80 | 6220 | 1500 | live resolved YAML |
| ra1_soviets_hammertank | redalert_soviets | REF | 210000 | 60 | 6825 | 1500 | live resolved YAML |
| steelconsortium_quantumtank | redalert2mod_consortium | FORMULA | 100000 | 100 | 6000 | 1600 | live resolved YAML |
| ts_gdi_titanmkii | tiberiansun_gdi | REF | 120000 | 75 | 6201 | 1600 | live resolved YAML |
| terran_matador | starcraft_terran | FORMULA | 100000 | 100 | unavailable | 1700 | live resolved YAML |
| latinsyndicate_smokertank | redalert2mod_syndicate | REF | 260000 | 95 | 6550 | 1800 | live resolved YAML |
...
Classified ledger rows excluded by fitting eligibility: 7.
...
|---|---|--:|--:|--:|--:|--:|---|
| atreides_combattank | OpenRA Dune 2000/combat_tank_a; OpenRA Dune 2000/combat_tank_a.starport | 104789 (n=1) | 81.5873 (n=1) | 5652.78 (n=1) | 938.149 (n=1) | unavailable (n=0) | unapproved |
| atreides_sonictank | OpenRA Dune 2000/sonic_tank; OpenRA Dune II/sonic_tank | 98261.7 (n=2) | 37.3724 (n=2) | 8077.14 (n=2) | 1502.89 (n=2) | 70.134 (n=1) | unapproved |
| harkonnen_flametank | OpenRA Dune 2000/missile_tank | 65452.5 (n=1) | 68.2407 (n=1) | 8567.49 (n=1) | 1087.84 (n=1) | unavailable (n=0) | unapproved |
| ordos_combatautoguntank | OpenRA Dune 2000/combat_tank_o; OpenRA Dune 2000/combat_tank_o.starport | 94342.1 (n=1) | 89.5102 (n=1) | 5890.28 (n=1) | 1483.34 (n=1) | unavailable (n=0) | unapproved |
| ra2_allies_grizzlytank | RA2 Reborn/GRNDR; Romanov's Vengeance/mtnk | 130271 (n=2) | 80.2329 (n=2) | 3411.22 (n=2) | 1069.65 (n=2) | 712.612 (n=2) | unapproved |
| ra2_soviets_rhinoheavytank | CnC Reloaded/HTNK; Mental Omega/HTNK; RA2 0XX/ADGATTTNK; RA2 Reborn/GRNDR; Red Resurrection/HTNK; Romanov's Vengeance/htnk; Valiant Shades/htnk | 112174 (n=7) | 76.2887 (n=7) | 4596.58 (n=7) | 1115.2 (n=7) | 574.827 (n=7) | unapproved |
| asianalliance_lynxtank | Generals Alpha/vehicle.emparor_overlord; Generals Alpha/vehicle.overlord_tank; Generals Alpha/vehicle.battlemaster_tank; Generals Alpha/vehicle.nuclear_battlemaster_tank; Generals Alpha/vehicle.attack_outpost; Generals Alpha/vehicle.ecm_tank; Generals Alpha/vehicle.gatling_tank; Generals Alpha/vehicle.supply_truck; Generals Alpha/vehicle.dragon_tank; Generals Alpha/vehicle.prc_mcc; Generals Alpha/vehicle.assault_troop_crawler; Generals Alpha/vehicle.listening_outpost; Generals Alpha/vehicle.nuke_cannon; Generals Alpha/vehicle.troop_crawler; Generals Alpha/vehicle.inferno_cannon; RA2 Reborn/LYNX; Rise of the East/LYNXTNK | 81916.4 (n=3) | 73.4931 (n=3) | 4742.51 (n=3) | 970.438 (n=3) | 437.581 (n=3) | unapproved |
| futuretech_guardiantank | Mental Omega/ABRM | 102407 (n=1) | 73.8576 (n=1) | 7231.76 (n=1) | 1386.01 (n=1) | 778.412 (n=1) | unapproved |
| naxis_tiger | OpenE2140/ed_vehicles_miner | 94000.6 (n=1) | 102.963 (n=1) | unavailable (n=0) | 1083.68 (n=1) | unavailable (n=0) | unapproved |
| latinsyndicate_smokertank | Generals Alpha/vehicle.battle_bus; Generals Alpha/vehicle.marauder_tank; Generals Alpha/vehicle.scorpion_tank; Generals Alpha/vehicle.gla_mcc; Generals Alpha/vehicle.toxin_tractor; Generals Alpha/vehicle.bomb_truck; Generals Alpha/vehicle.quad_cannon; Generals Alpha/vehicle.radar_van; Generals Alpha/vehicle.scud_launcher; Generals Alpha/vehicle.technical; Generals Alpha/vehicle.rocket_buggy; Generals Alpha/vehicle.combat_cycle; RA2 Reborn/FLTNK | 114311 (n=2) | 89.9848 (n=2) | 4340.97 (n=1) | 1156.62 (n=2) | 451.945 (n=1) | unapproved |
| tkm_abrams | Mental Omega/MARA | 72173.1 (n=1) | 81.693 (n=1) | 6354.5 (n=1) | 1215.07 (n=1) | 429.668 (n=1) | unapproved |
| tkm_trenchtank | Rise of the East/REPTNK | 110307 (n=1) | 70.1799 (n=1) | unavailable (n=0) | 1731.69 (n=1) | unavailable (n=0) | unapproved |
| ra1_allies_alliedmediumtank | Combined Arms/2TNK; DTA Enhanced/2TNK; OpenRA Red Alert/2TNK | 127394 (n=3) | 81.101 (n=3) | 5132.95 (n=3) | 1134.14 (n=3) | 323.615 (n=3) | unapproved |
| ra1_allies_alliedtigerheavytank | Combined Arms/3TNK.RHINO.ATOMIC; Combined Arms/3TNK.RHINO.ATOMICYURI | unavailable (n=0) | unavailable (n=0) | unavailable (n=0) | unavailable (n=0) | unavailable (n=0) | unapproved |
| japan_igomediumtank | Mental Omega/MGTK; RA2 Reborn/MGTK | 69108.6 (n=2) | 82.5886 (n=2) | 5985.14 (n=2) | 1058.1 (n=2) | 470.467 (n=2) | unapproved |
| ra1_soviets_hammertank | Combined Arms/3TNK; Combined Arms/3TNK.ATOMIC; Combined Arms/3TNK.ATOMICYURI; Combined Arms/3TNK.RHINO; Combined Arms/3TNK.RHINO.ATOMIC; Combined Arms/3TNK.RHINO.ATOMICYURI | 211365 (n=1) | 62.8787 (n=1) | 5632.1 (n=1) | 1692.96 (n=1) | 383.52 (n=1) | unapproved |
| ra1_soviets_heavytank | Combined Arms/3TNK; Combined Arms/3TNK.ATOMIC; Combined Arms/3TNK.ATOMICYURI; Combined Arms/3TNK.RHINO; Combined Arms/3TNK.RHINO.ATOMIC; Combined Arms/3TNK.RHINO.ATOMICYURI; DTA Enhanced/3TNK; OpenRA Red Alert/3TNK | 171628 (n=3) | 65.5654 (n=3) | 5208.38 (n=3) | 1561.34 (n=3) | 491.485 (n=3) | unapproved |
| ra1_soviets_kotinnucleartank | Combined Arms/3TNK; Combined Arms/3TNK.ATOMIC; Combined Arms/3TNK.ATOMICYURI; Combined Arms/3TNK.RHINO; Combined Arms/3TNK.RHINO.ATOMIC; Combined Arms/3TNK.RHINO.ATOMICYURI | 225958 (n=1) | 65.4462 (n=1) | 5465.42 (n=1) | 1854.54 (n=1) | 363.839 (n=1) | unapproved |
| td_gdi_battletank | Combined Arms/MTNK; Combined Arms/MTNK.Drone; Combined Arms/MTNK.Laser; DTA Enhanced/MTNK; OpenRA Tiberian Dawn/MTNK | 151105 (n=3) | 74.0261 (n=3) | 5171 (n=3) | 1305.14 (n=3) | 412.432 (n=3) | unapproved |
| td_gdi_predatortank | Combined Arms/MTNK; Combined Arms/MTNK.Drone; Combined Arms/MTNK.Laser | 170437 (n=1) | 74.5123 (n=1) | 5227.67 (n=1) | 1371.41 (n=1) | 294.513 (n=1) | unapproved |
| forgotten_rattytank | Shattered Paradise/MRINOTNK | 82084.9 (n=1) | 76.926 (n=1) | 5704.83 (n=1) | 833.638 (n=1) | 314.847 (n=1) | unapproved |
| ts_gdi_titan | CnC Reloaded/MMCH; OpenRA Tiberian Sun/MMCH; Shattered Paradise/MMCH | 109079 (n=3) | 62.89 (n=3) | 6773.13 (n=3) | 1098.03 (n=3) | 413.197 (n=2) | unapproved |
| ts_gdi_titanmkii | CnC Reloaded/TWMAMU | 164088 (n=1) | 59.2868 (n=1) | 5814.77 (n=1) | 1911.77 (n=1) | 475.62 (n=1) | unapproved |
| ts_nod_ticktank | CnC Reloaded/TICKT; Crystallized Nexus/TTNK; OpenRA Tiberian Sun/TTNK; Shattered Paradise/TTNK | 80821.9 (n=4) | 85.6973 (n=4) | 5398.11 (n=2) | 1027.08 (n=4) | 414.253 (n=2) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 100000 | 240000 | -140000 | -58.3% |
| speed | 100 | 95 | +5 | +5.3% |
| range_wdist | 5000 | 5500 | -500 | -9.1% |
| cost | 800 | 800 | +0 | +0.0% |
...
|---|--:|--:|--:|--:|
| naxis_tiger / hp | 100000 | 100000 | 155000 | -35.5% |
| naxis_tiger / speed | 100 | 100 | 73 | +37.0% |
| naxis_tiger / range_wdist | 5000 | 5000 | 5670 | -11.8% |
| naxis_tiger / cost | 800 | 800 | 1100 | -27.3% |
| naxis_kingtigerheavytank / hp | 200000 | 200000 | 155000 | +29.0% |
| naxis_kingtigerheavytank / speed | 100 | 100 | 73 | +37.0% |
| naxis_kingtigerheavytank / range_wdist | 5000 | 5000 | 5670 | -11.8% |
| naxis_kingtigerheavytank / cost | 2000 | 2000 | 1100 | +81.8% |
...
- `schwarzermond_lunartiger` / `Lunar_GreenTigerCannon`: 2 mains
- `japan_chihaheavytank` / `Type97PlasmaCannon`: 3 mains
- `yrrobo` / `RA2Robotmm`: 3 mains
