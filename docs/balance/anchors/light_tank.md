# `light_tank` — NOT READY / UNAPPROVED
...
Source pool: selected factions tiberiandawn_gdi, tiberiandawn_nod, redalert_allies, redalert_soviets, redalert_japan — 5 of 15 fit-eligible class members are in the selected factions. The reference preference and members missing a stat give each axis its own contributing set, named below.

| axis | diagnostic candidate | ruled spec | evidence count | fit-eligible class percentile | contributing actors | basis |
|---|--:|--:|--:|--:|---|---|
| hp0 | 80000 | 100000 | 5 | 73.3333 | ra1_allies_alliedlighttank, ra1_allies_sheridanassaulttank, japan_shrineminitank, td_nod_lighttank, td_nod_lighttankmkii | reference-backed ledger medians, snapped to step 1000 |
| speed0 | 110 | 125 | 5 | 36.6667 | ra1_allies_alliedlighttank, ra1_allies_sheridanassaulttank, japan_shrineminitank, td_nod_lighttank, td_nod_lighttankmkii | reference-backed ledger medians, snapped to step 1 |
| range0_wdist | 4990 | 5000 | 5 | 30 | ra1_allies_alliedlighttank, ra1_allies_sheridanassaulttank, japan_shrineminitank, td_nod_lighttank, td_nod_lighttankmkii | reference-backed ledger medians, snapped to step 10 |
| cost0 | 600 | 400 | 5 | 16.6667 | ra1_allies_alliedlighttank, ra1_allies_sheridanassaulttank, japan_shrineminitank, td_nod_lighttank, td_nod_lighttankmkii | reference-backed ledger medians, snapped to step 100 |
...
|---|---|--:|--:|--:|--:|
| anchor: ra1_allies_alliedlighttank | ledger | 50000 | 120 | 4720 | 500 |
| anchor: ra1_allies_alliedlighttank | live | 50000 | 120 | 4720 | 500 |
| verifier: td_nod_lighttankmkii | ledger | 80000 | 100 | 4903 | 800 |
| verifier: td_nod_lighttankmkii | live | 80000 | 100 | 4903 | 800 |

Verifier / anchor ratios (HP, speed, range, cost): 1.6 / 0.833333 / 1.03877 / 1.6

| role | ledger nominal DPS/tick | measured tier factor | derived aggregate K | K fallbacks |
|---|--:|--:|--:|--:|
| anchor | 162.162 | 1 | 0.762755 | 0 |
| verifier | 228.571 | 0.9429 | 0.626019 | 0 |
...
|---|---|---|--:|--:|--:|--:|---|
| ra1_allies_alliedlighttank | redalert_allies | REF | 50000 | 120 | 4720 | 500 | live resolved YAML |
| naxis_panzer | redalert2mod_naxis | FORMULA | 100000 | 100 | 5289 | 600 | excluded from fit (buildable=False and no explicit balance_include) |
| ra1_allies_sheridanassaulttank | redalert_allies | REF | 85000 | 85 | 5023 | 600 | live resolved YAML |
| td_nod_lighttank | tiberiandawn_nod | REF | 80000 | 110 | 4993 | 600 | live resolved YAML |
| yuri_lashertank | redalert2_yuri | REF | 70000 | 105 | 5201 | 600 | live resolved YAML |
| latinsyndicate_rushertank | redalert2mod_syndicate | REF | 75000 | 115 | 5031 | 650 | live resolved YAML |
| ordos_combattank | d2k_ordos | REF | 85000 | 85 | 5230 | 650 | live resolved YAML |
| schwarzermond_lunarpanzer | redalert2mod_schwarzermond | FORMULA | 90000 | 90 | 5121 | 650 | live resolved YAML |
| td_nod_lighttankmkii | tiberiandawn_nod | REF | 80000 | 100 | 4903 | 800 | live resolved YAML |
| steelconsortium_manta | redalert2mod_consortium | FORMULA | 55000 | 115 | 6666 | 850 | live resolved YAML |
| asianalliance_quasar | redalert2mod_asianalliance | REF | 55000 | 125 | 6000 | 900 | live resolved YAML |
| terran_vulture | starcraft_terran | FORMULA | 75000 | 125 | 4800 | 900 | live resolved YAML |
| ixian_shockraider | d2k_ixian | FORMULA | 40000 | 120 | 7756 | 1300 | live resolved YAML |
| cabal_ravager | tiberiansun_cabal | REF | 70000 | 130 | 3000 | 1500 | live resolved YAML |
| futuretech_robottank | redalert2mod_futuretech | REF | 50000 | 130 | 5780 | 1600 | live resolved YAML |
| japan_shrineminitank | redalert_japan | REF | 60000 | 120 | 6370 | 1600 | live resolved YAML |
...
|---|---|--:|--:|--:|--:|--:|---|
| ordos_combattank | OpenRA Dune 2000/combat_tank_o; OpenRA Dune 2000/combat_tank_o.starport | 89238.7 (n=1) | 92.265 (n=1) | 5401.21 (n=1) | 976.456 (n=1) | unavailable (n=0) | unapproved |
| yuri_lashertank | CnC Reloaded/LTNK; Combined Arms/3TNK; Combined Arms/3TNK.ATOMIC; Combined Arms/3TNK.ATOMICYURI; Combined Arms/3TNK.RHINO; Combined Arms/3TNK.RHINO.ATOMIC; Combined Arms/3TNK.RHINO.ATOMICYURI; Combined Arms/3TNK.RHINO.YURI; Combined Arms/3TNK.YURI; Mental Omega/LTNK; RA2 0XX/LTNK; RA2 Reborn/LTNK; Red Resurrection/LTNK; Romanov's Vengeance/ltnk | 78592.6 (n=7) | 92.2178 (n=7) | 5006.13 (n=7) | 953.195 (n=7) | 429.766 (n=7) | unapproved |
| asianalliance_quasar | Mental Omega/SCAR | 62076.7 (n=1) | 89.5655 (n=1) | 5688.4 (n=1) | 866.205 (n=1) | 572.38 (n=1) | unapproved |
| futuretech_robottank | Mental Omega/ROBO | 54752.2 (n=1) | 115.464 (n=1) | 5583.14 (n=1) | 1094.47 (n=1) | 897.435 (n=1) | unapproved |
| latinsyndicate_rushertank | RA2 Reborn/SHEIKH | 104445 (n=1) | 80.3063 (n=1) | 5219.24 (n=1) | 993.289 (n=1) | 241.499 (n=1) | unapproved |
| ra1_allies_alliedlighttank | Combined Arms/1TNK; DTA Enhanced/1TNK; OpenRA Red Alert/1TNK | 75280 (n=3) | 111.329 (n=3) | 4911.69 (n=3) | 923.137 (n=3) | 471.324 (n=3) | unapproved |
| ra1_allies_sheridanassaulttank | Combined Arms/RTNK | 95000.8 (n=1) | 103.142 (n=1) | 4831.71 (n=1) | 869.738 (n=1) | 682.636 (n=1) | unapproved |
| japan_shrineminitank | RA2 Reborn/GRNDR | 114490 (n=1) | 82.0335 (n=1) | 2667.55 (n=1) | 1251.57 (n=1) | 1496.89 (n=1) | unapproved |
| td_nod_lighttank | Combined Arms/LTNK; Combined Arms/LTNK.Laser; DTA Enhanced/LTNK; OpenRA Tiberian Dawn/LTNK | 110334 (n=3) | 88.8415 (n=3) | 4709.67 (n=3) | 982.426 (n=3) | 341.899 (n=3) | unapproved |
| td_nod_lighttankmkii | Combined Arms/LTNK; Combined Arms/LTNK.Laser | 98937.7 (n=1) | 91.536 (n=1) | 4773.65 (n=1) | 971.351 (n=1) | 329.582 (n=1) | unapproved |
| cabal_ravager | CnC Reloaded/ROBOTAVENGER | 89081.7 (n=1) | 100.49 (n=1) | 3755.21 (n=1) | 1290.46 (n=1) | 782.741 (n=1) | unapproved |
...
|---|--:|--:|--:|--:|
| hp | 50000 | 100000 | -50000 | -50.0% |
| speed | 120 | 125 | -5 | -4.0% |
| range_wdist | 4720 | 5000 | -280 | -5.6% |
| cost | 500 | 400 | +100 | +25.0% |
...
|---|--:|--:|--:|--:|
| ra1_allies_alliedlighttank / hp | 50000 | 50000 | 80000 | -37.5% |
| ra1_allies_alliedlighttank / speed | 120 | 120 | 110 | +9.1% |
| ra1_allies_alliedlighttank / range_wdist | 4720 | 4720 | 4990 | -5.4% |
| ra1_allies_alliedlighttank / cost | 500 | 500 | 600 | -16.7% |
| td_nod_lighttankmkii / hp | 80000 | 80000 | 80000 | +0.0% |
| td_nod_lighttankmkii / speed | 100 | 100 | 110 | -9.1% |
| td_nod_lighttankmkii / range_wdist | 4903 | 4903 | 4990 | -1.7% |
| td_nod_lighttankmkii / cost | 800 | 800 | 600 | +33.3% |
...
- `yuri_lashertank` / `RA2LasherToxicMortar_elite`: 2 mains
- `futuretech_robottank` / `RA2Robotmm`: 3 mains
- `ra1_allies_sheridanassaulttank` / `ra1_allies_sheridanassaulttank_cannon`: 2 mains
