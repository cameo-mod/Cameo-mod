...
contract-hardening, support-pricing, PDLaser payload, reference-map tooling and
built-state condition-selector batches are now published through `7ac6b7395` in
