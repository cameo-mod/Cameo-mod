...
| **OpenRA reference weapon evidence** | [`balance/review/OPENRA_WEAPON_EVIDENCE_PLAN_20260910.md`](balance/review/OPENRA_WEAPON_EVIDENCE_PLAN_20260910.md); [`balance/review/AEDIS_OVERNIGHT_RULINGS_20260909.md`](balance/review/AEDIS_OVERNIGHT_RULINGS_20260909.md) September 10 follow-up | `tools/reference/extract_peer_units.py` · `tools/balance/reference_distribution.py`; factory-ready and upgraded states stay separate, unknown conditions are not guessed |
