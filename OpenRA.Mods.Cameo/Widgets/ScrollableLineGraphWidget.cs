 ...
 * and the graph stops being readable exactly when it gets interesting. This keeps
 * the x step FIXED (XAxisSize samples visible at a time) and scrolls instead,
 * auto-following the right edge until the viewer scrolls away from it.
 */
#endregion
