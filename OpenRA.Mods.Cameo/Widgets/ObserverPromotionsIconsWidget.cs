...
{
	public class ObserverPromotionsIconsWidget : Widget
	{
		...
		// Stage B (DecoupledRendering): PlayerStatistics.Units is mutated by the sim thread; enumerate it only
		...
		public ObserverPromotionsIconsWidget(World world, WorldRenderer worldRenderer)
		{
			this.world = world;
		...
		protected ObserverPromotionsIconsWidget(ObserverPromotionsIconsWidget other)
			: base(other)
		{
		...
		{
			return new ObserverPromotionsIconsWidget(this);
		}
