...
{
	public class PlayerUpgradesIconsWidget : Widget
	{
		...
		public PlayerUpgradesIconsWidget(World world, WorldRenderer worldRenderer)
		{
			this.world = world;
		...
		protected PlayerUpgradesIconsWidget(PlayerUpgradesIconsWidget other)
			: base(other)
		{
			world = other.world;
		...
		{
			return new PlayerUpgradesIconsWidget(this);
		}
