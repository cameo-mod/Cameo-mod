...
actor_future_twister =
   .description = Fast multirole fighter.
      Can attack air.
      Strong vs Vehicles, Aircraft
      Weak vs Air Defense
...
actor_future_harbinger =
   .description = Heavy gunship armed with heavy proton cannons and chainguns.
      Slows down and attacks faster with sustained fire.
