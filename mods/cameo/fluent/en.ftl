...
statistics =
    ...
    .buildings-lost = Buildings Lost
    .median-game-length-all = Median game length (all factions)
    .average-game-length-all = Average game length (all factions)
    .median-game-length = Median game length
    .average-game-length = Average game length
    .enemy-assets-destroyed = Total enemy assets destroyed (in credits)
    .assets-owned = Total assets owned (in credits)
    .resources-collected = Resources collected
    .resources-spent = Resources spent
    .top-maps = Top 10 maps played
    .faction-statistics = Per-faction statistics
    .col-games = Games
...
checkbox-building-counts =
    .label = Show building counts in build menu
    .tooltip = Display the number of owned buildings of each type on their build-menu icons.
