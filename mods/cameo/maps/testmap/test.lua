-- Balance test harness v2: TD GDI vs TD Nod (2026-07-27)
...
-- spectator.
--
-- Map: testmap (130x66, VOLCANIC). Spawn area: 24x24 between (53,21)-(76,44).
-- Lake obstacle at (60,29)-(68,37) — units must path around it.
-- SideA (GDI) spawns left of lake: x=53-59, y=21-44.
-- SideB (Nod) spawns right of lake: x=69-76, y=21-44.
...
-- Spawn origins: left of lake (SideA) and right of lake (SideB)
-- Area: (53,21) to (76,44). Lake: (60,29) to (68,37).
-- SideA fills x=53..59 (7 cols), SideB fills x=69..76 (8 cols)
-- GridSpacing=1, GridRows=24 → up to 168/192 slots (plenty for 60-unit rounds)
SpawnA = CPos.New(53, 21)   -- GDI block, left of lake, faces right
SpawnB = CPos.New(69, 21)   -- Nod block, right of lake, faces left
GridRows = 24
GridSpacing = 1
...
WorldLoaded = function()
	Camera.Position = Map.CenterOfCell(CPos.New(64, 32))
	Media.DisplayMessage("Balance test harness v2: TD GDI vs TD Nod. Eight rounds, ~10k-credit armies each.", "Harness")
