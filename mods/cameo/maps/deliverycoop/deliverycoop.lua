--zerg invasion force
zergForce = {"sczergling","schydralisk","sczergling","scultralisk","sczergling","schydralisk","sczergling","sczergling","sczergling","scultralisk","sczergling","schydralisk","sczergling","sczergling","schydralisk","sczergling","sczergling","scultralisk","schydralisk","sczergling","sczergling","sczergling","sczergling","schydralisk","sczergling","scultralisk","sczergling","schydralisk","sczergling","sczergling","sczergling","scultralisk","sczergling","schydralisk","sczergling","sczergling","schydralisk","sczergling","sczergling","scultralisk","schydralisk","sczergling","sczergling","sczergling"}
...
WorldLoaded = function()
	...
	GDI2 = Player.GetPlayer("Player2")
	Truck = Player.GetPlayer("Truck")
	Truck2 = Player.GetPlayer("Truck2")
...
--proximity trigger for MCV owner
	...
	Trigger.OnEnteredProximityTrigger(ConTruck2.CenterPosition, WDist.New(3*1024), function(a, id)
		if a.Owner == GDI2 then
			ConTruck.Owner = GDI2
			Trigger.RemoveProximityTrigger(id)
		end
	end)
...
--GOD DAMN FUCKING PIECE OF SHIT TRIGGERS STILL TRIGGER WHEN THE FUCKING TRIGGER GOT DELETED FUCK FUCK FUCK MOTHERFUCKER FUCK FUCK FUCK
	Trigger.OnEnteredProximityTrigger(TriggWake1.CenterPosition, WDist.New(7*1024), function(a, id)
		if a.Owner == GDI or a.Owner == GDI2 then
