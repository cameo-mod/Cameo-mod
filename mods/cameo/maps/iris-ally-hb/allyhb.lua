...
SankalpaHeli = { "ra1_soviets_hiptransport" }
...
WorldLoaded = function ()
	...
	Trigger.OnTimerExpired(function ()
		...
		Reinforcements.ReinforceWithTransport(Sankalpa, "td_gdi_landingcraft", SankalpaDefenseForce, {SpawnThree.Location}, nil, function (transport)
		...
		Reinforcements.ReinforceWithTransport(Sankalpa, "td_gdi_landingcraft", SankalpaDefenseForce, {SpawnFive.Location}, nil, function (transport)
			Trigger.OnIdle(transport, function (transport)
