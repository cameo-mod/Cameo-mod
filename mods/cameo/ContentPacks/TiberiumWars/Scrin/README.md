...
infantry roster. It is not a playable roster yet, and the faction remains hidden
from the lobby. In particular, the Drone Platform must eventually be deployed
from a Drone Ship; the platform is not registered as a starting actor.

The pack contains 30 approved map/editor-ready actors. All sheets pair their
