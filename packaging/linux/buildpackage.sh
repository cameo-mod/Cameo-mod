...
ARCH=x86_64 ./appimagetool-x86_64.AppImage "${APPDIR}" -u "gh-releases-zsync|cameo-mod|Cameo-mod|latest|CameoMod-playtest-*-x86_64.AppImage.zsync" "${OUTPUTDIR}/${PACKAGING_INSTALLER_NAME}-${TAG}-x86_64.AppImage"
